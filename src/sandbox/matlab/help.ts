...
const SYM_REF = new Set<string>((
  ...
  'jacobiSC jacobiSD jacobiCD jacobiCS jacobiDC jacobiDS jacobiNC jacobiND jacobiNS texlabel cell2sym sym2cell series dsolve piecewise pade matlabFunction colspace hermiteForm smithForm'
).split(/\s+/));
...
const EXTRA_HELP: Record<string, string> = {
  ...
  dsolve: 'Solve ordinary differential equations symbolically', pade: 'Padé approximant', piecewise: 'Conditionally defined symbolic expression', matlabFunction: 'Convert a symbolic expression to a function handle',
