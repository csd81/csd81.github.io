...
const SYM_REF = new Set<string>((
  ...
  'jacobiSC jacobiSD jacobiCD jacobiCS jacobiDC jacobiDS jacobiNC jacobiND jacobiNS texlabel cell2sym sym2cell series dsolve piecewise pade matlabFunction colspace hermiteForm smithForm functionalDerivative eliminate symfun symtrue symfalse vpasum vpaintegral'
).split(/\s+/));
...
const EXTRA_HELP: Record<string, string> = {
  ...
  dsolve: 'Solve ordinary differential equations symbolically', symfun: 'Create a symbolic function', symtrue: 'Symbolic true', symfalse: 'Symbolic false', vpasum: 'Variable-precision (numeric) sum', vpaintegral: 'Variable-precision (numeric) definite integral', functionalDerivative: 'Functional (variational) derivative', eliminate: 'Eliminate variables from equations', pade: 'Padé approximant', piecewise: 'Conditionally defined symbolic expression', matlabFunction: 'Convert a symbolic expression to a function handle',
