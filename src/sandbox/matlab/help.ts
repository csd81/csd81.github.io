...
const SYM_REF = new Set<string>((
  ...
  'jacobiSC jacobiSD jacobiCD jacobiCS jacobiDC jacobiDS jacobiNC jacobiND jacobiNS texlabel cell2sym sym2cell series dsolve piecewise'
).split(/\s+/));
...
const EXTRA_HELP: Record<string, string> = {
  ...
  iskeyword: 'Determine whether input is a MATLAB keyword', regexptranslate: 'Translate text into a regular expression', texlabel: 'Format symbolic expression as TeX', cell2sym: 'Convert a cell array to a symbolic array', sym2cell: 'Convert a symbolic array to a cell array', series: 'Puiseux/Taylor series expansion',
  dsolve: 'Solve ordinary differential equations symbolically', piecewise: 'Conditionally defined symbolic expression',
