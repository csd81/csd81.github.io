...
const EXTRA_HELP: Record<string, string> = {
  ...
  fnval: 'Evaluate a piecewise polynomial', fnder: 'Differentiate a piecewise polynomial', fnint: 'Integrate a piecewise polynomial', fnbrk: 'Parts of a piecewise polynomial', fnplt: 'Plot a piecewise polynomial', fnmin: 'Minimum of a piecewise polynomial', fnzeros: 'Roots of a piecewise polynomial', csapi: 'Cubic spline interpolation', csape: 'Cubic spline interpolation with end conditions', missing: 'Create missing values (NaN)', kde: 'Kernel density estimate', histcounts2: 'Bivariate histogram bin counts', extract: 'Extract substrings matching a pattern',
