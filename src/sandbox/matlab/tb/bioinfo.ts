...
export const BIOINFO: ToolboxModule = {
  ...
  help: {
    nt2int: 'nt2int(SeqNT) — convert a nucleotide character sequence to an integer code vector (A=1,C=2,G=3,T/U=4,...,gap=16).',
    int2nt: 'int2nt(SeqInt) — convert an integer code vector back to a nucleotide character sequence.',
    aa2int: 'aa2int(SeqAA) — convert an amino-acid character sequence to an integer code vector (A=1,R=2,...,V=20).',
    int2aa: 'int2aa(SeqInt) — convert an integer code vector back to an amino-acid character sequence.',
    seqreverse: 'seqreverse(Seq) — reverse the order of a sequence.',
    seqcomplement: 'seqcomplement(SeqNT) — Watson-Crick complement of a nucleotide sequence (case and RNA preserved).',
    seqrcomplement: 'seqrcomplement(SeqNT) — reverse complement of a nucleotide sequence.',
    basecount: 'basecount(SeqNT) — count A, C, G, T bases in a nucleotide sequence, returned as a struct.',
    aacount: 'aacount(SeqAA) — count the 20 standard amino acids in a peptide sequence, returned as a struct.',
    nt2aa: 'nt2aa(SeqNT) — translate a nucleotide sequence to amino acids using the standard genetic code (frame 1).',
  },
};
