...
// Help entries here cover the 46 SYM_BUILTINS functions not already in help.ts's HELP table.
// docPath produces sym.<name>.html URLs; SYM_REF in help.ts handles the URL generation.
import type { ToolboxModule } from './types';
import { HELP_SYMBOLIC } from './help-symbolic';
