...
export const SIMULINK: ToolboxModule = {
  ...
  help: {
    new_system: 'Create a new Simulink model in memory', add_block: 'Add a block to a Simulink model',
    add_line: 'Connect block ports with a signal line', set_param: 'Set a block/model parameter',
    get_param: 'Get a block/model parameter', sim: 'Simulate a Simulink model (returns tout/yout)',
  },
};
