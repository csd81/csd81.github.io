...
export const RF: ToolboxModule = {
  ...
  help: {
    ...
    gammams: 'gammams(S) — source reflection coefficient for a simultaneous conjugate match (2-port).',
    powergain: "powergain(S,Z0,ZS,ZL[,type]) — 2-port power gain: 'Gt','Ga','Gp','Gmag','Gmsg'.",
    s2scc: 's2scc(S[,rfflag]) — convert 2N-port single-ended S-parameters to common-mode N-port Scc.',
    stabilityk: '[k,b1,b2,delta] = stabilityk(S) — Rollett stability factor K of a 2-port network.',
    s2abcd: 's2abcd(S[,Z0]) — convert S-parameters to ABCD-parameters (default Z0=50).',
    abcd2s: 'abcd2s(ABCD[,Z0]) — convert ABCD-parameters to S-parameters (default Z0=50).',
    s2y: 's2y(S[,Z0]) — convert S-parameters to Y-parameters (default Z0=50).',
    y2s: 'y2s(Y[,Z0]) — convert Y-parameters to S-parameters (default Z0=50).',
    s2z: 's2z(S[,Z0]) — convert S-parameters to Z-parameters (default Z0=50).',
    z2s: 'z2s(Z[,Z0]) — convert Z-parameters to S-parameters (default Z0=50).',
  },
};
