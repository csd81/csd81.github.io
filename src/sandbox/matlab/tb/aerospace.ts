...
export const AEROSPACE: ToolboxModule = {
  ...
  help: {
    ...
    angle2quat: { summary: 'Convert rotation angles to quaternion', syntax: ['q = angle2quat(r1,r2,r3)', "q = angle2quat(r1,r2,r3,sequence)"], seealso: ['quat2angle', 'angle2dcm', 'quat2dcm'] },
    quat2angle: { summary: 'Convert quaternion to rotation angles', syntax: ['[r1,r2,r3] = quat2angle(q)', "[r1,r2,r3] = quat2angle(q,sequence)"], seealso: ['angle2quat', 'dcm2angle', 'quat2dcm'] },
    angle2dcm: { summary: 'Convert rotation angles to direction cosine matrix', syntax: ['dcm = angle2dcm(r1,r2,r3)', "dcm = angle2dcm(r1,r2,r3,sequence)"], seealso: ['dcm2angle', 'angle2quat', 'quat2dcm'] },
    dcm2angle: { summary: 'Convert direction cosine matrix to rotation angles', syntax: ['[r1,r2,r3] = dcm2angle(dcm)', "[r1,r2,r3] = dcm2angle(dcm,sequence)"], seealso: ['angle2dcm', 'dcm2quat', 'quat2angle'] },
