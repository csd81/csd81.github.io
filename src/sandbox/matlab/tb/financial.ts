...
export const FINANCIAL: ToolboxModule = {
  ...
  help: {
    ...
    yearfrac: { summary: 'Fraction of year between dates for a given day-count basis', syntax: ['f = yearfrac(d1,d2)', 'f = yearfrac(d1,d2,basis)'], seealso: ['days360', 'days365', 'daysact', 'daysdif'] },
    prmat: { summary: 'Price and accrued interest of a security paying interest at maturity', syntax: ['[price,ai] = prmat(settle,maturity,issue,face,coupon,yield)', '[price,ai] = prmat(...,basis)'], seealso: ['yldmat', 'prdisc', 'acrudisc'] },
    yldmat: { summary: 'Yield of a security paying interest at maturity', syntax: ['yld = yldmat(settle,maturity,issue,face,price,coupon)', 'yld = yldmat(...,basis)'], seealso: ['prmat', 'ylddisc'] },
