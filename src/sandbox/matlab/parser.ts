...
const COMMAND_FNS = new Set(['hold', 'format', 'grid', 'box', 'axis', 'clc', 'close', 'clear', 'warning', 'shg', 'drawnow', 'colormap', 'shading', 'colorbar', 'view', 'help', 'doc', 'who', 'whos', 'lookfor', 'syms', 'save', 'load', 'lighting', 'camlight', 'material', 'geobasemap']);
