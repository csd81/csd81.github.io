...
10. Stopping Criterion: The iteration was stopped when the distance between two consecutive terms in the sequence (|$p_k - p_{k-1}$|) became less than the predefined tolerance (TOL) of 1$0^{-5}$.
