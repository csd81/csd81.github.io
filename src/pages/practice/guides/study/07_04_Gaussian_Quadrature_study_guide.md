...
Recursion Formula	A mathematical relation (such as P_{n+1}(x) = xP_n(x) - \frac{n^2}{4n^2 - 1}P_{n-1}(x)) used to define subsequent Legendre polynomials based on previous ones.
