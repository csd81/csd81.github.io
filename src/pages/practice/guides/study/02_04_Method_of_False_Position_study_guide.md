...
9. How many steps did the bisection method require to reach a tolerance of 10^{-5} on the interval [0, 4], and how did this compare to the method of false position?
...
7. On the interval [0, 1], the method of false position converges much faster than the bisection method. It reaches the desired tolerance of 10^{-5} in only eight iterations.
