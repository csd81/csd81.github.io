...
const TABS: Tab[] = [
  ...
  { id: 'boole', label: '13.1 Boole-algebra', content: <RichTex html={t2} /> },
  { id: 'polinom', label: '13.2a Polinomok', content: <RichTex html={t3} /> },
  { id: 'eukl', label: '13.2b Euklideszi gyűrűk', content: <RichTex html={t4} /> },
  { id: 'tablazat', label: '13.3 Táblázatok', content: <RichTex html={t5} /> },
];
