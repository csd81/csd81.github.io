...
const TABS: Tab[] = [
  ...
  { id: 'rsa', label: '10.1 RSA', content: <RichTex html={t2} /> },
  { id: 'pelda', label: 'RSA példa', content: <RichTex html={t3} /> },
  { id: 'aliras', label: 'Aláírás-hitelesítés', content: <RichTex html={t4} /> },
  { id: '129', label: 'RSA-129 feltörés', content: <RichTex html={t5} /> },
  { id: 'hatizsak', label: '10.2 Hátizsák', content: <RichTex html={t6} /> },
];
