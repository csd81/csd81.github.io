...
function EuclidCalc() {
  ...
  return (
    <div className="info-box">
      <span className="lbl" style={{ color: '#a78bfa' }}>4.3 Interaktív Euklideszi algoritmus</span>
      ...
      <div style={{ overflowX: 'auto' }}>
        <table className="cayley" style={{ width: '100%', fontFamily: 'monospace', fontSize: '.82rem' }}>
          ...
          <tbody>
            {steps.map((s, i) => (
              <tr key={i} style={s.r === 0 ? { background: 'rgba(167,139,250,.13)' } : undefined}>
                <td>{s.a}</td>
...
const TABS: Tab[] = [
  ...
  { id: 'pelda', label: '4.6–4.12 Példák', content: <div><RichTex html={t4a} /><EuclidCalc /></div> },
