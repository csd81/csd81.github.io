...
const TABS: Tab[] = [
  ...
  { id: 'bundled', label: 'A 5 mellékelt program', content: <RichTex html={tBundled} /> },
  { id: 'tools',   label: 'Külső eszközök',        content: <RichTex html={tTools} /> },
  { id: 'perf',    label: 'Teljesítmény-mérések',  content: <RichTex html={tPerf} /> },
];
