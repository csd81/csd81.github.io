...
function PowerModCalc() {
  ...
  function powmod(base: number, exp: number, mod: number): {
    result: number;
    steps: { j: number; uj: number; bit: number }[];
  } {
    if (mod <= 0 || exp < 0) return { result: 0, steps: [] };
  ...
  return (
    <div className="info-box">
      ...
      <div className="def-box" style={{ marginTop: '.6rem', fontWeight: 700, fontSize: '.9rem' }}>
        ...
        &nbsp;&nbsp;<span style={{ color: '#8892a4', fontWeight: 400, fontSize: '.8rem' }}>
          ({steps.length} lépés, szemben a {k} naiv szorzással)
        </span>
      </div>
    </div>
  );
...
/* ════ Tab 4: 6.3 Lineáris kongruencia ════ */
const t4 = String.raw`
<div class="def-box">
...
/* ════ Tab 5: 6.4–5 Euler-φ + Lagrange/Euler/Fermat/Wilson ════ */
const t5 = String.raw`
<div class="def-box">
...
/* ════ Tab 6: 6.6 Nagy kitevőjű hatványozás ════ */
const t6theory = String.raw`
<div class="def-box">
...
/* ════ Tab 7: Primitív gyök & kvadratikus maradékok ════ */
const t7 = String.raw`
<div class="def-box">
...
const TABS: Tab[] = [
  ...
  { id: 'zn', label: '6.2 ℤₙ gyűrű', content: <RichTex html={t3} /> },
  { id: 'linkong', label: '6.3 Lineáris kongr.', content: <RichTex html={t4} /> },
  { id: 'phi', label: '6.4–5 φ + tételek', content: <RichTex html={t5} /> },
  { id: 'hatv', label: '6.6 Nagy hatványozás', content: <div><RichTex html={t6theory} /><PowerModCalc /></div> },
  { id: 'kvad', label: '6.7–8 Primitív gyök & kvadr.', content: <RichTex html={t7} /> },
];
