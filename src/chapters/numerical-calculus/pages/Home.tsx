    ...
    <div className="space-y-10">
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 via-brand-500 to-accent-500 p-8 text-white shadow-lg sm:p-12">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link to="/numerical-calculus/lessons" className="btn bg-white text-brand-700 hover:bg-brand-50">
            {t('home.cta_lessons')}
          </Link>
          <Link to="/numerical-calculus/playground" className="btn bg-white/15 text-white ring-1 ring-white/40 hover:bg-white/25">
