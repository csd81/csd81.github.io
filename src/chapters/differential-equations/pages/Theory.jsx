...
import { GlossaryDeck, FlashcardDeck } from "../components/Decks.jsx";
...
export default function Theory({ sectionId: sidProp } = {}) {
  const params = useParams();
  const sectionId = sidProp ?? params.sectionId;
  const embedded = sidProp != null;
  const { lang } = useLang();
  const t = useT(lang);
