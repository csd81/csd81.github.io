...
export function Layout() {
  const t = useStrings();
  const links = [
    { to: '/iterative-methods', label: t.nav.home, end: true },
    { to: '/iterative-methods/fixed-point', label: t.nav.fixedPoint },
    { to: '/iterative-methods/jacobi-gauss-seidel', label: t.nav.jacobiGs },
    { to: '/iterative-methods/spectral', label: t.nav.spectral },
    { to: '/iterative-methods/condition', label: t.nav.condition },
  ];
    ...
    <div className="min-h-full flex flex-col">
      <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/90 backdrop-blur dark:border-slate-800 dark:bg-slate-900/90">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-4">
          <NavLink to="/iterative-methods" className="flex flex-col leading-tight">
