...
`,Ae={lagrange:{en:re,hu:oe},newton:{en:ae,hu:te},hermite:{en:ie,hu:ne},spline:{en:je,hu:Se}};function De(i,a){var r;return((r=Ae[i])==null?void 0:r[a])??""}const Te=`#include <vector>
#include <iostream>
using namespace std;
...
`,He=`function [z, a] = hermite_coeffs(x, y, dy)
...
`,Qe=`hermiteCoeffs[x_, y_, dy_] := Module[{n = Length[x], m, z, Q, i, j},
...
`,rn=`// Evaluate the Newton form by nested (Horner-like) multiplication.
...
`,cn=`// Newton divided-difference coefficients a_i = f[x_0, ..., x_i].
...
println("a = ", a)
`,vn=`// Natural cubic spline: per-interval coefficients (a, b, c, d).
function solve(A, b) {
  const n = b.length;
  const m = A.map((r) => [...r]), r = [...b];
  for (let k = 0; k < n; k++) {
...
if __name__ == "__main__":
    ...
    print("c =", c)
    print("d =", d)
`,zn=`# Natural cubic spline. Returns per-interval (a, b, c, d) with
# S_i(t) = a_i + b_i (t - x_i) + c_i (t - x_i)^2 + d_i (t - x_i)^3.
...
`,Sn=Object.assign({"./hermite.cpp":Te,"./hermite.f90":Le,"./hermite.go":Ne,"./hermite.jl":Me,"./hermite.js":Ie,"./hermite.m":He,"./hermite.py":Ce,"./hermite.r":Ve,"./hermite.rs":We,"./hermite.wl":Qe,"./lagrange.cpp":Ee,"./lagrange.f90":Fe,"./lagrange.go":Pe,"./lagrange.jl":Re,"./lagrange.js":Oe,"./lagrange.m":Ge,"./lagrange.py":Be,"./lagrange.r":Ue,"./lagrange.rs":Ke,"./lagrange.wl":Xe,"./newton-eval.cpp":Ye,"./newton-eval.f90":Ze,"./newton-eval.go":Je,"./newton-eval.jl":en,"./newton-eval.js":nn,"./newton-eval.m":tn,"./newton-eval.py":an,"./newton-eval.r":on,"./newton-eval.rs":rn,"./newton-eval.wl":sn,"./newton.cpp":ln,"./newton.f90":dn,"./newton.go":fn,"./newton.jl":_n,"./newton.js":cn,"./newton.m":xn,"./newton.py":hn,"./newton.r":$n,"./newton.rs":mn,"./newton.wl":pn,"./spline.cpp":un,"./spline.f90":gn,"./spline.go":yn,"./spline.jl":bn,"./spline.js":vn,"./spline.m":kn,"./spline.py":wn,"./spline.r":zn,"./spline.rs":qn,"./spline.wl":jn}),q=(i,a)=>Sn[`./${i}.${a}`],An={lagrange:{en:"Lagrange interpolation (Vandermonde system)",hu:"Lagrange-interpoláció (Vandermonde-rendszer)"},newton:{en:"Newton's divided differences (coefficients)",hu:"Newton-féle osztott differenciák (együtthatók)"},"newton-eval":{en:"Newton polynomial evaluation (nested form)",hu:"Newton-polinom kiértékelése (beágyazott alak)"},hermite:{en:"Hermite interpolation",hu:"Hermite-interpoláció"},spline:{en:"Natural cubic spline",hu:"Természetes köbös spline"}},Dn=i=>({id:i,caption:An[i],snippets:{matlab:q(i,"m"),python:q(i,"py"),cpp:q(i,"cpp"),julia:q(i,"jl"),rust:q(i,"rs"),fortran:q(i,"f90"),wolfram:q(i,"wl"),javascript:q(i,"js"),go:q(i,"go"),r:q(i,"r")}}),Tn={lagrange:["lagrange"],newton:["newton","newton-eval"],hermite:["hermite"],spline:["spline"]};function Ln(i){return(Tn[i]??[]).map(Dn)}const Nn={lagrange:[{id:"q-lagrange-1",prompt:"In two-variable Lagrange interpolation, the polynomial L_{n,m}(x,y) is:",options:["∑_i ∑_j z_ij l_i(x) l̃_j(y)","the product L_n(x) L_m(y)","a sum of polynomials in x only","a single monomial xⁿ yᵐ"],answer:0,explanation:"It is the double sum of node values times the tensor product of 1-D basis polynomials."},{id:"q-lagrange-2",prompt:"The Lagrange interpolating polynomial L_n(x) can be written as:",options:["L_n(x) = ∑_k y_k l_k(x)","L_n(x) = y₀ + y₁x + … + y_n xⁿ","L_n(x) = ∏_k y_k l_k(x)","L_n(x) = ∫_a^b y(t) l_k(t) dt"],answer:0,explanation:"It is the sum of node values weighted by the Lagrange basis polynomials."},{id:"q-lagrange-3",prompt:"For equidistant nodes with spacing h and x ∈ (x_k, x_{k+1}), the product ∏|x − x_i| satisfies:",options:["≤ (hⁿ⁺¹/4) · n!","≤ (hⁿ⁺¹/2) · n!","≤ (hⁿ⁺¹/8) · n!","≤ hⁿ⁺¹"],answer:0,explanation:"The standard equidistant bound is hⁿ⁺¹·n!/4."},{id:"q-lagrange-4",prompt:"The Lagrange basis polynomial l_k(x) satisfies:",options:["l_k(x_k) = 1 and l_k(x_i) = 0 for all i ≠ k","l_k(x_i) = 1 for all i","l_k(x) = xᵏ","l_k(x_i) = 0 for all i"],answer:0,explanation:"The basis polynomials are cardinal: l_k(x_i) = δ_{ki}."},{id:"q-lagrange-5",prompt:"The remainder term in the degree-n Lagrange interpolation error formula is:",options:["[f⁽ⁿ⁾(ξ)/n!] ∏(x − x_i)","[f⁽ⁿ⁺¹⁾(ξ)/(n+1)!] ∏(x − x_i)","f''(ξ)(x − x₀)","f'(ξ) ∏(x − x_i)"],answer:1,explanation:"The error uses the (n+1)-th derivative divided by (n+1)!."}],newton:[{id:"q-newton-1",prompt:"Which is the explicit formula for f[x₀,…,x_n]?",options:["f⁽ⁿ⁾(x₀)/n!","∑_i f(x_i) / ∏_{j≠i}(x_i − x_j)","∑_i f(x_i)(x_i − x₀)","∏_i f(x_i)"],answer:1,explanation:"The divided difference equals ∑_i f(x_i) / ∏_{j≠i}(x_i − x_j)."},{id:"q-newton-2",prompt:"The recursive definition of the n-th divided difference is:",options:["f[x₀,…,x_n] = ∑_k f[x_k]","f[x₀,…,x_n] = f[x₁,…,x_n] − f[x₀,…,x_{n−1}]","f[x₀,…,x_n] = (f[x₁,…,x_n] − f[x₀,…,x_{n−1}]) / (x_n − x₀)","f[x₀,…,x_n] = (x_n − x₀) f[x₁,…,x_{n−1}]"],answer:2,explanation:"Each higher divided difference is the difference of two lower ones over (x_n − x₀)."},{id:"q-newton-3",prompt:"Which statement best applies to computing divided differences?",options:["In practice the recursive definition is preferred","We compute them using Taylor's approximation","The explicit formula needs fewer operations","We prefer the explicit formula"],answer:0,explanation:"The recursive table is more efficient and numerically convenient than the explicit sum."},{id:"q-newton-4",prompt:"The first divided difference of f at nodes x₀, x₁ is:",options:["(f(x₁) − f(x₀)) / (x₁ − x₀)","(f(x₀) − f(x₁)) / (x₁ − x₀)","f(x₁) − f(x₀)","(f'(x₁) − f'(x₀)) / (x₁ − x₀)"],answer:0,explanation:"f[x₀,x₁] = (f(x₁) − f(x₀)) / (x₁ − x₀)."},{id:"q-newton-5",prompt:"The zeroth divided difference of f at a node x₀ is defined as:",options:["0","f'(x₀)","x₀","f(x₀)"],answer:3,explanation:"f[x₀] = f(x₀)."},{id:"q-newton-6",prompt:"The Newton interpolating polynomial of degree n is:",options:["L_n(x) = ∑_k y_k xᵏ","L_n(x) = ∏_k (x − x_k)","L_n(x) = f[x₀]xⁿ + … + f[x_n]","L_n(x) = ∑_k f[x₀,…,x_k](x − x₀)…(x − x_{k−1})"],answer:3,explanation:"Newton form sums divided-difference coefficients times the nested node products."},{id:"q-newton-7",prompt:"After adding a new data point (x_{n+1}, y_{n+1}), the updated polynomial is:",options:["L_{n+1}(x) = f[x₀,…,x_n](x − x_{n+1})","No change: L_{n+1}(x) = L_n(x)","L_{n+1}(x) = L_n(x) + f[x₀,…,x_{n+1}](x − x₀)…(x − x_n)","L_{n+1}(x) = L_n(x) + f[x_{n+1}]"],answer:2,explanation:"Newton form only appends one new term, leaving previous coefficients intact."},{id:"q-newton-8",prompt:"The factor (x − x₀)(x − x₁)…(x − x_{k−1}) in the Newton polynomial has degree:",options:["n − k","k","n","k − 1"],answer:1,explanation:"There are k linear factors, so the degree is k."},{id:"q-newton-9",prompt:"Building the divided-difference table for n+1 points has arithmetic complexity:",options:["O(n)","O(2ⁿ)","O(n²)","O(n³)"],answer:2,explanation:"The triangular table requires O(n²) operations."},{id:"q-newton-10",prompt:"The main computational advantage of the Newton form over the Lagrange form is that it:",options:["allows easy addition of new mesh points without recomputing all coefficients","avoids any division operations","minimizes rounding errors","produces lower-degree polynomials"],answer:0,explanation:"New points add a single term, reusing all earlier coefficients."}],hermite:[{id:"q-hermite-1",prompt:"Hermite interpolation is especially appropriate when:",options:["the nodes are equally spaced","only function values are known","second derivatives are known everywhere","derivative values at the nodes are also known"],answer:3,explanation:"Hermite matches both function and derivative values at the nodes."},{id:"q-hermite-2",prompt:"When building the Hermite divided-difference table, each node x_i is:",options:["listed three times","omitted in even columns","listed once","listed twice in consecutive rows"],answer:3,explanation:"Each node is duplicated so the derivative condition enters the table."},{id:"q-hermite-3",prompt:"For n+1 nodes, the Hermite problem specifies how many interpolation conditions?",options:["2n","n + 1","n²","2(n + 1)"],answer:3,explanation:"A value and a derivative at each of n+1 nodes give 2(n+1) conditions."},{id:"q-hermite-4",prompt:"The degree of the Hermite polynomial for n+1 mesh points is at most:",options:["n + 1","2n","2n + 1","n"],answer:2,explanation:"2(n+1) conditions determine a polynomial of degree at most 2n+1."},{id:"q-hermite-5",prompt:"The extended divided difference f[x₀, x₀] is defined to be:",options:["f'(x₀)","f(x₀)","0","f''(x₀)"],answer:0,explanation:"As x₁ → x₀ the first divided difference tends to f′(x₀)."}],spline:[{id:"q-spline-1",prompt:"A cubic spline with S''(x₀) = 0 and S''(x_n) = 0 is called a:",options:["natural spline","clamped spline","quadratic spline","not-a-knot spline"],answer:0,explanation:"Zero second derivatives at the endpoints define the natural cubic spline."},{id:"q-spline-2",prompt:"A spline function S of degree k on [a,b] is a function that:",options:["is piecewise polynomial of degree ≤ k and belongs to Cᵏ⁻¹[a,b]","satisfies S⁽ᵏ⁾(x) = 0 everywhere","has continuous first derivative only","is a polynomial of degree k on the whole interval"],answer:0,explanation:"A degree-k spline is piecewise polynomial and globally Cᵏ⁻¹."},{id:"q-spline-3",prompt:"Compared with high-degree global polynomial interpolation, cubic splines are preferred because they:",options:["use fewer sub-intervals","minimize oscillation while achieving smoothness","require no continuity across nodes","never oscillate"],answer:1,explanation:"Cubic splines avoid Runge-type oscillation while staying smooth (C²)."},{id:"q-spline-4",prompt:"The relation b_i = Δy_i/Δx_i − (2c_i + c_{i+1})/3 · Δx_i expresses:",options:["the natural boundary condition","the slope of the piece S_i at x_i","continuity of S'' at x_i","the difference equation for c_i"],answer:1,explanation:"This formula gives the linear coefficient (slope at x_i) of the spline piece."},{id:"q-spline-5",prompt:"The unknown second-derivative parameters c_i = S''(x_i)/2 are found by solving a linear system whose matrix is:",options:["diagonal","upper-triangular","tridiagonal","dense and symmetric"],answer:2,explanation:"Continuity conditions yield a tridiagonal system for the c_i."}]};function B(i){return Nn[i]??[]}function C({str:i,method:a,points:r,derivatives:t,allowCompare:l,showTable:o,enableDerivatives:s}){const{lang:f}=E(),n=i.lessons[a],_=De(a,f),m=Ln(a);return e.jsxs("article",{className:"lesson",children:[e.jsxs("header",{children:[e.jsx("h2",{children:n.title}),e.jsx("p",{className:"intro",children:n.intro})]}),e.jsxs("section",{className:"theorem-card",children:[e.jsx("div",{className:"theorem-tag",children:n.theoremTitle}),e.jsx(se,{block:!0,children:n.theorem}),e.jsx("p",{children:n.body})]}),_&&e.jsxs("details",{className:"lesson__theory",open:!0,children:[e.jsx("summary",{children:f==="hu"?"Elmélet":"Theory"}),e.jsx(Q,{markdown:_})]}),m.map(h=>e.jsx(Z,{snippets:h.snippets,caption:h.caption},h.id)),B(a).length>0&&e.jsx(J,{questions:B(a)}),e.jsxs("p",{className:"tryit",children:["👉 ",n.tryIt]}),e.jsx(be,{str:i,initialPoints:r,initialDerivs:t,primary:a,allowCompare:l,showTable:o,enableDerivatives:s}),e.jsx(we,{deck:a}),e.jsx(qe,{deck:a})]})}const V={lagrange:"#ff5d8f",newton:"#f5a623",hermite:"#9b5de5",spline:"#00bbf9"},U=i=>Math.cos(i),W=[-Math.PI-.5,Math.PI+.5],Mn=[-2.5,2.5];function In(){const i=Array.from({length:40}),a=["#ff5d8f","#f5a623","#9b5de5","#00bbf9","#3ddc97"];return e.jsx("div",{className:"confetti","aria-hidden":!0,children:i.map((r,t)=>e.jsx("span",{style:{left:`${Math.random()*100}%`,background:a[t%a.length],animationDelay:`${Math.random()*.6}s`,transform:`rotate(${Math.random()*360}deg)`}},t))})}function Hn({str:i}){const[a,r]=p.useState([{x:-3,y:-.5},{x:-1.2,y:.5},{x:.5,y:.7},{x:2,y:-.2},{x:3,y:-.8}]),[t,l]=p.useState("spline"),[o,s]=p.useState(!0),f=p.useMemo(()=>[...a].sort(($,g)=>$.x-g.x),[a]),n=p.useMemo(()=>F(t,f),[t,f]),_=p.useMemo(()=>{let $=0;for(let g=0;g<=80;g++){const v=W[0]+(W[1]-W[0])*g/80,S=Math.abs(n(v)-U(v));Number.isFinite(S)&&($=Math.max($,S))}return $},[n]),m=_<.18,h=[{fn:n,color:V[t],label:i.methods[t]}];o&&h.push({fn:U,color:"#8aa0b5",label:"cos x",dashed:!0});const u=($,g,v)=>r(S=>S.map((D,T)=>T===$?{x:g,y:v}:D));return e.jsxs("div",{className:"challenge",children:[e.jsxs("div",{className:"challenge-head",children:[e.jsx("h2",{children:i.nav.playground}),e.jsx("p",{className:"intro",children:i.tagline})]}),e.jsxs("div",{className:"challenge-bar",children:[e.jsx("div",{className:"methodpills",children:Object.keys(V).map($=>e.jsx("button",{className:`pill ${t===$?"on":""}`,style:t===$?{background:V[$],borderColor:V[$]}:{},onClick:()=>l($),children:i.methods[$]},$))}),e.jsxs("label",{className:"chip",children:[e.jsx("input",{type:"checkbox",checked:o,onChange:()=>s($=>!$)}),i.ui.showCos]})]}),e.jsxs("div",{className:"challenge-plotwrap",children:[e.jsx(K,{points:a,curves:h,domain:W,range:Mn,onDrag:u,width:720,height:440}),m&&e.jsx(In,{})]}),e.jsx("div",{className:`challenge-status ${m?"win":""}`,children:m?e.jsx("strong",{children:i.ui.nailedIt}):e.jsxs("span",{children:["🎯 ",i.ui.challengeHint," ",e.jsxs("em",{children:["(max Δ = ",_.toFixed(2),")"]})]})})]})}const Cn=[{id:"play",no:"6·play",title:{en:z.en.nav.playground,hu:z.hu.nav.playground},blurb:{en:"",hu:""}},{id:"lagrange",no:"6.1",title:{en:z.en.nav.lagrange,hu:z.hu.nav.lagrange},blurb:{en:"",hu:""}},{id:"newton",no:"6.2",title:{en:z.en.nav.newton,hu:z.hu.nav.newton},blurb:{en:"",hu:""}},{id:"hermite",no:"6.4",title:{en:z.en.nav.hermite,hu:z.hu.nav.hermite},blurb:{en:"",hu:""}},{id:"spline",no:"6.5",title:{en:z.en.nav.spline,hu:z.hu.nav.spline},blurb:{en:"",hu:""}}];function On(){const{lang:i}=E(),a=z[i],r={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return e.jsxs("div",{className:"app ch-interpolation",children:[e.jsx(ee,{sections:Cn}),e.jsx("header",{className:"topbar",children:e.jsxs("div",{className:"brand",children:[e.jsx("span",{className:"logo",children:"📈"}),e.jsxs("div",{children:[e.jsx("div",{className:"brand-title",children:a.appTitle}),e.jsx("div",{className:"brand-sub",children:a.tagline})]})]})}),e.jsxs("main",{className:"content",children:[e.jsx("section",{id:"play",style:r,children:e.jsx(Hn,{str:a})}),e.jsx("section",{id:"lagrange",style:r,children:e.jsx(C,{str:a,method:"lagrange",points:[{x:-1,y:-3},{x:1,y:1},{x:2,y:3},{x:3,y:29}],allowCompare:!0})}),e.jsx("section",{id:"newton",style:r,children:e.jsx(C,{str:a,method:"newton",points:[{x:-1,y:-2},{x:1,y:0},{x:2,y:-2},{x:3,y:2}],showTable:!0,allowCompare:!0})}),e.jsx("section",{id:"hermite",style:r,children:e.jsx(C,{str:a,method:"hermite",points:[{x:-1,y:2},{x:1,y:4},{x:2,y:11}],derivatives:[3,-5,30],enableDerivatives:!0})}),e.jsx("section",{id:"spline",style:r,children:e.jsx(C,{str:a,method:"spline",points:[{x:0,y:.5},{x:1,y:.1},{x:1.5,y:2.5},{x:2,y:-1},{x:3,y:-.5},{x:4,y:0}],allowCompare:!0})})]}),e.jsx("footer",{className:"foot",children:"InterPlay · Numerical Analysis · Interpolation"})]})}export{On as default};
