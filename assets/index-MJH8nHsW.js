...
`,_n=`## 7.2. Richardson's extrapolation
...
`,vn=`## 7.1. Numerikus differenciálás
...
`,zn=`## 7.2. Richardson-extrapoláció
...
`,qn=`## 7.4. Gauss-féle kvadratúra formulák
...
`,Hn={trapezoid:{id:"trapezoid",snippets:{matlab:Fn,python:Wn,cpp:Mn},caption:{en:"Composite trapezoidal rule",hu:"Összetett trapéz-szabály"}},simpson:{id:"simpson",snippets:{matlab:Dn,python:Gn,cpp:Bn},caption:{en:"Composite Simpson's rule",hu:"Összetett Simpson-szabály"}}},Vn={"7_3":["trapezoid","simpson"]};function Un(a){return(Vn[a]??[]).map(e=>Hn[e]).filter(Boolean)}function Qn({slug:a}={}){const e=et(),t=a??e.slug??"",n=a!=null,{t:i,i18n:r}=E(),o=r.language==="hu"?"hu":"en",[s,h]=k.useState(null),[l,c]=k.useState("loading");return k.useEffect(()=>{let $=!0;return c("loading"),Cn(t,o).then(d=>{$&&(h(d),c("ok"))}).catch(()=>$&&c("error")),()=>{$=!1}},[t,o]),f.jsxs("article",{children:[!n&&f.jsxs(Ee,{to:"/numerical-calculus/lessons",className:"text-sm font-semibold text-brand-600 hover:underline dark:text-brand-300",children:["← ",i("lessons.back")]}),l==="loading"&&f.jsx("p",{className:"mt-6 text-slate-500",children:i("lessons.loading")}),l==="error"&&f.jsx("p",{className:"mt-6 text-rose-600",children:i("lessons.error")}),l==="ok"&&s&&f.jsx(Q.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},className:"card mt-4",children:f.jsx(ie,{markdown:s.markdown})},s.slug+o),l==="ok"&&s&&Un(s.slug).map($=>f.jsx(ot,{snippets:$.snippets,caption:$.caption},$.id)),l==="ok"&&s&&f.jsxs(f.Fragment,{children:[f.jsx(Rn,{slug:s.slug}),f.jsx(In,{slug:s.slug})]})]})}const Jn=(a,e,t)=>(a(e+t)-a(e))/t,Yn=(a,e,t)=>(a(e)-a(e-t))/t,Zn=(a,e,t)=>(a(e+t)-a(e-t))/(2*t),Xn=(a,e,t)=>(a(e-t)-2*a(e)+a(e+t))/(t*t),He=(a,e,t)=>(a(e-2*t)-8*a(e-t)+8*a(e+t)-a(e+2*t))/(12*t),Ce={forward:{id:"forward",order:1,apply:Jn},backward:{id:"backward",order:1,apply:Yn},central:{id:"central",order:1,apply:Zn},"five-point":{id:"five-point",order:1,apply:He},second:{id:"second",order:2,apply:Xn}};function ea(a,e,t,n){const i=(t-e)/n;let r=.5*(a(e)+a(t));for(let o=1;o<n;o++)r+=a(e+o*i);return r*i}function Ve(a,e,t,n){const i=n%2===0?n:n+1,r=(t-e)/i;let o=a(e)+a(t);for(let s=1;s<i;s++)o+=(s%2===0?2:4)*a(e+s*r);return o*r/3}const Ue={2:{nodes:[-.5773502692,.5773502692],weights:[1,1]},3:{nodes:[-.7745966692,0,.7745966692],weights:[.5555555556,.8888888889,.5555555556]},4:{nodes:[-.8611363116,-.3399810436,.3399810436,.8611363116],weights:[.3478548451,.6521451549,.6521451549,.3478548451]},5:{nodes:[-.9061798459,-.5384693101,0,.5384693101,.9061798459],weights:[.236926885,.4786286705,.5688888889,.4786286705,.236926885]}};function ee(a,e,t,n){const{nodes:i,weights:r}=Ue[n],o=(t-e)/2,s=(e+t)/2;let h=0;for(let l=0;l<i.length;l++)h+=r[l]*a(o*i[l]+s);return o*h}const Pe={trapezoid:{id:"trapezoid",usesN:!0,apply:ea},simpson:{id:"simpson",usesN:!0,apply:Ve},gauss2:{id:"gauss2",usesN:!1,apply:(a,e,t)=>ee(a,e,t,2)},gauss3:{id:"gauss3",usesN:!1,apply:(a,e,t)=>ee(a,e,t,3)},gauss4:{id:"gauss4",usesN:!1,apply:(a,e,t)=>ee(a,e,t,4)},gauss5:{id:"gauss5",usesN:!1,apply:(a,e,t)=>ee(a,e,t,5)}};function ta(a,e,t,n=4e3){return Ve(a,e,t,n)}const Qe=(a,e)=>Math.abs(a-e),xe=ft(ht,{}),Ae=[{id:"exp_x2x",latex:"e^{x^2+x}",expr:"exp(x^2 + x)"},{id:"exp_x",latex:"e^{x}",expr:"exp(x)"},{id:"x2_exp_x",latex:"x^2 e^{x}",expr:"x^2 * exp(x)"},{id:"sin",latex:"\\sin x",expr:"sin(x)"},{id:"poly",latex:"x^4 - 6x^2 + 3x",expr:"x^4 - 6*x^2 + 3*x"},{id:"exp_sin",latex:"e^{x}\\sin x",expr:"exp(x) * sin(x)"}];function ue(a){try{const e=xe.parse(a),t=e.compile(),n=r=>{const o=t.evaluate({x:r});return typeof o=="number"?o:Number(o)},i=n(.123);return Number.isFinite(i),{f:n,ok:!0,node:e}}catch(e){return{f:()=>NaN,ok:!1,error:e instanceof Error?e.message:String(e)}}}function na(a,e,t){try{let r=xe.parse(a);for(let l=0;l<t;l++)r=xe.derivative(r,"x");const s=r.compile().evaluate({x:e}),h=typeof s=="number"?s:Number(s);if(Number.isFinite(h))return h}catch{}const{f:n}=ue(a),i=1e-4;return t===1?He(n,e,i):(n(e-i)-2*n(e)+n(e+i))/(i*i)}function U({label:a,value:e,min:t,max:n,step:i,onChange:r,format:o}){return f.jsxs("label",{className:"block",children:[f.jsxs("div",{className:"mb-1 flex items-baseline justify-between",children:[f.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a}),f.jsx("span",{className:"font-mono text-sm font-semibold text-brand-700 dark:text-brand-300",children:o?o(e):e})]}),f.jsx("input",{type:"range",min:t,max:n,step:i,value:e,onChange:s=>r(Number(s.target.value)),className:"h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-brand-600 dark:bg-slate-700"})]})}const A={top:12,right:12,bottom:24,left:36};function Je({f:a,xMin:e,xMax:t,width:n=520,height:i=300,segments:r=[],areas:o=[],points:s=[]}){const{curve:h,x:l,y:c,yMin:$,yMax:d}=k.useMemo(()=>{const u=[],z=[];for(let _=0;_<=240;_++){const v=e+(t-e)*_/240;u.push(v),z.push(a(v))}const y=z.filter(_=>Number.isFinite(_));for(const _ of o)for(const[,v]of _.points)y.push(v);for(const _ of r)for(const[,v]of _.points)y.push(v);for(const _ of s)y.push(_.y);let g=Math.min(...y,0),q=Math.max(...y,0);(!Number.isFinite(g)||!Number.isFinite(q)||g===q)&&(g=-1,q=1);const j=(q-g)*.1||1;g-=j,q+=j;const N=ge().domain([e,t]).range([A.left,n-A.right]),S=ge().domain([g,q]).range([i-A.bottom,A.top]);let L="",T=!1;for(let _=0;_<=240;_++){const v=z[_];if(!Number.isFinite(v)){T=!1;continue}const P=N(u[_]),I=S(v);L+=`${T?"L":"M"}${P.toFixed(2)},${I.toFixed(2)} `,T=!0}return{curve:L,x:N,y:S,yMin:g,yMax:q}},[a,e,t,n,i,o,r,s]),x=p=>p.map((u,z)=>`${z?"L":"M"}${l(u[0]).toFixed(2)},${c(u[1]).toFixed(2)}`).join(" "),m=$<0&&d>0?c(0):null,w=e<0&&t>0?l(0):null;return f.jsxs("svg",{viewBox:`0 0 ${n} ${i}`,className:"h-auto w-full text-slate-400 dark:text-slate-500",role:"img",children:[f.jsx("rect",{x:A.left,y:A.top,width:n-A.left-A.right,height:i-A.top-A.bottom,className:"fill-transparent stroke-slate-200 dark:stroke-slate-700"}),m!==null&&f.jsx("line",{x1:A.left,x2:n-A.right,y1:m,y2:m,stroke:"currentColor",strokeWidth:1}),w!==null&&f.jsx("line",{x1:w,x2:w,y1:A.top,y2:i-A.bottom,stroke:"currentColor",strokeWidth:1}),o.map((p,u)=>f.jsx("path",{d:`${x(p.points)} Z`,fill:p.color??"#06b6d4",fillOpacity:.22,stroke:p.color??"#06b6d4",strokeOpacity:.5,strokeWidth:1},`a${u}`)),f.jsx("path",{d:h,fill:"none",stroke:"#6366f1",strokeWidth:2.5,strokeLinejoin:"round"}),r.map((p,u)=>f.jsx("path",{d:x(p.points),fill:"none",stroke:p.color??"#f59e0b",strokeWidth:2,strokeDasharray:p.dashed?"5 4":void 0},`s${u}`)),s.map((p,u)=>f.jsx("circle",{cx:l(p.x),cy:c(p.y),r:4,fill:p.color??"#f59e0b",stroke:"#fff",strokeWidth:1.5},`p${u}`)),f.jsx("text",{x:A.left,y:i-6,className:"fill-slate-500 text-[10px]",children:e}),f.jsx("text",{x:n-A.right,y:i-6,textAnchor:"end",className:"fill-slate-500 text-[10px]",children:t})]})}function aa({tex:a,display:e=!1,className:t}){const n=k.useMemo(()=>{try{return dt.renderToString(a,{displayMode:e,throwOnError:!1})}catch{return a}},[a,e]);return f.jsx("span",{className:t,dangerouslySetInnerHTML:{__html:n}})}function Ye({expr:a,onChange:e,valid:t}){const{t:n}=E(),i=Ae.find(r=>r.expr===a);return f.jsxs("div",{children:[f.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:n("playground.function")}),f.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:Ae.map(r=>f.jsx("button",{type:"button",onClick:()=>e(r.expr),className:`chip border transition ${(i==null?void 0:i.id)===r.id?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:f.jsx(aa,{tex:r.latex})},r.id))}),f.jsxs("label",{className:"mt-3 block",children:[f.jsx("span",{className:"text-xs uppercase tracking-wide text-slate-400",children:n("playground.custom")}),f.jsx("input",{type:"text",value:a,spellCheck:!1,onChange:r=>e(r.target.value),className:`mt-1 w-full rounded-xl border bg-white px-3 py-2 font-mono text-sm outline-none transition dark:bg-slate-800 ${t?"border-slate-200 focus:border-brand-400 dark:border-slate-700":"border-rose-400 focus:border-rose-500"}`})]}),t?f.jsx("p",{className:"mt-1 text-xs text-slate-400",children:n("playground.custom_hint")}):f.jsx("p",{className:"mt-1 text-xs text-rose-500",children:n("playground.invalid")})]})}const Oe=a=>Number.isFinite(a)?a.toPrecision(7):"—",ra=a=>Number.isFinite(a)?a.toExponential(4):"—";function Ze({approx:a,reference:e,error:t}){const{t:n}=E(),i=[{label:n("playground.approx"),value:Oe(a),accent:!0},{label:n("playground.reference"),value:Oe(e),accent:!1},{label:n("playground.error"),value:ra(t),accent:!1}];return f.jsx("dl",{className:"grid gap-2",children:i.map(r=>f.jsxs("div",{className:"flex items-center justify-between rounded-xl bg-slate-100 px-4 py-2 dark:bg-slate-800/70",children:[f.jsx("dt",{className:"text-sm text-slate-500 dark:text-slate-400",children:r.label}),f.jsx("dd",{className:`font-mono text-sm font-semibold ${r.accent?"text-brand-700 dark:text-brand-300":"text-slate-800 dark:text-slate-100"}`,children:r.value})]},r.label))})}const ia=["forward","backward","central","five-point","second"];function sa(){const{t:a}=E(),[e,t]=k.useState("exp(x^2 + x)"),[n,i]=k.useState("central"),[r,o]=k.useState(0),[s,h]=k.useState(.1),l=k.useMemo(()=>ue(e),[e]),c=Ce[n].order,{approx:$,reference:d,error:x,segments:m,points:w}=k.useMemo(()=>{if(!l.ok)return{approx:NaN,reference:NaN,error:NaN,segments:[],points:[]};const u=l.f,z=Ce[n].apply(u,r,s),y=na(e,r,c),g=Qe(z,y),q=[],j=[],N=u(r);if(j.push({x:r,y:N,color:"#ef4444"}),c===1){const S=Math.max(2*s,1),L=r-S,T=r+S;q.push({points:[[L,N+y*(L-r)],[T,N+y*(T-r)]],color:"#10b981",dashed:!0}),n==="central"||n==="five-point"?(j.push({x:r-s,y:u(r-s)},{x:r+s,y:u(r+s)}),q.push({points:[[r-s,u(r-s)],[r+s,u(r+s)]],color:"#f59e0b"})):n==="forward"?(j.push({x:r+s,y:u(r+s)}),q.push({points:[[r,N],[r+s,u(r+s)]],color:"#f59e0b"})):(j.push({x:r-s,y:u(r-s)}),q.push({points:[[r-s,u(r-s)],[r,N]],color:"#f59e0b"}))}else j.push({x:r-s,y:u(r-s)},{x:r+s,y:u(r+s)});return{approx:z,reference:y,error:g,segments:q,points:j}},[l,n,r,s,e,c]),p=Math.max(2.5*s,1.5);return f.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[f.jsxs("div",{className:"card space-y-4",children:[f.jsx(Ye,{expr:e,onChange:t,valid:l.ok}),f.jsxs("div",{children:[f.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),f.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:ia.map(u=>f.jsx("button",{type:"button",onClick:()=>i(u),className:`chip border transition ${n===u?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${u}`)},u))})]}),f.jsx(U,{label:a("playground.x0"),value:r,min:-3,max:3,step:.1,onChange:o,format:u=>u.toFixed(2)}),f.jsx(U,{label:a("playground.h"),value:s,min:.01,max:1,step:.01,onChange:h,format:u=>u.toFixed(2)}),f.jsx(Ze,{approx:$,reference:d,error:x})]}),f.jsxs("div",{className:"card",children:[f.jsx(Je,{f:l.f,xMin:r-p,xMax:r+p,segments:m,points:w}),f.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),c===1&&f.jsxs(f.Fragment,{children:[f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-1 w-4 rounded bg-amber-500"})," ",a("playground.approx")]}),f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-1 w-4 rounded bg-emerald-500"})," ",a("playground.reference")]})]})]})]})]})}const oa=["trapezoid","simpson","gauss2","gauss3","gauss4","gauss5"];function la(){const{t:a}=E(),[e,t]=k.useState("x^2 * exp(x)"),[n,i]=k.useState("simpson"),[r,o]=k.useState(0),[s,h]=k.useState(1),[l,c]=k.useState(4),$=k.useMemo(()=>ue(e),[e]),d=Pe[n].usesN,{approx:x,reference:m,error:w,areas:p,points:u}=k.useMemo(()=>{if(!$.ok||s<=r)return{approx:NaN,reference:NaN,error:NaN,areas:[],points:[]};const y=$.f,g=Pe[n].apply(y,r,s,l),q=ta(y,r,s),j=Qe(g,q),N=[],S=[];if(n==="trapezoid"){const L=(s-r)/l;for(let T=0;T<l;T++){const _=r+T*L,v=_+L;N.push({points:[[_,0],[_,y(_)],[v,y(v)],[v,0]]})}}else{const L=[[r,0]],T=80;for(let _=0;_<=T;_++){const v=r+(s-r)*_/T;L.push([v,y(v)])}if(L.push([s,0]),N.push({points:L}),n.startsWith("gauss")){const _=Number(n.slice(5)),v=(s-r)/2,P=(r+s)/2;for(const I of Ue[_].nodes){const F=v*I+P;S.push({x:F,y:y(F),color:"#ef4444"})}}}return{approx:g,reference:q,error:j,areas:N,points:S}},[$,n,r,s,l]),z=(s-r)*.1||.2;return f.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[f.jsxs("div",{className:"card space-y-4",children:[f.jsx(Ye,{expr:e,onChange:t,valid:$.ok}),f.jsxs("div",{children:[f.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),f.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:oa.map(y=>f.jsx("button",{type:"button",onClick:()=>i(y),className:`chip border transition ${n===y?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${y}`)},y))})]}),f.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[f.jsx(U,{label:a("playground.a"),value:r,min:-3,max:3,step:.1,onChange:o,format:y=>y.toFixed(2)}),f.jsx(U,{label:a("playground.b"),value:s,min:-3,max:4,step:.1,onChange:h,format:y=>y.toFixed(2)})]}),d&&f.jsx(U,{label:a("playground.n"),value:l,min:2,max:20,step:n==="simpson"?2:1,onChange:c}),f.jsx(Ze,{approx:x,reference:m,error:w})]}),f.jsxs("div",{className:"card",children:[f.jsx(Je,{f:$.f,xMin:r-z,xMax:s+z,areas:p,points:u}),f.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-3 w-4 rounded bg-accent-500/30"})," ∫ region"]}),n.startsWith("gauss")&&f.jsxs("span",{className:"flex items-center gap-1",children:[f.jsx("span",{className:"inline-block h-2 w-2 rounded-full bg-red-500"})," nodes"]})]})]})]})}function fa(){const{t:a}=E(),[e,t]=k.useState("diff");return f.jsxs("div",{children:[f.jsx("h1",{className:"text-3xl font-extrabold",children:a("playground.title")}),f.jsx("p",{className:"mt-1 text-slate-500 dark:text-slate-400",children:a("playground.lead")}),f.jsx("div",{className:"mt-5 inline-flex rounded-xl bg-slate-200 p-1 dark:bg-slate-800",children:["diff","int"].map(n=>f.jsx("button",{type:"button",onClick:()=>t(n),className:`rounded-lg px-4 py-2 text-sm font-semibold transition ${e===n?"bg-white text-brand-700 shadow dark:bg-slate-900 dark:text-brand-300":"text-slate-600 dark:text-slate-300"}`,children:a(n==="diff"?"playground.tab_diff":"playground.tab_int")},n))}),f.jsx("div",{className:"mt-5",children:e==="diff"?f.jsx(sa,{}):f.jsx(la,{})})]})}function ha({correct:a,total:e,onRetry:t}){const{t:n}=E(),i=e?Math.round(a/e*100):0,r=i>=80?"🏆":i>=50?"👍":"📚";return f.jsxs(Q.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},className:"card text-center",children:[f.jsx("div",{className:"text-6xl",children:r}),f.jsx("h2",{className:"mt-3 text-2xl font-extrabold",children:n("quiz.results_title")}),f.jsx("p",{className:"mt-2 text-lg text-slate-600 dark:text-slate-300",children:n("quiz.results_score",{correct:a,total:e})}),f.jsx("div",{className:"mx-auto mt-4 h-3 w-full max-w-sm overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:f.jsx(Q.div,{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500",initial:{width:0},animate:{width:`${i}%`},transition:{duration:.6}})}),f.jsxs("div",{className:"mt-6 flex flex-wrap justify-center gap-3",children:[f.jsx("button",{type:"button",onClick:t,className:"btn-primary",children:n("quiz.retry")}),f.jsx(Ee,{to:"/numerical-calculus/lessons",className:"btn-ghost",children:n("quiz.to_lessons")})]})]})}function da(){var _;const{t:a,i18n:e}=E(),t=e.language==="hu"?"hu":"en",[n,i]=k.useState([]),[r,o]=k.useState(0),[s,h]=k.useState(""),[l,c]=k.useState(null),[$,d]=k.useState(0),[x,m]=k.useState(0),[w,p]=k.useState(!1),[u,z]=k.useState(!0);function y(v=n){o(0),h(""),c(null),d(0),m(0),p(!1)}if(k.useEffect(()=>{z(!0),Pn(t).then(v=>{i(v),y(v)}).finally(()=>z(!1))},[t]),u)return f.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(!n.length)return f.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(w)return f.jsx(ha,{correct:$,total:n.length,onRetry:()=>y()});const g=n[r],q=r===n.length-1,j=l!==null,N=s!==""&&!j;async function S(){if(s==="")return;const v=await An(g.id,s,t);c(v),v.correct?(d(P=>P+1),m(P=>P+1)):m(0)}function L(){if(q){p(!0);return}o(v=>v+1),h(""),c(null)}const T=(v,P)=>j?v?"border-emerald-500 bg-emerald-50 dark:bg-emerald-900/30":P?"border-rose-500 bg-rose-50 dark:bg-rose-900/30":"border-slate-200 bg-white opacity-60 dark:border-slate-700 dark:bg-slate-800":P?"border-brand-500 bg-brand-50 dark:bg-brand-900/40":"border-slate-200 bg-white hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800";return f.jsxs("div",{className:"card",children:[f.jsxs("div",{className:"flex items-center justify-between text-sm",children:[f.jsxs("span",{className:"font-semibold text-slate-500 dark:text-slate-400",children:[a("quiz.question")," ",r+1," ",a("quiz.of")," ",n.length]}),f.jsxs("span",{className:"flex gap-3",children:[f.jsxs("span",{className:"chip bg-brand-100 text-brand-700 dark:bg-brand-900/50 dark:text-brand-200",children:[a("quiz.score"),": ",$]}),f.jsxs("span",{className:"chip bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-200",children:["🔥 ",x]})]})]}),f.jsx("div",{className:"mt-2 h-1.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:f.jsx("div",{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500 transition-all",style:{width:`${(r+(j?1:0))/n.length*100}%`}})}),f.jsxs("span",{className:"mt-4 inline-block chip bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400",children:[a("quiz.topic")," ",g.topic]}),f.jsx(lt,{mode:"wait",children:f.jsxs(Q.div,{initial:{opacity:0,x:16},animate:{opacity:1,x:0},exit:{opacity:0,x:-16},children:[f.jsx("h2",{className:"mt-3 text-lg font-semibold",children:g.prompt}),f.jsxs("div",{className:"mt-4 space-y-2",children:[g.type==="mcq"&&((_=g.options)==null?void 0:_.map((v,P)=>f.jsxs("button",{type:"button",disabled:j,onClick:()=>h(P),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${T((l==null?void 0:l.answer)===P,s===P)}`,children:[f.jsx("span",{className:"grid h-6 w-6 shrink-0 place-items-center rounded-full bg-slate-200 text-xs font-bold dark:bg-slate-700",children:String.fromCharCode(65+P)}),v]},P))),g.type==="truefalse"&&[!0,!1].map(v=>f.jsx("button",{type:"button",disabled:j,onClick:()=>h(v),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${T((l==null?void 0:l.answer)===v,s===v)}`,children:a(v?"quiz.true":"quiz.false")},String(v))),g.type==="numeric"&&f.jsx("input",{type:"number",step:"any",disabled:j,placeholder:a("quiz.numeric_placeholder"),value:s===""?"":String(s),onChange:v=>h(v.target.value===""?"":Number(v.target.value)),className:"w-full rounded-xl border border-slate-200 bg-white px-4 py-3 font-mono outline-none focus:border-brand-400 dark:border-slate-700 dark:bg-slate-800"})]}),j&&f.jsxs(Q.div,{initial:{opacity:0,y:6},animate:{opacity:1,y:0},className:`mt-4 rounded-xl p-4 ${l!=null&&l.correct?"bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-200":"bg-rose-50 text-rose-800 dark:bg-rose-900/30 dark:text-rose-200"}`,children:[f.jsx("p",{className:"font-bold",children:l!=null&&l.correct?a("quiz.correct"):a("quiz.incorrect")}),f.jsx("p",{className:"mt-1 text-sm",children:l==null?void 0:l.explanation})]})]},g.id)}),f.jsx("div",{className:"mt-5 flex justify-end gap-3",children:j?f.jsx("button",{type:"button",onClick:L,className:"btn-primary",children:a(q?"quiz.finish":"quiz.next")}):f.jsx("button",{type:"button",disabled:!N,onClick:S,className:"btn-primary disabled:opacity-50",children:a("quiz.check")})})]})}function ca(){const{t:a}=E();return f.jsxs("div",{children:[f.jsx("h1",{className:"text-3xl font-extrabold",children:a("quiz.title")}),f.jsx("p",{className:"mb-5 mt-1 text-slate-500 dark:text-slate-400",children:a("quiz.lead")}),f.jsx(da,{})]})}const Xe=De,$a=[...Xe.map(a=>({id:a.slug,no:a.id==="intro"?"7":a.id,title:a.title,blurb:{en:"",hu:""}})),{id:"playground",no:"7·pg",title:{en:"Playground",hu:"Játéktér"},blurb:{en:"",hu:""}},{id:"quiz",no:"7·qz",title:{en:"Quiz",hu:"Kvíz"},blurb:{en:"",hu:""}}];function va(){const a=tt(),{t:e}=E(),{lang:t}=nt();k.useEffect(()=>{C.changeLanguage(t)},[t]),k.useEffect(()=>{let i=decodeURIComponent(a.hash.replace(/^#/,""));if(!i){const r=a.pathname.match(/\/lessons\/([^/]+)/);if(r)i=r[1];else{const o=a.pathname.split("/").filter(Boolean).pop()??"";["playground","quiz"].includes(o)&&(i=o)}}i&&requestAnimationFrame(()=>{var r;return(r=document.getElementById(i))==null?void 0:r.scrollIntoView()})},[a.pathname,a.hash]);const n={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return f.jsxs("div",{className:"flex min-h-screen flex-col",children:[f.jsx(ct,{sections:$a}),f.jsxs("main",{className:"mx-auto w-full max-w-5xl flex-1 space-y-16 px-4 py-8",children:[Xe.map(i=>f.jsx("section",{id:i.slug,style:n,children:f.jsx(Qn,{slug:i.slug})},i.slug)),f.jsx("section",{id:"playground",style:n,children:f.jsx(fa,{})}),f.jsx("section",{id:"quiz",style:n,children:f.jsx(ca,{})})]}),f.jsx("footer",{className:"border-t border-slate-200 py-6 text-center text-sm text-slate-400 dark:border-slate-800",children:e("app.footer")})]})}export{va as default};
