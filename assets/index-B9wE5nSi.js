...
`,qe={lagrange:{en:pe,hu:ue},newton:{en:ye,hu:ke},hermite:{en:be,hu:ve},spline:{en:ze,hu:we}};function je(t,a){var s;return((s=qe[t])==null?void 0:s[a])??""}const Le=`function a = lagrange_coeffs(x, y)
...
`,He=`function a = divided_differences(x, y)
...
`,Ee=`function [a, b, c, d] = natural_cubic_spline(x, y)
...
`,Pe={lagrange:{id:"lagrange",snippets:{matlab:Le,python:Te,cpp:Se},caption:{en:"Lagrange interpolation (Vandermonde system)",hu:"Lagrange-interpoláció (Vandermonde-rendszer)"}},newton:{id:"newton",snippets:{matlab:He,python:Ae,cpp:De},caption:{en:"Newton's divided differences",hu:"Newton-féle osztott differenciák"}},hermite:{id:"hermite",snippets:{matlab:Ne,python:Ie,cpp:Ce},caption:{en:"Hermite interpolation",hu:"Hermite-interpoláció"}},spline:{id:"spline",snippets:{matlab:Ee,python:Me,cpp:We},caption:{en:"Natural cubic spline",hu:"Természetes köbös spline"}}};function Fe(t){return Pe[t]}function C({str:t,method:a,points:s,derivatives:i,allowCompare:r,showTable:o,enableDerivatives:l}){const{lang:$}=P(),n=t.lessons[a],_=je(a,$),c=Fe(a);return e.jsxs("article",{className:"lesson",children:[e.jsxs("header",{children:[e.jsx("h2",{children:n.title}),e.jsx("p",{className:"intro",children:n.intro})]}),e.jsxs("section",{className:"theorem-card",children:[e.jsx("div",{className:"theorem-tag",children:n.theoremTitle}),e.jsx(J,{block:!0,children:n.theorem}),e.jsx("p",{children:n.body})]}),_&&e.jsxs("details",{className:"lesson__theory",open:!0,children:[e.jsx("summary",{children:$==="hu"?"Elmélet":"Theory"}),e.jsx(W,{markdown:_})]}),c&&e.jsx(Y,{snippets:c.snippets,caption:c.caption}),e.jsxs("p",{className:"tryit",children:["👉 ",n.tryIt]}),e.jsx(de,{str:t,initialPoints:s,initialDerivs:i,primary:a,allowCompare:r,showTable:o,enableDerivatives:l}),e.jsx(ce,{deck:a}),e.jsx(ge,{deck:a})]})}const E={lagrange:"#ff5d8f",newton:"#f5a623",hermite:"#9b5de5",spline:"#00bbf9"},Q=t=>Math.cos(t),M=[-Math.PI-.5,Math.PI+.5],Ve=[-2.5,2.5];function Re(){const t=Array.from({length:40}),a=["#ff5d8f","#f5a623","#9b5de5","#00bbf9","#3ddc97"];return e.jsx("div",{className:"confetti","aria-hidden":!0,children:t.map((s,i)=>e.jsx("span",{style:{left:`${Math.random()*100}%`,background:a[i%a.length],animationDelay:`${Math.random()*.6}s`,transform:`rotate(${Math.random()*360}deg)`}},i))})}function Be({str:t}){const[a,s]=g.useState([{x:-3,y:-.5},{x:-1.2,y:.5},{x:.5,y:.7},{x:2,y:-.2},{x:3,y:-.8}]),[i,r]=g.useState("spline"),[o,l]=g.useState(!0),$=g.useMemo(()=>[...a].sort((h,u)=>h.x-u.x),[a]),n=g.useMemo(()=>F(i,$),[i,$]),_=g.useMemo(()=>{let h=0;for(let u=0;u<=80;u++){const b=M[0]+(M[1]-M[0])*u/80,j=Math.abs(n(b)-Q(b));Number.isFinite(j)&&(h=Math.max(h,j))}return h},[n]),c=_<.18,m=[{fn:n,color:E[i],label:t.methods[i]}];o&&m.push({fn:Q,color:"#8aa0b5",label:"cos x",dashed:!0});const p=(h,u,b)=>s(j=>j.map((T,S)=>S===h?{x:u,y:b}:T));return e.jsxs("div",{className:"challenge",children:[e.jsxs("div",{className:"challenge-head",children:[e.jsx("h2",{children:t.nav.playground}),e.jsx("p",{className:"intro",children:t.tagline})]}),e.jsxs("div",{className:"challenge-bar",children:[e.jsx("div",{className:"methodpills",children:Object.keys(E).map(h=>e.jsx("button",{className:`pill ${i===h?"on":""}`,style:i===h?{background:E[h],borderColor:E[h]}:{},onClick:()=>r(h),children:t.methods[h]},h))}),e.jsxs("label",{className:"chip",children:[e.jsx("input",{type:"checkbox",checked:o,onChange:()=>l(h=>!h)}),t.ui.showCos]})]}),e.jsxs("div",{className:"challenge-plotwrap",children:[e.jsx(U,{points:a,curves:m,domain:M,range:Ve,onDrag:p,width:720,height:440}),c&&e.jsx(Re,{})]}),e.jsx("div",{className:`challenge-status ${c?"win":""}`,children:c?e.jsx("strong",{children:t.ui.nailedIt}):e.jsxs("span",{children:["🎯 ",t.ui.challengeHint," ",e.jsxs("em",{children:["(max Δ = ",_.toFixed(2),")"]})]})})]})}const Oe=[{id:"play",no:"6·play",title:{en:w.en.nav.playground,hu:w.hu.nav.playground},blurb:{en:"",hu:""}},{id:"lagrange",no:"6.1",title:{en:w.en.nav.lagrange,hu:w.hu.nav.lagrange},blurb:{en:"",hu:""}},{id:"newton",no:"6.2",title:{en:w.en.nav.newton,hu:w.hu.nav.newton},blurb:{en:"",hu:""}},{id:"hermite",no:"6.4",title:{en:w.en.nav.hermite,hu:w.hu.nav.hermite},blurb:{en:"",hu:""}},{id:"spline",no:"6.5",title:{en:w.en.nav.spline,hu:w.hu.nav.spline},blurb:{en:"",hu:""}}];function Ze(){const{lang:t}=P(),a=w[t],s={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return e.jsxs("div",{className:"app ch-interpolation",children:[e.jsx(X,{sections:Oe}),e.jsx("header",{className:"topbar",children:e.jsxs("div",{className:"brand",children:[e.jsx("span",{className:"logo",children:"📈"}),e.jsxs("div",{children:[e.jsx("div",{className:"brand-title",children:a.appTitle}),e.jsx("div",{className:"brand-sub",children:a.tagline})]})]})}),e.jsxs("main",{className:"content",children:[e.jsx("section",{id:"play",style:s,children:e.jsx(Be,{str:a})}),e.jsx("section",{id:"lagrange",style:s,children:e.jsx(C,{str:a,method:"lagrange",points:[{x:-1,y:-3},{x:1,y:1},{x:2,y:3},{x:3,y:29}],allowCompare:!0})}),e.jsx("section",{id:"newton",style:s,children:e.jsx(C,{str:a,method:"newton",points:[{x:-1,y:-2},{x:1,y:0},{x:2,y:-2},{x:3,y:2}],showTable:!0,allowCompare:!0})}),e.jsx("section",{id:"hermite",style:s,children:e.jsx(C,{str:a,method:"hermite",points:[{x:-1,y:2},{x:1,y:4},{x:2,y:11}],derivatives:[3,-5,30],enableDerivatives:!0})}),e.jsx("section",{id:"spline",style:s,children:e.jsx(C,{str:a,method:"spline",points:[{x:0,y:.5},{x:1,y:.1},{x:1.5,y:2.5},{x:2,y:-1},{x:3,y:-.5},{x:4,y:0}],allowCompare:!0})})]}),e.jsx("footer",{className:"foot",children:"InterPlay · Numerical Analysis 6 · Interpolation — F. Hartung, University of Pannonia"})]})}export{Ze as default};
