...
`,Sn=`## 7.2. Richardson-extrapoláció
...
// -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Gn=`function composite(f, a, b, n = 10)
...
println("Simpson   = ", S)
# -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Hn=`// Composite trapezoidal and Simpson rules on [a, b] with n subintervals.
...
// -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Vn=`function [T, S] = composite(f, a, b, n)
...
# -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Bn=`# Composite trapezoidal and Simpson rules on [a, b] with n subintervals.
...
# -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Qn=`// Composite trapezoidal and Simpson rules on [a, b] with n subintervals.
...
// -> trapezoid ~ 1.7197135, Simpson ~ 1.7182828; exact e-1 = 1.7182818
`,Jn=`composite[f_, a_, b_, nIn_ : 10] := Module[{n = nIn, h, T, S},
...
`,Zn=`program differentiation_demo
  implicit none
  real(8) :: x, h
  x = 1d0; h = 0.01d0
...
// -> 1.7178964 (2-pt), 1.7182810 (3-pt); exact e-1 = 1.7182818
`,da=`function gauss_quad(f, a, b, n = 2)
    if n == 3
...
# -> 1.7178964 (2-pt), 1.7182810 (3-pt); exact e-1 = 1.7182818
`,fa=`// 2- or 3-point Gauss-Legendre quadrature on [a, b].
...
if __name__ == "__main__":
    ...
    print("exact e-1 =", math.e - 1)
# -> 1.7178964 (2-pt), 1.7182810 (3-pt); exact e-1 = 1.7182818
`,pa=`# 2- or 3-point Gauss-Legendre quadrature on [a, b].
...
# -> 1.7178964 (2-pt), 1.7182810 (3-pt); exact e-1 = 1.7182818
`,ma=`// 2- or 3-point Gauss-Legendre quadrature on [a, b].
...
// -> 1.7178964 (2-pt), 1.7182810 (3-pt); exact e-1 = 1.7182818
`,ga=`gaussQuad[f_, a_, b_, n_ : 2] := Module[{t, w, hm, mid},
   {t, w} = If[n == 3,
...
`,_a=`# Central-difference first derivative D(h), error O(h^2).
...
`,Ca=`function simpson(f, a, b, n = 100)
    isodd(n) && (n += 1)
    h = (b - a) / n
    s = f(a) + f(b)
    for i in 1:n-1
...
`,Ta=`// Composite Simpson's rule (n forced even) on [a, b].
...
`,Ra=`# Composite Simpson's rule (n forced even) on [a, b].
...
`,Ka=`simpson[f_, a_, b_, nIn_ : 100] := Module[{n = nIn, h},
   If[OddQ[n], n++];
   h = (b - a)/n;
...
`,Ia=`function trapezoid(f, a, b, n = 100)
    h = (b - a) / n
    s = (f(a) + f(b)) / 2
    for i in 1:n-1
        s += f(a + i*h)
...
`,Va=`trapezoid[f_, a_, b_, n_ : 100] := Module[{h = (b - a)/n},
   h (f[a]/2 + f[b]/2 + Sum[f[a + i h], {i, 1, n - 1}])];
Print["int_0^1 e^x dx = ", trapezoid[Exp, 0., 1., 100]]
`,Ua=Object.assign({"./composite.cpp":Mn,"./composite.f90":Dn,"./composite.go":Wn,"./composite.jl":Gn,"./composite.js":Hn,"./composite.m":Vn,"./composite.py":Un,"./composite.r":Bn,"./composite.rs":Qn,"./composite.wl":Jn,"./differentiation.cpp":Yn,"./differentiation.f90":Zn,"./differentiation.go":Xn,"./differentiation.jl":ea,"./differentiation.js":ta,"./differentiation.m":na,"./differentiation.py":aa,"./differentiation.r":ra,"./differentiation.rs":ia,"./differentiation.wl":sa,"./gauss-quad.cpp":oa,"./gauss-quad.f90":la,"./gauss-quad.go":ha,"./gauss-quad.jl":da,"./gauss-quad.js":fa,"./gauss-quad.m":ca,"./gauss-quad.py":ua,"./gauss-quad.r":pa,"./gauss-quad.rs":ma,"./gauss-quad.wl":ga,"./richardson.cpp":xa,"./richardson.f90":$a,"./richardson.go":ba,"./richardson.jl":_a,"./richardson.js":ya,"./richardson.m":va,"./richardson.py":ka,"./richardson.r":wa,"./richardson.rs":za,"./richardson.wl":qa,"./simpson.cpp":Sa,"./simpson.f90":Na,"./simpson.go":ja,"./simpson.jl":Ca,"./simpson.js":Ta,"./simpson.m":Oa,"./simpson.py":La,"./simpson.r":Ra,"./simpson.rs":Pa,"./simpson.wl":Ka,"./trapezoid.cpp":Fa,"./trapezoid.f90":Aa,"./trapezoid.go":Ea,"./trapezoid.jl":Ia,"./trapezoid.js":Ma,"./trapezoid.m":Da,"./trapezoid.py":Wa,"./trapezoid.r":Ga,"./trapezoid.rs":Ha,"./trapezoid.wl":Va}),F=(a,e)=>Ua[`./${a}.${e}`],Ba={differentiation:{en:"Numerical differentiation (central differences)",hu:"Numerikus deriválás (centrális differenciák)"},richardson:{en:"Richardson extrapolation of the derivative",hu:"A derivált Richardson-extrapolációja"},trapezoid:{en:"Composite trapezoidal rule",hu:"Összetett trapéz-szabály"},simpson:{en:"Composite Simpson's rule",hu:"Összetett Simpson-szabály"},"gauss-quad":{en:"Gauss–Legendre quadrature (2- and 3-point)",hu:"Gauss–Legendre-kvadratúra (2- és 3-pontos)"}},Qa=a=>({id:a,caption:Ba[a],snippets:{matlab:F(a,"m"),python:F(a,"py"),cpp:F(a,"cpp"),julia:F(a,"jl"),rust:F(a,"rs"),fortran:F(a,"f90"),wolfram:F(a,"wl"),javascript:F(a,"js"),go:F(a,"go"),r:F(a,"r")}}),Ja={"7_1":["differentiation"],"7_2":["richardson"],"7_3":["trapezoid","simpson"],"7_4":["gauss-quad"]};function Ya(a){return(Ja[a]??[]).map(Qa)}function Za({slug:a}={}){const e=tt(),t=a??e.slug??"",n=a!=null,{t:i,i18n:r}=K(),o=r.language==="hu"?"hu":"en",[s,d]=y.useState(null),[l,c]=y.useState("loading");return y.useEffect(()=>{let u=!0;return c("loading"),Ln(t,o).then(f=>{u&&(d(f),c("ok"))}).catch(()=>u&&c("error")),()=>{u=!1}},[t,o]),h.jsxs("article",{children:[!n&&h.jsxs(Fe,{to:"/numerical-calculus/lessons",className:"text-sm font-semibold text-brand-600 hover:underline dark:text-brand-300",children:["← ",i("lessons.back")]}),l==="loading"&&h.jsx("p",{className:"mt-6 text-slate-500",children:i("lessons.loading")}),l==="error"&&h.jsx("p",{className:"mt-6 text-rose-600",children:i("lessons.error")}),l==="ok"&&s&&h.jsx(J.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},className:"card mt-4",children:h.jsx(se,{markdown:s.markdown})},s.slug+o),l==="ok"&&s&&Ya(s.slug).map(u=>h.jsx(pt,{snippets:u.snippets,caption:u.caption},u.id)),l==="ok"&&s&&h.jsxs(h.Fragment,{children:[h.jsx(An,{slug:s.slug}),h.jsx(In,{slug:s.slug})]})]})}const Xa=(a,e,t)=>(a(e+t)-a(e))/t,er=(a,e,t)=>(a(e)-a(e-t))/t,tr=(a,e,t)=>(a(e+t)-a(e-t))/(2*t),nr=(a,e,t)=>(a(e-t)-2*a(e)+a(e+t))/(t*t),Ue=(a,e,t)=>(a(e-2*t)-8*a(e-t)+8*a(e+t)-a(e+2*t))/(12*t),Le={forward:{id:"forward",order:1,apply:Xa},backward:{id:"backward",order:1,apply:er},central:{id:"central",order:1,apply:tr},"five-point":{id:"five-point",order:1,apply:Ue},second:{id:"second",order:2,apply:nr}};function ar(a,e,t,n){const i=(t-e)/n;let r=.5*(a(e)+a(t));for(let o=1;o<n;o++)r+=a(e+o*i);return r*i}function Be(a,e,t,n){const i=n%2===0?n:n+1,r=(t-e)/i;let o=a(e)+a(t);for(let s=1;s<i;s++)o+=(s%2===0?2:4)*a(e+s*r);return o*r/3}const Qe={2:{nodes:[-.5773502692,.5773502692],weights:[1,1]},3:{nodes:[-.7745966692,0,.7745966692],weights:[.5555555556,.8888888889,.5555555556]},4:{nodes:[-.8611363116,-.3399810436,.3399810436,.8611363116],weights:[.3478548451,.6521451549,.6521451549,.3478548451]},5:{nodes:[-.9061798459,-.5384693101,0,.5384693101,.9061798459],weights:[.236926885,.4786286705,.5688888889,.4786286705,.236926885]}};function te(a,e,t,n){const{nodes:i,weights:r}=Qe[n],o=(t-e)/2,s=(e+t)/2;let d=0;for(let l=0;l<i.length;l++)d+=r[l]*a(o*i[l]+s);return o*d}const Re={trapezoid:{id:"trapezoid",usesN:!0,apply:ar},simpson:{id:"simpson",usesN:!0,apply:Be},gauss2:{id:"gauss2",usesN:!1,apply:(a,e,t)=>te(a,e,t,2)},gauss3:{id:"gauss3",usesN:!1,apply:(a,e,t)=>te(a,e,t,3)},gauss4:{id:"gauss4",usesN:!1,apply:(a,e,t)=>te(a,e,t,4)},gauss5:{id:"gauss5",usesN:!1,apply:(a,e,t)=>te(a,e,t,5)}};function rr(a,e,t,n=4e3){return Be(a,e,t,n)}const Je=(a,e)=>Math.abs(a-e),me=xt($t,{}),Pe=[{id:"exp_x2x",latex:"e^{x^2+x}",expr:"exp(x^2 + x)"},{id:"exp_x",latex:"e^{x}",expr:"exp(x)"},{id:"x2_exp_x",latex:"x^2 e^{x}",expr:"x^2 * exp(x)"},{id:"sin",latex:"\\sin x",expr:"sin(x)"},{id:"poly",latex:"x^4 - 6x^2 + 3x",expr:"x^4 - 6*x^2 + 3*x"},{id:"exp_sin",latex:"e^{x}\\sin x",expr:"exp(x) * sin(x)"}];function ge(a){try{const e=me.parse(a),t=e.compile(),n=r=>{const o=t.evaluate({x:r});return typeof o=="number"?o:Number(o)},i=n(.123);return Number.isFinite(i),{f:n,ok:!0,node:e}}catch(e){return{f:()=>NaN,ok:!1,error:e instanceof Error?e.message:String(e)}}}function ir(a,e,t){try{let r=me.parse(a);for(let l=0;l<t;l++)r=me.derivative(r,"x");const s=r.compile().evaluate({x:e}),d=typeof s=="number"?s:Number(s);if(Number.isFinite(d))return d}catch{}const{f:n}=ge(a),i=1e-4;return t===1?Ue(n,e,i):(n(e-i)-2*n(e)+n(e+i))/(i*i)}function Q({label:a,value:e,min:t,max:n,step:i,onChange:r,format:o}){return h.jsxs("label",{className:"block",children:[h.jsxs("div",{className:"mb-1 flex items-baseline justify-between",children:[h.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a}),h.jsx("span",{className:"font-mono text-sm font-semibold text-brand-700 dark:text-brand-300",children:o?o(e):e})]}),h.jsx("input",{type:"range",min:t,max:n,step:i,value:e,onChange:s=>r(Number(s.target.value)),className:"h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-brand-600 dark:bg-slate-700"})]})}const R={top:12,right:12,bottom:24,left:36};function Ye({f:a,xMin:e,xMax:t,width:n=520,height:i=300,segments:r=[],areas:o=[],points:s=[]}){const{curve:d,x:l,y:c,yMin:u,yMax:f}=y.useMemo(()=>{const m=[],w=[];for(let b=0;b<=240;b++){const k=e+(t-e)*b/240;m.push(k),w.push(a(k))}const v=w.filter(b=>Number.isFinite(b));for(const b of o)for(const[,k]of b.points)v.push(k);for(const b of r)for(const[,k]of b.points)v.push(k);for(const b of s)v.push(b.y);let $=Math.min(...v,0),q=Math.max(...v,0);(!Number.isFinite($)||!Number.isFinite(q)||$===q)&&($=-1,q=1);const S=(q-$)*.1||1;$-=S,q+=S;const N=be().domain([e,t]).range([R.left,n-R.right]),j=be().domain([$,q]).range([i-R.bottom,R.top]);let T="",C=!1;for(let b=0;b<=240;b++){const k=w[b];if(!Number.isFinite(k)){C=!1;continue}const L=N(m[b]),I=j(k);T+=`${C?"L":"M"}${L.toFixed(2)},${I.toFixed(2)} `,C=!0}return{curve:T,x:N,y:j,yMin:$,yMax:q}},[a,e,t,n,i,o,r,s]),p=g=>g.map((m,w)=>`${w?"L":"M"}${l(m[0]).toFixed(2)},${c(m[1]).toFixed(2)}`).join(" "),x=u<0&&f>0?c(0):null,z=e<0&&t>0?l(0):null;return h.jsxs("svg",{viewBox:`0 0 ${n} ${i}`,className:"h-auto w-full text-slate-400 dark:text-slate-500",role:"img",children:[h.jsx("rect",{x:R.left,y:R.top,width:n-R.left-R.right,height:i-R.top-R.bottom,className:"fill-transparent stroke-slate-200 dark:stroke-slate-700"}),x!==null&&h.jsx("line",{x1:R.left,x2:n-R.right,y1:x,y2:x,stroke:"currentColor",strokeWidth:1}),z!==null&&h.jsx("line",{x1:z,x2:z,y1:R.top,y2:i-R.bottom,stroke:"currentColor",strokeWidth:1}),o.map((g,m)=>h.jsx("path",{d:`${p(g.points)} Z`,fill:g.color??"#06b6d4",fillOpacity:.22,stroke:g.color??"#06b6d4",strokeOpacity:.5,strokeWidth:1},`a${m}`)),h.jsx("path",{d,fill:"none",stroke:"#6366f1",strokeWidth:2.5,strokeLinejoin:"round"}),r.map((g,m)=>h.jsx("path",{d:p(g.points),fill:"none",stroke:g.color??"#f59e0b",strokeWidth:2,strokeDasharray:g.dashed?"5 4":void 0},`s${m}`)),s.map((g,m)=>h.jsx("circle",{cx:l(g.x),cy:c(g.y),r:4,fill:g.color??"#f59e0b",stroke:"#fff",strokeWidth:1.5},`p${m}`)),h.jsx("text",{x:R.left,y:i-6,className:"fill-slate-500 text-[10px]",children:e}),h.jsx("text",{x:n-R.right,y:i-6,textAnchor:"end",className:"fill-slate-500 text-[10px]",children:t})]})}function sr({tex:a,display:e=!1,className:t}){const n=y.useMemo(()=>{try{return bt.renderToString(a,{displayMode:e,throwOnError:!1})}catch{return a}},[a,e]);return h.jsx("span",{className:t,dangerouslySetInnerHTML:{__html:n}})}function Ze({expr:a,onChange:e,valid:t}){const{t:n}=K(),i=Pe.find(r=>r.expr===a);return h.jsxs("div",{children:[h.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:n("playground.function")}),h.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:Pe.map(r=>h.jsx("button",{type:"button",onClick:()=>e(r.expr),className:`chip border transition ${(i==null?void 0:i.id)===r.id?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:h.jsx(sr,{tex:r.latex})},r.id))}),h.jsxs("label",{className:"mt-3 block",children:[h.jsx("span",{className:"text-xs uppercase tracking-wide text-slate-400",children:n("playground.custom")}),h.jsx("input",{type:"text",value:a,spellCheck:!1,onChange:r=>e(r.target.value),className:`mt-1 w-full rounded-xl border bg-white px-3 py-2 font-mono text-sm outline-none transition dark:bg-slate-800 ${t?"border-slate-200 focus:border-brand-400 dark:border-slate-700":"border-rose-400 focus:border-rose-500"}`})]}),t?h.jsx("p",{className:"mt-1 text-xs text-slate-400",children:n("playground.custom_hint")}):h.jsx("p",{className:"mt-1 text-xs text-rose-500",children:n("playground.invalid")})]})}const Ke=a=>Number.isFinite(a)?a.toPrecision(7):"—",or=a=>Number.isFinite(a)?a.toExponential(4):"—";function Xe({approx:a,reference:e,error:t}){const{t:n}=K(),i=[{label:n("playground.approx"),value:Ke(a),accent:!0},{label:n("playground.reference"),value:Ke(e),accent:!1},{label:n("playground.error"),value:or(t),accent:!1}];return h.jsx("dl",{className:"grid gap-2",children:i.map(r=>h.jsxs("div",{className:"flex items-center justify-between rounded-xl bg-slate-100 px-4 py-2 dark:bg-slate-800/70",children:[h.jsx("dt",{className:"text-sm text-slate-500 dark:text-slate-400",children:r.label}),h.jsx("dd",{className:`font-mono text-sm font-semibold ${r.accent?"text-brand-700 dark:text-brand-300":"text-slate-800 dark:text-slate-100"}`,children:r.value})]},r.label))})}const lr=["forward","backward","central","five-point","second"];function hr(){const{t:a}=K(),[e,t]=y.useState("exp(x^2 + x)"),[n,i]=y.useState("central"),[r,o]=y.useState(0),[s,d]=y.useState(.1),l=y.useMemo(()=>ge(e),[e]),c=Le[n].order,{approx:u,reference:f,error:p,segments:x,points:z}=y.useMemo(()=>{if(!l.ok)return{approx:NaN,reference:NaN,error:NaN,segments:[],points:[]};const m=l.f,w=Le[n].apply(m,r,s),v=ir(e,r,c),$=Je(w,v),q=[],S=[],N=m(r);if(S.push({x:r,y:N,color:"#ef4444"}),c===1){const j=Math.max(2*s,1),T=r-j,C=r+j;q.push({points:[[T,N+v*(T-r)],[C,N+v*(C-r)]],color:"#10b981",dashed:!0}),n==="central"||n==="five-point"?(S.push({x:r-s,y:m(r-s)},{x:r+s,y:m(r+s)}),q.push({points:[[r-s,m(r-s)],[r+s,m(r+s)]],color:"#f59e0b"})):n==="forward"?(S.push({x:r+s,y:m(r+s)}),q.push({points:[[r,N],[r+s,m(r+s)]],color:"#f59e0b"})):(S.push({x:r-s,y:m(r-s)}),q.push({points:[[r-s,m(r-s)],[r,N]],color:"#f59e0b"}))}else S.push({x:r-s,y:m(r-s)},{x:r+s,y:m(r+s)});return{approx:w,reference:v,error:$,segments:q,points:S}},[l,n,r,s,e,c]),g=Math.max(2.5*s,1.5);return h.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[h.jsxs("div",{className:"card space-y-4",children:[h.jsx(Ze,{expr:e,onChange:t,valid:l.ok}),h.jsxs("div",{children:[h.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),h.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:lr.map(m=>h.jsx("button",{type:"button",onClick:()=>i(m),className:`chip border transition ${n===m?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${m}`)},m))})]}),h.jsx(Q,{label:a("playground.x0"),value:r,min:-3,max:3,step:.1,onChange:o,format:m=>m.toFixed(2)}),h.jsx(Q,{label:a("playground.h"),value:s,min:.01,max:1,step:.01,onChange:d,format:m=>m.toFixed(2)}),h.jsx(Xe,{approx:u,reference:f,error:p})]}),h.jsxs("div",{className:"card",children:[h.jsx(Ye,{f:l.f,xMin:r-g,xMax:r+g,segments:x,points:z}),h.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),c===1&&h.jsxs(h.Fragment,{children:[h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-1 w-4 rounded bg-amber-500"})," ",a("playground.approx")]}),h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-1 w-4 rounded bg-emerald-500"})," ",a("playground.reference")]})]})]})]})]})}const dr=["trapezoid","simpson","gauss2","gauss3","gauss4","gauss5"];function fr(){const{t:a}=K(),[e,t]=y.useState("x^2 * exp(x)"),[n,i]=y.useState("simpson"),[r,o]=y.useState(0),[s,d]=y.useState(1),[l,c]=y.useState(4),u=y.useMemo(()=>ge(e),[e]),f=Re[n].usesN,{approx:p,reference:x,error:z,areas:g,points:m}=y.useMemo(()=>{if(!u.ok||s<=r)return{approx:NaN,reference:NaN,error:NaN,areas:[],points:[]};const v=u.f,$=Re[n].apply(v,r,s,l),q=rr(v,r,s),S=Je($,q),N=[],j=[];if(n==="trapezoid"){const T=(s-r)/l;for(let C=0;C<l;C++){const b=r+C*T,k=b+T;N.push({points:[[b,0],[b,v(b)],[k,v(k)],[k,0]]})}}else{const T=[[r,0]],C=80;for(let b=0;b<=C;b++){const k=r+(s-r)*b/C;T.push([k,v(k)])}if(T.push([s,0]),N.push({points:T}),n.startsWith("gauss")){const b=Number(n.slice(5)),k=(s-r)/2,L=(r+s)/2;for(const I of Qe[b].nodes){const M=k*I+L;j.push({x:M,y:v(M),color:"#ef4444"})}}}return{approx:$,reference:q,error:S,areas:N,points:j}},[u,n,r,s,l]),w=(s-r)*.1||.2;return h.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[h.jsxs("div",{className:"card space-y-4",children:[h.jsx(Ze,{expr:e,onChange:t,valid:u.ok}),h.jsxs("div",{children:[h.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),h.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:dr.map(v=>h.jsx("button",{type:"button",onClick:()=>i(v),className:`chip border transition ${n===v?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${v}`)},v))})]}),h.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[h.jsx(Q,{label:a("playground.a"),value:r,min:-3,max:3,step:.1,onChange:o,format:v=>v.toFixed(2)}),h.jsx(Q,{label:a("playground.b"),value:s,min:-3,max:4,step:.1,onChange:d,format:v=>v.toFixed(2)})]}),f&&h.jsx(Q,{label:a("playground.n"),value:l,min:2,max:20,step:n==="simpson"?2:1,onChange:c}),h.jsx(Xe,{approx:p,reference:x,error:z})]}),h.jsxs("div",{className:"card",children:[h.jsx(Ye,{f:u.f,xMin:r-w,xMax:s+w,areas:g,points:m}),h.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-3 w-4 rounded bg-accent-500/30"})," ∫ region"]}),n.startsWith("gauss")&&h.jsxs("span",{className:"flex items-center gap-1",children:[h.jsx("span",{className:"inline-block h-2 w-2 rounded-full bg-red-500"})," nodes"]})]})]})]})}function cr(){const{t:a}=K(),[e,t]=y.useState("diff");return h.jsxs("div",{children:[h.jsx("h1",{className:"text-3xl font-extrabold",children:a("playground.title")}),h.jsx("p",{className:"mt-1 text-slate-500 dark:text-slate-400",children:a("playground.lead")}),h.jsx("div",{className:"mt-5 inline-flex rounded-xl bg-slate-200 p-1 dark:bg-slate-800",children:["diff","int"].map(n=>h.jsx("button",{type:"button",onClick:()=>t(n),className:`rounded-lg px-4 py-2 text-sm font-semibold transition ${e===n?"bg-white text-brand-700 shadow dark:bg-slate-900 dark:text-brand-300":"text-slate-600 dark:text-slate-300"}`,children:a(n==="diff"?"playground.tab_diff":"playground.tab_int")},n))}),h.jsx("div",{className:"mt-5",children:e==="diff"?h.jsx(hr,{}):h.jsx(fr,{})})]})}function ur({correct:a,total:e,onRetry:t}){const{t:n}=K(),i=e?Math.round(a/e*100):0,r=i>=80?"🏆":i>=50?"👍":"📚";return h.jsxs(J.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},className:"card text-center",children:[h.jsx("div",{className:"text-6xl",children:r}),h.jsx("h2",{className:"mt-3 text-2xl font-extrabold",children:n("quiz.results_title")}),h.jsx("p",{className:"mt-2 text-lg text-slate-600 dark:text-slate-300",children:n("quiz.results_score",{correct:a,total:e})}),h.jsx("div",{className:"mx-auto mt-4 h-3 w-full max-w-sm overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:h.jsx(J.div,{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500",initial:{width:0},animate:{width:`${i}%`},transition:{duration:.6}})}),h.jsxs("div",{className:"mt-6 flex flex-wrap justify-center gap-3",children:[h.jsx("button",{type:"button",onClick:t,className:"btn-primary",children:n("quiz.retry")}),h.jsx(Fe,{to:"/numerical-calculus/lessons",className:"btn-ghost",children:n("quiz.to_lessons")})]})]})}function pr(){var b;const{t:a,i18n:e}=K(),t=e.language==="hu"?"hu":"en",[n,i]=y.useState([]),[r,o]=y.useState(0),[s,d]=y.useState(""),[l,c]=y.useState(null),[u,f]=y.useState(0),[p,x]=y.useState(0),[z,g]=y.useState(!1),[m,w]=y.useState(!0);function v(k=n){o(0),d(""),c(null),f(0),x(0),g(!1)}if(y.useEffect(()=>{w(!0),Rn(t).then(k=>{i(k),v(k)}).finally(()=>w(!1))},[t]),m)return h.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(!n.length)return h.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(z)return h.jsx(ur,{correct:u,total:n.length,onRetry:()=>v()});const $=n[r],q=r===n.length-1,S=l!==null,N=s!==""&&!S;async function j(){if(s==="")return;const k=await Pn($.id,s,t);c(k),k.correct?(f(L=>L+1),x(L=>L+1)):x(0)}function T(){if(q){g(!0);return}o(k=>k+1),d(""),c(null)}const C=(k,L)=>S?k?"border-emerald-500 bg-emerald-50 dark:bg-emerald-900/30":L?"border-rose-500 bg-rose-50 dark:bg-rose-900/30":"border-slate-200 bg-white opacity-60 dark:border-slate-700 dark:bg-slate-800":L?"border-brand-500 bg-brand-50 dark:bg-brand-900/40":"border-slate-200 bg-white hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800";return h.jsxs("div",{className:"card",children:[h.jsxs("div",{className:"flex items-center justify-between text-sm",children:[h.jsxs("span",{className:"font-semibold text-slate-500 dark:text-slate-400",children:[a("quiz.question")," ",r+1," ",a("quiz.of")," ",n.length]}),h.jsxs("span",{className:"flex gap-3",children:[h.jsxs("span",{className:"chip bg-brand-100 text-brand-700 dark:bg-brand-900/50 dark:text-brand-200",children:[a("quiz.score"),": ",u]}),h.jsxs("span",{className:"chip bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-200",children:["🔥 ",p]})]})]}),h.jsx("div",{className:"mt-2 h-1.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:h.jsx("div",{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500 transition-all",style:{width:`${(r+(S?1:0))/n.length*100}%`}})}),h.jsxs("span",{className:"mt-4 inline-block chip bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400",children:[a("quiz.topic")," ",$.topic]}),h.jsx(gt,{mode:"wait",children:h.jsxs(J.div,{initial:{opacity:0,x:16},animate:{opacity:1,x:0},exit:{opacity:0,x:-16},children:[h.jsx("h2",{className:"mt-3 text-lg font-semibold",children:$.prompt}),h.jsxs("div",{className:"mt-4 space-y-2",children:[$.type==="mcq"&&((b=$.options)==null?void 0:b.map((k,L)=>h.jsxs("button",{type:"button",disabled:S,onClick:()=>d(L),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${C((l==null?void 0:l.answer)===L,s===L)}`,children:[h.jsx("span",{className:"grid h-6 w-6 shrink-0 place-items-center rounded-full bg-slate-200 text-xs font-bold dark:bg-slate-700",children:String.fromCharCode(65+L)}),k]},L))),$.type==="truefalse"&&[!0,!1].map(k=>h.jsx("button",{type:"button",disabled:S,onClick:()=>d(k),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${C((l==null?void 0:l.answer)===k,s===k)}`,children:a(k?"quiz.true":"quiz.false")},String(k))),$.type==="numeric"&&h.jsx("input",{type:"number",step:"any",disabled:S,placeholder:a("quiz.numeric_placeholder"),value:s===""?"":String(s),onChange:k=>d(k.target.value===""?"":Number(k.target.value)),className:"w-full rounded-xl border border-slate-200 bg-white px-4 py-3 font-mono outline-none focus:border-brand-400 dark:border-slate-700 dark:bg-slate-800"})]}),S&&h.jsxs(J.div,{initial:{opacity:0,y:6},animate:{opacity:1,y:0},className:`mt-4 rounded-xl p-4 ${l!=null&&l.correct?"bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-200":"bg-rose-50 text-rose-800 dark:bg-rose-900/30 dark:text-rose-200"}`,children:[h.jsx("p",{className:"font-bold",children:l!=null&&l.correct?a("quiz.correct"):a("quiz.incorrect")}),h.jsx("p",{className:"mt-1 text-sm",children:l==null?void 0:l.explanation})]})]},$.id)}),h.jsx("div",{className:"mt-5 flex justify-end gap-3",children:S?h.jsx("button",{type:"button",onClick:T,className:"btn-primary",children:a(q?"quiz.finish":"quiz.next")}):h.jsx("button",{type:"button",disabled:!N,onClick:j,className:"btn-primary disabled:opacity-50",children:a("quiz.check")})})]})}function mr(){const{t:a}=K();return h.jsxs("div",{children:[h.jsx("h1",{className:"text-3xl font-extrabold",children:a("quiz.title")}),h.jsx("p",{className:"mb-5 mt-1 text-slate-500 dark:text-slate-400",children:a("quiz.lead")}),h.jsx(pr,{})]})}const et=Ge,gr=[...et.map(a=>({id:a.slug,no:a.id==="intro"?"7":a.id,title:a.title,blurb:{en:"",hu:""}})),{id:"playground",no:"7·pg",title:{en:"Playground",hu:"Játéktér"},blurb:{en:"",hu:""}},{id:"quiz",no:"7·qz",title:{en:"Quiz",hu:"Kvíz"},blurb:{en:"",hu:""}}];function Sr(){const a=nt(),{t:e}=K(),{lang:t}=at();y.useEffect(()=>{O.changeLanguage(t)},[t]),y.useEffect(()=>{let i=decodeURIComponent(a.hash.replace(/^#/,""));if(!i){const r=a.pathname.match(/\/lessons\/([^/]+)/);if(r)i=r[1];else{const o=a.pathname.split("/").filter(Boolean).pop()??"";["playground","quiz"].includes(o)&&(i=o)}}i&&requestAnimationFrame(()=>{var r;return(r=document.getElementById(i))==null?void 0:r.scrollIntoView()})},[a.pathname,a.hash]);const n={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return h.jsxs("div",{className:"flex min-h-screen flex-col",children:[h.jsx(mt,{sections:gr}),h.jsxs("main",{className:"mx-auto w-full max-w-5xl flex-1 space-y-16 px-4 py-8",children:[et.map(i=>h.jsx("section",{id:i.slug,style:n,children:h.jsx(Za,{slug:i.slug})},i.slug)),h.jsx("section",{id:"playground",style:n,children:h.jsx(cr,{})}),h.jsx("section",{id:"quiz",style:n,children:h.jsx(mr,{})})]}),h.jsx("footer",{className:"border-t border-slate-200 py-6 text-center text-sm text-slate-400 dark:border-slate-800",children:e("app.footer")})]})}export{Sr as default};
