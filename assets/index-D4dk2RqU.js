...
**Reciprocal model $y=1/(a+bx)$.** Linearize as $1/y=a+bx$ and fit a line to $(x_i,1/y_i)$; e.g. data $x_i:1,\\dots,5$, $\\ y_i:0.50,0.33,0.25,0.20,0.17$ transform to $Y_i:2.00,3.03,4.00,5.00,5.88$, giving $Y=0.98+0.99X$, hence $y\\approx1/(1+x)$.`},{type:"glossary",deck:"nonlinear"},{type:"flashcards",deck:"nonlinear"},{type:"quiz",ref:"nonlinear"}]},Xe=[yt,_t,kt,zt];Xe.map(r=>r.id);const Ye="lsq.progress",vt=new Set,Ne=()=>({completed:{},xp:0});let Y=(()=>{try{const r=localStorage.getItem(Ye);if(r)return{...Ne(),...JSON.parse(r)}}catch{}return Ne()})();function wt(){try{localStorage.setItem(Ye,JSON.stringify(Y))}catch{}vt.forEach(r=>r(Y))}function qt(r){return!!Y.completed[r]}function jt(r,n=50){Y.completed[r]||(Y.completed[r]=!0,Y.xp+=n,wt())}function At(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function M({text:r}){const n=S.useMemo(()=>(r||"").split(/(\$[^$]+\$)/g).map(e=>e.length>1&&e.startsWith("$")&&e.endsWith("$")?ge.renderToString(e.slice(1,-1),{throwOnError:!1}):At(e)).join(""),[r]);return h.jsx("span",{dangerouslySetInnerHTML:{__html:n}})}function Ze(r,n){const e=n.length,t=r.map((a,i)=>[...a,n[i]]);for(let a=0;a<e;a++){let i=a;for(let o=a+1;o<e;o++)Math.abs(t[o][a])>Math.abs(t[i][a])&&(i=o);if(Math.abs(t[i][a])<1e-15)throw new Error("Singular matrix in solveLinearSystem");[t[a],t[i]]=[t[i],t[a]];for(let o=a+1;o<e;o++){const l=t[o][a]/t[a][a];if(l!==0)for(let u=a;u<=e;u++)t[o][u]-=l*t[a][u]}}const s=new Array(e).fill(0);for(let a=e-1;a>=0;a--){let i=t[a][e];for(let o=a+1;o<e;o++)i-=t[a][o]*s[o];s[a]=i/t[a][a]}return s}function Z(r,n){const e=r.length;let t=0,s=0,a=0,i=0;for(let u=0;u<e;u++)t+=r[u],s+=n[u],a+=r[u]*r[u],i+=r[u]*n[u];const[o,l]=Ze([[a,t],[t,e]],[i,s]);return{a:o,b:l}}function St(r,n,e){const t=r.length,s=e+1,a=new Array(2*e+1).fill(0);for(let l=0;l<t;l++){let u=1;for(let c=0;c<=2*e;c++)a[c]+=u,u*=r[l]}const i=new Array(s).fill(0);for(let l=0;l<t;l++){let u=1;for(let c=0;c<s;c++)i[c]+=u*n[l],u*=r[l]}const o=[];for(let l=0;l<s;l++){const u=[];for(let c=0;c<s;c++)u.push(a[l+c]);o.push(u)}return Ze(o,i)}function Tt(r,n){const e=n.map(a=>Math.log(a)),{a:t,b:s}=Z(r,e);return{a:t,b:Math.exp(s)}}function Ft(r,n){const e=r.map(i=>Math.log(i)),t=n.map(i=>Math.log(i)),{a:s,b:a}=Z(e,t);return{a:s,b:Math.exp(a)}}function H(r,n,e){let t=0;for(let s=0;s<n.length;s++){const a=r(n[s])-e[s];t+=a*a}return t}function Be(r,n){let e=0;for(let t=r.length-1;t>=0;t--)e=e*n+r[t];return e}var Et=function(n,e,t){for(var s=t,a=0,i=n.length;s<e.length;){var o=e[s];if(a<=0&&e.slice(s,s+i)===n)return s;o==="\\"?s++:o==="{"?a++:o==="}"&&a--,s++}return-1},It=function(n){return n.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")},Lt=/^\\begin{/,Mt=function(n,e){for(var t,s=[],a=new RegExp("("+e.map(u=>It(u.left)).join("|")+")");t=n.search(a),t!==-1;){t>0&&(s.push({type:"text",data:n.slice(0,t)}),n=n.slice(t));var i=e.findIndex(u=>n.startsWith(u.left));if(t=Et(e[i].right,n,e[i].left.length),t===-1)break;var o=n.slice(0,t+e[i].right.length),l=Lt.test(o)?o:n.slice(e[i].left.length,t);s.push({type:"math",data:l,rawData:o,display:e[i].display}),n=n.slice(t+e[i].right.length)}return n!==""&&s.push({type:"text",data:n}),s},Rt=function(n,e){var t=Mt(n,e.delimiters);if(t.length===1&&t[0].type==="text")return null;for(var s=document.createDocumentFragment(),a=0;a<t.length;a++)if(t[a].type==="text")s.appendChild(document.createTextNode(t[a].data));else{var i=document.createElement("span"),o=t[a].data;e.displayMode=t[a].display;try{e.preProcess&&(o=e.preProcess(o)),ge.render(o,i,e)}catch(l){if(!(l instanceof ge.ParseError))throw l;e.errorCallback("KaTeX auto-render: Failed to parse `"+t[a].data+"` with ",l),s.appendChild(document.createTextNode(t[a].rawData));continue}s.appendChild(i)}return s},Qe=function(n,e){for(var t=function(i){var o=n.childNodes[i];if(o.nodeType===3){for(var l,u=(l=o.textContent)!=null?l:"",c=o.nextSibling,m=0;c&&c.nodeType===Node.TEXT_NODE;){var p;u+=(p=c.textContent)!=null?p:"",c=c.nextSibling,m++}var d=Rt(u,e);if(d){for(var $=0;$<m;$++)o.nextSibling.remove();i+=d.childNodes.length-1,n.replaceChild(d,o)}else i+=m}else if(o.nodeType===1){var f=" "+o.className+" ",x=!e.ignoredTags.has(o.nodeName.toLowerCase())&&e.ignoredClasses.every(b=>!f.includes(" "+b+" "));x&&Qe(o,e)}s=i},s=0;s<n.childNodes.length;s++)t(s)},Nt=function(n,e){if(!n)throw new Error("No element provided to render");var t={};Object.assign(t,e),t.delimiters=t.delimiters||[{left:"$$",right:"$$",display:!0},{left:"\\(",right:"\\)",display:!1},{left:"\\begin{equation}",right:"\\end{equation}",display:!0},{left:"\\begin{align}",right:"\\end{align}",display:!0},{left:"\\begin{alignat}",right:"\\end{alignat}",display:!0},{left:"\\begin{gather}",right:"\\end{gather}",display:!0},{left:"\\begin{CD}",right:"\\end{CD}",display:!0},{left:"\\[",right:"\\]",display:!0}],t.ignoredTags=new Set((e==null?void 0:e.ignoredTags)||["script","noscript","style","textarea","pre","code","option"]),t.ignoredClasses=t.ignoredClasses||[],t.errorCallback=t.errorCallback||console.error,t.macros=t.macros||{},Qe(n,t)};function we(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let X=we();function Ke(r){X=r}const Ue=/[&<>"']/,Bt=new RegExp(Ue.source,"g"),Je=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Ct=new RegExp(Je.source,"g"),Wt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ce=r=>Wt[r];function T(r,n){if(n){if(Ue.test(r))return r.replace(Bt,Ce)}else if(Je.test(r))return r.replace(Ct,Ce);return r}const Pt=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Vt(r){return r.replace(Pt,(n,e)=>(e=e.toLowerCase(),e==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const Dt=/(^|[^\[])\^/g;function _(r,n){let e=typeof r=="string"?r:r.source;n=n||"";const t={replace:(s,a)=>{let i=typeof a=="string"?a:a.source;return i=i.replace(Dt,"$1"),e=e.replace(s,i),t},getRegex:()=>new RegExp(e,n)};return t}function We(r){try{r=encodeURI(r).replace(/%25/g,"%")}catch{return null}return r}const ee={exec:()=>null};function Pe(r,n){const e=r.replace(/\|/g,(a,i,o)=>{let l=!1,u=i;for(;--u>=0&&o[u]==="\\";)l=!l;return l?"|":" |"}),t=e.split(/ \|/);let s=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),n)if(t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;s<t.length;s++)t[s]=t[s].trim().replace(/\\\|/g,"|");return t}function oe(r,n,e){const t=r.length;if(t===0)return"";let s=0;for(;s<t&&r.charAt(t-s-1)===n;)s++;return r.slice(0,t-s)}function Ht(r,n){if(r.indexOf(n[1])===-1)return-1;let e=0;for(let t=0;t<r.length;t++)if(r[t]==="\\")t++;else if(r[t]===n[0])e++;else if(r[t]===n[1]&&(e--,e<0))return t;return-1}function Ve(r,n,e,t){const s=n.href,a=n.title?T(n.title):null,i=r[1].replace(/\\([\[\]])/g,"$1");if(r[0].charAt(0)!=="!"){t.state.inLink=!0;const o={type:"link",raw:e,href:s,title:a,text:i,tokens:t.inlineTokens(i)};return t.state.inLink=!1,o}return{type:"image",raw:e,href:s,title:a,text:T(i)}}function Ot(r,n){const e=r.match(/^(\s+)(?:```)/);if(e===null)return n;const t=e[1];return n.split(`
`).map(s=>{const a=s.match(/^\s+/);if(a===null)return s;const[i]=a;return i.length>=t.length?s.slice(t.length):s}).join(`
`)}class he{constructor(n){k(this,"options");k(this,"rules");k(this,"lexer");this.options=n||X}space(n){const e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){const e=this.rules.block.code.exec(n);if(e){const t=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:oe(t,`
...
`+p.slice(d);else{if($||m.search(/[^ ]/)>=4||z.test(m)||w.test(m)||v.test(m))break;l+=`
`+p}!$&&!p.trim()&&($=!0),o+=A+`
`,n=n.substring(A.length+1),m=p.slice(d)}}a.loose||(u?a.loose=!0:/\n *\n *$/.test(o)&&(u=!0));let f=null,x;this.options.gfm&&(f=/^\[[ xX]\] /.exec(l),f&&(x=f[0]!=="[ ] ",l=l.replace(/^\[[ xX]\] +/,""))),a.items.push({type:"list_item",raw:o,task:!!f,checked:x,loose:!1,text:l,tokens:[]}),a.raw+=o}a.items[a.items.length-1].raw=o.trimEnd(),a.items[a.items.length-1].text=l.trimEnd(),a.raw=a.raw.trimEnd();for(let c=0;c<a.items.length;c++)if(this.lexer.state.top=!1,a.items[c].tokens=this.lexer.blockTokens(a.items[c].text,[]),!a.loose){const m=a.items[c].tokens.filter(d=>d.type==="space"),p=m.length>0&&m.some(d=>/\n.*\n/.test(d.raw));a.loose=p}if(a.loose)for(let c=0;c<a.items.length;c++)a.items[c].loose=!0;return a}}html(n){const e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){const e=this.rules.block.def.exec(n);if(e){const t=e[1].toLowerCase().replace(/\s+/g," "),s=e[2]?e[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",a=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:s,title:a}}}table(n){const e=this.rules.block.table.exec(n);if(!e||!/[:|]/.test(e[2]))return;const t=Pe(e[1]),s=e[2].replace(/^\||\| *$/g,"").split("|"),a=e[3]&&e[3].trim()?e[3].replace(/\n[ \t]*$/,"").split(`
...
`+t.raw,s.text+=`
`+t.raw,this.inlineQueue[this.inlineQueue.length-1].src=s.text):this.tokens.links[t.tag]||(this.tokens.links[t.tag]={href:t.href,title:t.title});continue}if(t=this.tokenizer.table(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.lheading(n)){n=n.substring(t.raw.length),e.push(t);continue}if(a=n,this.options.extensions&&this.options.extensions.startBlock){let o=1/0;const l=n.slice(1);let u;this.options.extensions.startBlock.forEach(c=>{u=c.call({lexer:this},l),typeof u=="number"&&u>=0&&(o=Math.min(o,u))}),o<1/0&&o>=0&&(a=n.substring(0,o+1))}if(this.state.top&&(t=this.tokenizer.paragraph(a))){s=e[e.length-1],i&&s.type==="paragraph"?(s.raw+=`
`+t.raw,s.text+=`
...
`+t.raw,s.text+=`
`+t.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=s.text):e.push(t);continue}if(n){const o="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,e}inline(n,e=[]){return this.inlineQueue.push({src:n,tokens:e}),e}inlineTokens(n,e=[]){let t,s,a,i=n,o,l,u;if(this.tokens.links){const c=Object.keys(this.tokens.links);if(c.length>0)for(;(o=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)c.includes(o[0].slice(o[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(o=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)i=i.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(o=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,o.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;n;)if(l||(u=""),l=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(c=>(t=c.call({lexer:this},n,e))?(n=n.substring(t.raw.length),e.push(t),!0):!1))){if(t=this.tokenizer.escape(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.tag(n)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.link(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.reflink(n,this.tokens.links)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.emStrong(n,i,u)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.codespan(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.br(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.del(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.autolink(n)){n=n.substring(t.raw.length),e.push(t);continue}if(!this.state.inLink&&(t=this.tokenizer.url(n))){n=n.substring(t.raw.length),e.push(t);continue}if(a=n,this.options.extensions&&this.options.extensions.startInline){let c=1/0;const m=n.slice(1);let p;this.options.extensions.startInline.forEach(d=>{p=d.call({lexer:this},m),typeof p=="number"&&p>=0&&(c=Math.min(c,p))}),c<1/0&&c>=0&&(a=n.substring(0,c+1))}if(t=this.tokenizer.inlineText(a)){n=n.substring(t.raw.length),t.raw.slice(-1)!=="_"&&(u=t.raw.slice(-1)),l=!0,s=e[e.length-1],s&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(n){const c="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return e}}class me{constructor(n){k(this,"options");this.options=n||X}code(n,e,t){var a;const s=(a=(e||"").match(/^\S*/))==null?void 0:a[0];return n=n.replace(/\n$/,"")+`
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return"<br>"}del(n){return`<del>${n}</del>`}link(n,e,t){const s=We(n);if(s===null)return t;n=s;let a='<a href="'+n+'"';return e&&(a+=' title="'+e+'"'),a+=">"+t+"</a>",a}image(n,e,t){const s=We(n);if(s===null)return t;n=s;let a=`<img src="${n}" alt="${t}"`;return e&&(a+=` title="${e}"`),a+=">",a}text(n){return n}}class Fe{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,e,t){return""+t}image(n,e,t){return""+t}br(){return""}}class N{constructor(n){k(this,"options");k(this,"renderer");k(this,"textRenderer");this.options=n||X,this.options.renderer=this.options.renderer||new me,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Fe}static parse(n,e){return new N(e).parse(n)}static parseInline(n,e){return new N(e).parseInline(n)}parse(n,e=!0){let t="";for(let s=0;s<n.length;s++){const a=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[a.type]){const i=a,o=this.options.extensions.renderers[i.type].call({parser:this},i);if(o!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){t+=o||"";continue}}switch(a.type){case"space":continue;case"hr":{t+=this.renderer.hr();continue}case"heading":{const i=a;t+=this.renderer.heading(this.parseInline(i.tokens),i.depth,Vt(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{const i=a;t+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{const i=a;let o="",l="";for(let c=0;c<i.header.length;c++)l+=this.renderer.tablecell(this.parseInline(i.header[c].tokens),{header:!0,align:i.align[c]});o+=this.renderer.tablerow(l);let u="";for(let c=0;c<i.rows.length;c++){const m=i.rows[c];l="";for(let p=0;p<m.length;p++)l+=this.renderer.tablecell(this.parseInline(m[p].tokens),{header:!1,align:i.align[p]});u+=this.renderer.tablerow(l)}t+=this.renderer.table(o,u);continue}case"blockquote":{const i=a,o=this.parse(i.tokens);t+=this.renderer.blockquote(o);continue}case"list":{const i=a,o=i.ordered,l=i.start,u=i.loose;let c="";for(let m=0;m<i.items.length;m++){const p=i.items[m],d=p.checked,$=p.task;let f="";if(p.task){const x=this.renderer.checkbox(!!d);u?p.tokens.length>0&&p.tokens[0].type==="paragraph"?(p.tokens[0].text=x+" "+p.tokens[0].text,p.tokens[0].tokens&&p.tokens[0].tokens.length>0&&p.tokens[0].tokens[0].type==="text"&&(p.tokens[0].tokens[0].text=x+" "+p.tokens[0].tokens[0].text)):p.tokens.unshift({type:"text",text:x+" "}):f+=x+" "}f+=this.parse(p.tokens,u),c+=this.renderer.listitem(f,$,!!d)}t+=this.renderer.list(c,o,l);continue}case"html":{const i=a;t+=this.renderer.html(i.text,i.block);continue}case"paragraph":{const i=a;t+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=a,o=i.tokens?this.parseInline(i.tokens):i.text;for(;s+1<n.length&&n[s+1].type==="text";)i=n[++s],o+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);t+=e?this.renderer.paragraph(o):o;continue}default:{const i='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return t}parseInline(n,e){e=e||this.renderer;let t="";for(let s=0;s<n.length;s++){const a=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[a.type]){const i=this.options.extensions.renderers[a.type].call({parser:this},a);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(a.type)){t+=i||"";continue}}switch(a.type){case"escape":{const i=a;t+=e.text(i.text);break}case"html":{const i=a;t+=e.html(i.text);break}case"link":{const i=a;t+=e.link(i.href,i.title,this.parseInline(i.tokens,e));break}case"image":{const i=a;t+=e.image(i.href,i.title,i.text);break}case"strong":{const i=a;t+=e.strong(this.parseInline(i.tokens,e));break}case"em":{const i=a;t+=e.em(this.parseInline(i.tokens,e));break}case"codespan":{const i=a;t+=e.codespan(i.text);break}case"br":{t+=e.br();break}case"del":{const i=a;t+=e.del(this.parseInline(i.tokens,e));break}case"text":{const i=a;t+=e.text(i.text);break}default:{const i='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return t}}class te{constructor(n){k(this,"options");this.options=n||X}preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}}k(te,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var G,ke,ot;class gn{constructor(...n){Re(this,G);k(this,"defaults",we());k(this,"options",this.setOptions);k(this,"parse",re(this,G,ke).call(this,R.lex,N.parse));k(this,"parseInline",re(this,G,ke).call(this,R.lexInline,N.parseInline));k(this,"Parser",N);k(this,"Renderer",me);k(this,"TextRenderer",Fe);k(this,"Lexer",R);k(this,"Tokenizer",he);k(this,"Hooks",te);this.use(...n)}walkTokens(n,e){var s,a;let t=[];for(const i of n)switch(t=t.concat(e.call(this,i)),i.type){case"table":{const o=i;for(const l of o.header)t=t.concat(this.walkTokens(l.tokens,e));for(const l of o.rows)for(const u of l)t=t.concat(this.walkTokens(u.tokens,e));break}case"list":{const o=i;t=t.concat(this.walkTokens(o.items,e));break}default:{const o=i;(a=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&a[o.type]?this.defaults.extensions.childTokens[o.type].forEach(l=>{const u=o[l].flat(1/0);t=t.concat(this.walkTokens(u,e))}):o.tokens&&(t=t.concat(this.walkTokens(o.tokens,e)))}}return t}use(...n){const e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach(t=>{const s={...t};if(s.async=this.defaults.async||s.async||!1,t.extensions&&(t.extensions.forEach(a=>{if(!a.name)throw new Error("extension name required");if("renderer"in a){const i=e.renderers[a.name];i?e.renderers[a.name]=function(...o){let l=a.renderer.apply(this,o);return l===!1&&(l=i.apply(this,o)),l}:e.renderers[a.name]=a.renderer}if("tokenizer"in a){if(!a.level||a.level!=="block"&&a.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const i=e[a.level];i?i.unshift(a.tokenizer):e[a.level]=[a.tokenizer],a.start&&(a.level==="block"?e.startBlock?e.startBlock.push(a.start):e.startBlock=[a.start]:a.level==="inline"&&(e.startInline?e.startInline.push(a.start):e.startInline=[a.start]))}"childTokens"in a&&a.childTokens&&(e.childTokens[a.name]=a.childTokens)}),s.extensions=e),t.renderer){const a=this.defaults.renderer||new me(this.defaults);for(const i in t.renderer){if(!(i in a))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;const o=i,l=t.renderer[o],u=a[o];a[o]=(...c)=>{let m=l.apply(a,c);return m===!1&&(m=u.apply(a,c)),m||""}}s.renderer=a}if(t.tokenizer){const a=this.defaults.tokenizer||new he(this.defaults);for(const i in t.tokenizer){if(!(i in a))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;const o=i,l=t.tokenizer[o],u=a[o];a[o]=(...c)=>{let m=l.apply(a,c);return m===!1&&(m=u.apply(a,c)),m}}s.tokenizer=a}if(t.hooks){const a=this.defaults.hooks||new te;for(const i in t.hooks){if(!(i in a))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;const o=i,l=t.hooks[o],u=a[o];te.passThroughHooks.has(i)?a[o]=c=>{if(this.defaults.async)return Promise.resolve(l.call(a,c)).then(p=>u.call(a,p));const m=l.call(a,c);return u.call(a,m)}:a[o]=(...c)=>{let m=l.apply(a,c);return m===!1&&(m=u.apply(a,c)),m}}s.hooks=a}if(t.walkTokens){const a=this.defaults.walkTokens,i=t.walkTokens;s.walkTokens=function(o){let l=[];return l.push(i.call(this,o)),a&&(l=l.concat(a.call(this,o))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return R.lex(n,e??this.defaults)}parser(n,e){return N.parse(n,e??this.defaults)}}G=new WeakSet,ke=function(n,e){return(t,s)=>{const a={...s},i={...this.defaults,...a};this.defaults.async===!0&&a.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);const o=re(this,G,ot).call(this,!!i.silent,!!i.async);if(typeof t>"u"||t===null)return o(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return o(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(t):t).then(l=>n(l,i)).then(l=>i.hooks?i.hooks.processAllTokens(l):l).then(l=>i.walkTokens?Promise.all(this.walkTokens(l,i.walkTokens)).then(()=>l):l).then(l=>e(l,i)).then(l=>i.hooks?i.hooks.postprocess(l):l).catch(o);try{i.hooks&&(t=i.hooks.preprocess(t));let l=n(t,i);i.hooks&&(l=i.hooks.processAllTokens(l)),i.walkTokens&&this.walkTokens(l,i.walkTokens);let u=e(l,i);return i.hooks&&(u=i.hooks.postprocess(u)),u}catch(l){return o(l)}}},ot=function(n,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){const s="<p>An error occurred:</p><pre>"+T(t.message+"",!0)+"</pre>";return e?Promise.resolve(s):s}if(e)return Promise.reject(t);throw t}};const O=new gn;function g(r,n){return O.parse(r,n)}g.options=g.setOptions=function(r){return O.setOptions(r),g.defaults=O.defaults,Ke(g.defaults),g};g.getDefaults=we;g.defaults=X;g.use=function(...r){return O.use(...r),g.defaults=O.defaults,Ke(g.defaults),g};g.walkTokens=function(r,n){return O.walkTokens(r,n)};g.parseInline=O.parseInline;g.Parser=N;g.parser=N.parse;g.Renderer=me;g.TextRenderer=Fe;g.Lexer=R;g.lexer=R.lex;g.Tokenizer=he;g.Hooks=te;g.parse=g;g.options;g.setOptions;g.use;g.walkTokens;g.parseInline;N.parse;R.lex;const yn={delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1};function Ee(r){r&&Nt(r,yn)}g.setOptions({breaks:!0,gfm:!0});function Ie(r,n){const e=()=>n.forEach(s=>{if(s&&s.offsetParent!==null)try{ne.Plots.resize(s)}catch{}});requestAnimationFrame(e),setTimeout(e,60);let t;return typeof ResizeObserver<"u"&&(t=new ResizeObserver(e),t.observe(r)),()=>{t&&t.disconnect()}}function pe(r={}){const n=J("--fg")||"#1a1a2e",e=J("--grid")||"#d8d8e0",t=J("--surface")||"#ffffff";return{paper_bgcolor:t,plot_bgcolor:t,font:{color:n,family:"system-ui, sans-serif"},margin:{l:44,r:16,t:28,b:40},xaxis:{gridcolor:e,zerolinecolor:e},yaxis:{gridcolor:e,zerolinecolor:e},showlegend:!0,legend:{orientation:"h",y:1.12,x:0},...r}}const $e=()=>J("--accent")||"#e63946",de=()=>J("--point")||"#3a6ea5",fe={displayModeBar:!1,responsive:!0},ce={xs:[-1,1,2.5,3,4,4.5,6],ys:[0,1.2,1.9,2.5,3.1,3.2,4.5]};function _n(r){let n=[...ce.xs],e=[...ce.ys],t=!1,s=.5,a=.5;r.innerHTML=`
    <div class="demo">
    ...
    </div>`;const i=r.querySelector("[data-plot]"),o=r.querySelector("[data-readout]"),l=r.querySelector("[data-sliders]");function u($,f){const x=(f-$)*.1||1;return[$-x,f+x]}function c(){const{a:$,b:f}=Z(n,e),[x,b]=u(Math.min(...n),Math.max(...n)),v=[{x:n,y:e,mode:"markers",type:"scatter",name:y({hu:"adatok",en:"data"}),marker:{size:11,color:de()}},{x:[x,b],y:[$*x+f,$*b+f],mode:"lines",name:y(q.demoBestFit),line:{color:$e(),width:3}}];t&&v.push({x:[x,b],y:[s*x+a,s*b+a],mode:"lines",name:y(q.demoGuess),line:{color:"#f4a261",width:2,dash:"dash"}}),ne.react(i,v,pe({xaxis:{range:[x,b]}}),fe);const z=H(A=>$*A+f,n,e);let w=`<div class="ro-row">$\\bar a = ${$.toFixed(6)},\\quad \\bar b = ${f.toFixed(6)}$</div>`;if(w+=`<div class="ro-row"><span class="ro-label">${y(q.optimalError)}:</span> $F = ${z.toFixed(6)}$</div>`,t){const A=H(F=>s*F+a,n,e),B=A>0?z/A:1,C=B>.98?"★★★":B>.85?"★★☆":B>.6?"★☆☆":"☆☆☆";w+=`<div class="ro-row"><span class="ro-label">${y(q.yourError)}:</span> $F = ${A.toFixed(6)}$ <span class="ro-stars">${C}</span></div>`}o.innerHTML=w,Ee(o)}function m(){const $=i.querySelector(".nsewdrag");if(!$)return;let f=-1;const x=b=>{const v=$.getBoundingClientRect(),z=i._fullLayout.xaxis,w=i._fullLayout.yaxis;return{x:z.p2d(b.clientX-v.left),y:w.p2d(b.clientY-v.top)}};$.addEventListener("mousedown",b=>{const v=x(b),z=i._fullLayout.xaxis,w=i._fullLayout.yaxis,A=z.range[1]-z.range[0],B=w.range[1]-w.range[0];let C=-1,F=1/0;for(let V=0;V<n.length;V++){const se=(n[V]-v.x)/A,Q=(e[V]-v.y)/B,K=se*se+Q*Q;K<F&&(F=K,C=V)}C>=0&&F<.0025&&(f=C,b.preventDefault())}),window.addEventListener("mousemove",b=>{f<0||(e[f]=x(b).y,c())}),window.addEventListener("mouseup",()=>{f=-1})}r.querySelector('[data-act="best"]').addEventListener("click",()=>{t=!1,l.hidden=!0,r.querySelector('[data-act="guess"]').setAttribute("aria-pressed","false"),c()}),r.querySelector('[data-act="guess"]').addEventListener("click",$=>{t=!t,l.hidden=!t,$.currentTarget.setAttribute("aria-pressed",String(t)),c()}),r.querySelector('[data-act="add"]').addEventListener("click",()=>{const $=Z(n,e),f=Math.max(...n)+1;n.push(f),e.push($.a*f+$.b),c(),setTimeout(m,60)}),r.querySelector('[data-act="reset"]').addEventListener("click",()=>{n=[...ce.xs],e=[...ce.ys],c(),setTimeout(m,60)}),r.querySelectorAll("[data-slider]").forEach($=>{$.value=$.dataset.slider==="a"?s:a,$.addEventListener("input",()=>{$.dataset.slider==="a"?s=parseFloat($.value):a=parseFloat($.value),r.querySelector("[data-ga]").textContent=s.toFixed(2),r.querySelector("[data-gb]").textContent=a.toFixed(2),c()})}),r.querySelector("[data-ga]").textContent=s.toFixed(2),r.querySelector("[data-gb]").textContent=a.toFixed(2),c(),setTimeout(m,80);const p=ve(()=>c()),d=Ie(r,[i]);return()=>{p(),d()}}const He={xs:[-1,0,.5,1,2,2.5,3],ys:[1.4,1.9,1.6,1.7,.2,-.1,-2]};function kn(r){let n=[...He.xs],e=[...He.ys],t=2;const s=Math.min(6,n.length-1);r.innerHTML=`
    <div class="demo">
      ...
      <div class="demo-plot" data-plot></div>
      <div class="demo-readout" data-readout></div>
    </div>`;const a=r.querySelector("[data-plot]"),i=r.querySelector("[data-readout]");r.querySelector("[data-deg]").textContent=t;function o(){const c=St(n,e,t),m=Math.min(...n)-.4,p=Math.max(...n)+.4,d=[],$=[],f=120;for(let z=0;z<=f;z++){const w=m+(p-m)*z/f;d.push(w),$.push(Be(c,w))}ne.react(a,[{x:n,y:e,mode:"markers",type:"scatter",name:y({hu:"adatok",en:"data"}),marker:{size:11,color:de()}},{x:d,y:$,mode:"lines",name:`${y({hu:"fokszám",en:"degree"})} ${t}`,line:{color:$e(),width:3}}],pe({xaxis:{range:[m,p]}}),fe);const x=H(z=>Be(c,z),n,e);let v=`<div class="ro-row">$p(x) = ${c.map((z,w)=>w===0?z.toFixed(4):`${z>=0?"+":""}${z.toFixed(4)}x^{${w}}`).join(" ")}$</div>`;v+=`<div class="ro-row"><span class="ro-label">${y(q.error)}:</span> $F = ${x.toFixed(6)}$</div>`,t>=n.length-1&&(v+=`<div class="ro-row ro-warn">${y({hu:"⚠ $m \\ge n$: interpoláció, a hiba ≈ 0.",en:"⚠ $m \\ge n$: interpolation, error ≈ 0."})}</div>`),i.innerHTML=v,Ee(i)}r.querySelector('[data-slider="m"]').addEventListener("input",c=>{t=parseInt(c.target.value,10),r.querySelector("[data-deg]").textContent=t,o()}),o();const l=ve(()=>o()),u=Ie(r,[a]);return()=>{l(),u()}}const zn={exp:{xs:[0,1,1.5,2,3,4],ys:[.3,.7,.9,1.2,1.8,2.7]},power:{xs:[.5,1,1.5,2.5,3],ys:[.7,1.1,1.6,2.1,2.3]}};function vn(r){let n="exp";r.innerHTML=`
    <div class="demo">
      <div class="demo-controls">
...
# -> slope b = 0.8, intercept a = 1.4
`,Xn=`// Least-squares line y = a + b x via the 2x2 normal equations.
...
# -> slope b = 0.8, intercept a = 1.4
`,Kn=`// Least-squares line y = a + b x via the 2x2 normal equations.
...
// -> slope b = 0.8, intercept a = 1.4
`,Un=`lineFit[x_, y_] := Module[{n = Length[x], Sx, Sy, Sxx, Sxy, a, b},
...
`,ni=`function poly_fit(t, y, degree)
...
`,ii=`// Least-squares polynomial fit via the normal equations.
...
`,ai=`function c = poly_fit(t, y, degree)
...
`,ri=`# Least-squares polynomial fit; returns coefficients (low -> high).
...
`,oi=`// Least-squares polynomial fit via the normal equations (A^T A) c = A^T y.
...
`,li=`polyFit[t_, y_, degree_] := Module[{A},
...
`,pi=`// Fit y ~ b*t^a by linear least squares on log-log data. Returns [a, b].
...
if __name__ == "__main__":
    ...
    a, b = power_fit(t, y)
    print(f"a = {a:.4f}, b = {b:.4f}")
`,fi=`# Fit y ~ b*t^a by linear least squares on log-log data. Returns (a, b).
...
`,gi=Object.assign({"./exponential.cpp":In,"./exponential.f90":Ln,"./exponential.go":Mn,"./exponential.jl":Rn,"./exponential.js":Nn,"./exponential.m":Bn,"./exponential.py":Cn,"./exponential.r":Wn,"./exponential.rs":Pn,"./exponential.wl":Vn,"./line.cpp":Dn,"./line.f90":Hn,"./line.go":On,"./line.jl":Gn,"./line.js":Xn,"./line.m":Yn,"./line.py":Zn,"./line.r":Qn,"./line.rs":Kn,"./line.wl":Un,"./polynomial.cpp":Jn,"./polynomial.f90":ei,"./polynomial.go":ti,"./polynomial.jl":ni,"./polynomial.js":ii,"./polynomial.m":ai,"./polynomial.py":si,"./polynomial.r":ri,"./polynomial.rs":oi,"./polynomial.wl":li,"./power.cpp":ci,"./power.f90":hi,"./power.go":ui,"./power.jl":mi,"./power.js":pi,"./power.m":$i,"./power.py":di,"./power.r":fi,"./power.rs":xi,"./power.wl":bi}),I=(r,n)=>gi[`./${r}.${n}`],yi={line:{en:"Least-squares line fit (normal equations)",hu:"Legkisebb négyzetes egyenesillesztés (normálegyenletek)"},polynomial:{en:"Least-squares polynomial fit",hu:"Legkisebb négyzetes polinomillesztés"},exponential:{en:"Exponential fit  y ≈ b·e^{a t}",hu:"Exponenciális illesztés  y ≈ b·e^{a t}"},power:{en:"Power-law fit  y ≈ b·t^a",hu:"Hatványfüggvény-illesztés  y ≈ b·t^a"}},_i=r=>({id:r,caption:yi[r],snippets:{matlab:I(r,"m"),python:I(r,"py"),cpp:I(r,"cpp"),julia:I(r,"jl"),rust:I(r,"rs"),fortran:I(r,"f90"),wolfram:I(r,"wl"),javascript:I(r,"js"),go:I(r,"go"),r:I(r,"r")}}),ki={line:["line"],polynomial:["polynomial"],nonlinear:["exponential","power"]};function zi(r){return(ki[r]??[]).map(_i)}function vi({block:r}){const{t:n}=D();return h.jsxs("figure",{className:"data-table",children:[r.caption&&h.jsx("figcaption",{children:h.jsx(M,{text:n(r.caption)})}),h.jsxs("table",{children:[h.jsx("thead",{children:h.jsx("tr",{children:r.headers.map((e,t)=>h.jsx("th",{children:h.jsx(M,{text:e})},t))})}),h.jsxs("tbody",{children:[r.rows.map((e,t)=>h.jsx("tr",{children:e.map((s,a)=>h.jsx("td",{children:h.jsx(M,{text:s})},a))},t)),r.totals&&h.jsx("tr",{className:"totals",children:r.totals.map((e,t)=>h.jsx("td",{children:h.jsx(M,{text:e})},t))})]})]})]})}function wi({block:r}){const{t:n,lang:e}=D(),t=e==="hu"?"Megoldás":"Show solution";return h.jsxs("div",{className:"exercises",children:[h.jsx("h4",{children:n(r.label)}),h.jsx("p",{children:h.jsx(M,{text:n(r.intro)})}),h.jsx("div",{className:"exercise-grid",children:r.items.map((s,a)=>h.jsxs("div",{className:"exercise-card",children:[h.jsx("div",{className:"exercise-tag",children:h.jsx(M,{text:s.tag})}),h.jsx("table",{className:"mini",children:h.jsxs("tbody",{children:[h.jsxs("tr",{children:[h.jsx("th",{children:h.jsx(M,{text:s.headers[0]})}),s.cols.map(([i],o)=>h.jsx("td",{children:i},o))]}),h.jsxs("tr",{children:[h.jsx("th",{children:h.jsx(M,{text:s.headers[1]})}),s.cols.map(([,i],o)=>h.jsx("td",{children:i},o))]})]})})]},a))}),r.solution&&h.jsx("div",{className:"prose",children:h.jsx(P,{markdown:`<details class="reveal-solution"><summary>${t}</summary>

${r.solution}

</details>`})})]})}function qi({block:r,sectionId:n}){const{t:e}=D();switch(r.type){case"text":return h.jsx("div",{className:"prose",children:h.jsx(P,{markdown:e(r)})});case"math":return h.jsx("div",{className:"math-display",children:h.jsx(P,{markdown:`$$
${r.tex}
$$`})});case"callout":return h.jsx("div",{className:`callout ${r.variant||"note"}`,children:h.jsx(P,{markdown:e(r)})});case"theorem":case"example":return h.jsxs("div",{className:`box ${r.type}`,children:[h.jsx("div",{className:"box-label",children:e(r.label)}),h.jsx("div",{className:"box-body",children:h.jsx(P,{markdown:e(r)})})]});case"table":return h.jsx(vi,{block:r});case"exercises":return h.jsx(wi,{block:r});case"demo":return h.jsx(wn,{component:r.component,caption:r.caption?e(r.caption):void 0});case"quiz":return h.jsx(jn,{refKey:r.ref,sectionId:n});case"glossary":return h.jsx(Tn,{deck:r.deck});case"flashcards":return h.jsx(En,{deck:r.deck});default:return null}}function ji({section:r}){const{t:n}=D();return h.jsxs("article",{className:"section",id:`sec-${r.id}`,children:[h.jsxs("h2",{className:"section-title",children:[n(r.title),qt(r.id)&&h.jsx("span",{className:"done-badge",children:"✓"})]}),r.blocks.map((e,t)=>h.jsx(qi,{block:e,sectionId:r.id},t)),zi(r.id).map(e=>h.jsx($t,{snippets:e.snippets,caption:e.caption},e.id))]})}const lt=Xe,Ai={intro:"9",line:"9.1",polynomial:"9.2",nonlinear:"9.3"},Si=lt.map(r=>({id:`sec-${r.id}`,no:Ai[r.id]??"9",title:r.title,blurb:{en:"",hu:""}}));function Bi(){const{lang:r}=D(),{theme:n}=mt(),e=pt();return S.useEffect(()=>{xt(r)},[r]),S.useEffect(()=>{gt(n)},[n]),S.useEffect(()=>{const t=decodeURIComponent(e.hash.replace(/^#/,""));t&&requestAnimationFrame(()=>{var s;return(s=document.getElementById(t))==null?void 0:s.scrollIntoView()})},[e.hash]),h.jsxs("div",{className:"ch-least-squares",children:[h.jsx(dt,{sections:Si}),h.jsx("main",{className:"content content--full",children:lt.map(t=>h.jsx(ji,{section:t},t.id))})]})}export{Bi as default};
