...
Összefüggés: \(B_n = \sum_{k=0}^{n} S(n,k)\)</div></div>`,I=[{id:"alap",label:"Alapfogalom",content:t.jsx(x,{html:F})},{id:"lin",label:"Lineáris rekurziók",content:t.jsxs("div",{children:[t.jsx(x,{html:C}),t.jsx(p,{})]})},{id:"cat",label:"Catalan-számok",content:t.jsxs("div",{children:[t.jsx(x,{html:B}),t.jsx(j,{})]})},{id:"coin",label:"Pénzváltás",content:t.jsxs("div",{children:[t.jsx(x,{html:A}),t.jsx(_,{})]})},{id:"egf",label:"Exponenciális GF",content:t.jsxs("div",{children:[t.jsx(x,{html:q}),t.jsx(N,{})]})}];function L(){return t.jsxs("div",{className:"ila",children:[t.jsx(y,{to:"/dimat",className:"ila__back",children:"← Fejezetek"}),t.jsx("p",{className:"ila__kicker",children:"Diszkrét matematika VI — fejezet"}),t.jsx("h1",{className:"ila__title",children:"Generátorfüggvények"}),t.jsx("p",{className:"ila__cite",children:"Dr. Szalkai István · Pannon Egyetem Matematika Tanszék · 2026"}),t.jsx(u,{tabs:I})]})}export{L as default};
