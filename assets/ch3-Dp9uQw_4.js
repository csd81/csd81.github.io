import{j as t,L as g,r as d}from"./index-CAqBiqM_.js";import{T as p,R as s}from"./kit-C3piugpg.js";import"./auto-render-DUhD6wWl.js";import"./katex-Dc8nsIP1.js";const n=[{label:"a)",num:"440 747",factored:"613 × 719",note:"két közeli prím"},{label:"b)",num:"2 347 589",factored:"1 483 × 1 583",note:"két közeli prím"},{label:"c)",num:"97 189 241",factored:"7 151 × 13 591",note:"két prím"},{label:"d)",num:"17 967 876 255 379",factored:"81 371 × 220 814 249",note:"két prím"},{label:"e)",num:"444 113 096 135 661 846 937",factored:"3 719 977 867 × 119 385 951 211",note:"két 10-jegyű prím"},{label:"f)",num:"2⁶⁷ − 1 = 147 573 952 589 676 412 927",factored:"193 707 721 × 761 838 257 287",note:"Cole, 1903 — történelmi"},{label:"g)",num:"129-jegyű RSA-129",factored:"RSA-129: feltörve 1994, 600 gép, 8 hónap",note:"9.1 alfej. 10.23. Megoldás"}];function b(){const[l,o]=d.useState(new Array(n.length).fill(!1)),i=e=>o(a=>a.map((r,m)=>m===e?!r:r));return t.jsxs("div",{className:"info-box",style:{overflowX:"auto"},children:[t.jsx("span",{className:"lbl",style:{color:"#fbbf24"},children:"3.25 Megoldás — Az 1.1 példa felbontásai"}),t.jsx("p",{style:{fontSize:".83rem",margin:".4rem 0"},children:"Most felfedjük a bevezető fejezet 7 számának prímfelbontásait. Kattints egy sorra!"}),t.jsxs("table",{className:"cayley",style:{width:"100%",fontSize:".83rem"},children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{style:{textAlign:"left",width:"2.5rem"},children:"Jel"}),t.jsx("th",{style:{textAlign:"left"},children:"Szám"}),t.jsx("th",{style:{textAlign:"right",width:"14rem"},children:"Felbontás"})]})}),t.jsx("tbody",{children:n.map((e,a)=>t.jsxs("tr",{style:{cursor:"pointer",background:l[a]?"rgba(251,191,36,.07)":void 0},onClick:()=>i(a),children:[t.jsx("td",{style:{color:"#a78bfa",fontFamily:"monospace",fontWeight:700},children:e.label}),t.jsx("td",{style:{fontFamily:"monospace",fontSize:".8rem",color:"#c4cdd8"},children:e.num}),t.jsx("td",{style:{textAlign:"right",fontSize:".78rem"},children:l[a]?t.jsxs("span",{style:{color:"#fbbf24",fontWeight:700},children:[e.factored," ",t.jsxs("span",{style:{color:"#64748b",fontWeight:400},children:["(",e.note,")"]})]}):t.jsx("span",{style:{color:"#64748b",fontStyle:"italic"},children:"kattints ▾"})})]},a))})]}),t.jsxs("div",{className:"thm-box",style:{marginTop:".75rem"},children:[t.jsx("strong",{children:"RSA-129 anekdota."})," 1977-ben Martin Gardner a ",t.jsx("em",{children:"Scientific American"}),"-ben közölte a 129-jegyű kihívást — Rivest, Shamir, Adleman 100 USD-t ajánlott a feltöréséért, és azt jósolták hogy ",t.jsx("em",{children:"40 kvadrillió év"})," kellene hozzá. 1994-ben Atkins, Graff, Lenstra és Leyland az interneten szervezett elosztott számítással 8 hónap alatt megoldotta. Üzenet:",t.jsx("em",{children:' „The magic words are squeamish ossifrage."'})]})]})}const k=String.raw`
<div class="def-box">
...
</div>`,v=[{id:"intro",label:"Áttekintés",content:t.jsx(s,{html:k})},{id:"oszt",label:"3.1 Oszthatóság",content:t.jsx(s,{html:z})},{id:"algprob",label:"3.2 Alg. problémák",content:t.jsxs("div",{children:[t.jsx(s,{html:c}),t.jsx(b,{})]})},{id:"lnko",label:"3.3 lnko & lkkt",content:t.jsx(s,{html:y})},{id:"eloszlas",label:"3.4 Prímeloszlás",content:t.jsx(s,{html:f})},{id:"nevezetes",label:"3.5 Nevezetes",content:t.jsx(s,{html:h})}];function A(){return t.jsxs("div",{className:"ila",children:[t.jsx(g,{to:"/algo",className:"ila__back",children:"← Fejezetek"}),t.jsx("p",{className:"ila__kicker",children:"Számelmélet — 3. fejezet"}),t.jsx("h1",{className:"ila__title",children:"A számelmélet alapjai"}),t.jsx("p",{className:"ila__cite",children:"Szalkai István & Dósa György · Pannon Egyetem · Typotex 2011"}),t.jsx(p,{tabs:v})]})}export{A as default};
