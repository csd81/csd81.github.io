...
`,je={lagrange:{en:ae,hu:te},newton:{en:ie,hu:ne},hermite:{en:ee,hu:Z},spline:{en:ze,hu:qe}};function Se(i,a){var r;return((r=je[i])==null?void 0:r[a])??""}const Ae=`#include <vector>
#include <iostream>
using namespace std;
...
`,Ne=`function hermite_coeffs(x, y, dy)
...
println(a)   # [1, 0, -1, 2]
`,Le=`// Hermite interpolation via divided differences with doubled nodes.
...
`,Me=`function [z, a] = hermite_coeffs(x, y, dy)
...
`,Ve=`hermiteCoeffs[x_, y_, dy_] := Module[{n = Length[x], m, z, Q, i, j},
...
`,Fe=`function lagrange_coeffs(x, y)
    n = length(x)
...
`,Pe=`// Lagrange interpolation via the Vandermonde system V a = y.
function solve(A, b) {
  const n = b.length;
...
`,Ge=`# Polynomial coefficients a (low->high) of the degree n-1 interpolant
# through (x_i, y_i), via the Vandermonde system V a = y.
...
`,Be=`// Lagrange interpolation via the Vandermonde system V a = y.
...
`,Ue=`lagrangeCoeffs[x_, y_] := Module[{n = Length[x], V},
...
`,sn=`program divided_differences_demo
  implicit none
  integer, parameter :: n = 4
  real(8) :: x(n), a(n)
  integer :: i, j
...
`,dn=`function divided_differences(x, y)
...
`,fn=`// Newton divided-difference coefficients a_i = f[x_0, ..., x_i].
...
`,_n=`function a = divided_differences(x, y)
...
`,xn=`dividedDifferences[x_, y_] := Module[{a = N[y], n = Length[x], i, j},
...
`,gn=`function natural_cubic_spline(x, y)
    n = length(x); h = diff(x)
...
`,bn=`function [a, b, c, d] = natural_cubic_spline(x, y)
...
if __name__ == "__main__":
    ...
    print("c =", c)
    print("d =", d)
`,kn=`# Natural cubic spline. Returns per-interval (a, b, c, d) with
# S_i(t) = a_i + b_i (t - x_i) + c_i (t - x_i)^2 + d_i (t - x_i)^3.
...
`,zn=`naturalCubicSpline[x_, y_] := Module[{n = Length[x], h, A, rhs, c, a, b, d},
   h = Differences[x];
...
`,qn=Object.assign({"./hermite.cpp":Ae,"./hermite.f90":De,"./hermite.go":Te,"./hermite.jl":Ne,"./hermite.js":Le,"./hermite.m":Me,"./hermite.py":Ie,"./hermite.r":He,"./hermite.rs":Ce,"./hermite.wl":Ve,"./lagrange.cpp":We,"./lagrange.f90":Qe,"./lagrange.go":Ee,"./lagrange.jl":Fe,"./lagrange.js":Pe,"./lagrange.m":Re,"./lagrange.py":Oe,"./lagrange.r":Ge,"./lagrange.rs":Be,"./lagrange.wl":Ue,"./newton-eval.cpp":Ke,"./newton-eval.f90":Xe,"./newton-eval.go":Ye,"./newton-eval.jl":Je,"./newton-eval.js":Ze,"./newton-eval.m":en,"./newton-eval.py":nn,"./newton-eval.r":tn,"./newton-eval.rs":an,"./newton-eval.wl":on,"./newton.cpp":rn,"./newton.f90":sn,"./newton.go":ln,"./newton.jl":dn,"./newton.js":fn,"./newton.m":_n,"./newton.py":cn,"./newton.r":$n,"./newton.rs":hn,"./newton.wl":xn,"./spline.cpp":mn,"./spline.f90":pn,"./spline.go":un,"./spline.jl":gn,"./spline.js":yn,"./spline.m":bn,"./spline.py":vn,"./spline.r":kn,"./spline.rs":wn,"./spline.wl":zn}),q=(i,a)=>qn[`./${i}.${a}`],jn={lagrange:{en:"Lagrange interpolation (Vandermonde system)",hu:"Lagrange-interpoláció (Vandermonde-rendszer)"},newton:{en:"Newton's divided differences (coefficients)",hu:"Newton-féle osztott differenciák (együtthatók)"},"newton-eval":{en:"Newton polynomial evaluation (nested form)",hu:"Newton-polinom kiértékelése (beágyazott alak)"},hermite:{en:"Hermite interpolation",hu:"Hermite-interpoláció"},spline:{en:"Natural cubic spline",hu:"Természetes köbös spline"}},Sn=i=>({id:i,caption:jn[i],snippets:{matlab:q(i,"m"),python:q(i,"py"),cpp:q(i,"cpp"),julia:q(i,"jl"),rust:q(i,"rs"),fortran:q(i,"f90"),wolfram:q(i,"wl"),javascript:q(i,"js"),go:q(i,"go"),r:q(i,"r")}}),An={lagrange:["lagrange"],newton:["newton","newton-eval"],hermite:["hermite"],spline:["spline"]};function Dn(i){return(An[i]??[]).map(Sn)}function C({str:i,method:a,points:r,derivatives:t,allowCompare:l,showTable:o,enableDerivatives:s}){const{lang:f}=E(),n=i.lessons[a],_=Se(a,f),m=Dn(a);return e.jsxs("article",{className:"lesson",children:[e.jsxs("header",{children:[e.jsx("h2",{children:n.title}),e.jsx("p",{className:"intro",children:n.intro})]}),e.jsxs("section",{className:"theorem-card",children:[e.jsx("div",{className:"theorem-tag",children:n.theoremTitle}),e.jsx(oe,{block:!0,children:n.theorem}),e.jsx("p",{children:n.body})]}),_&&e.jsxs("details",{className:"lesson__theory",open:!0,children:[e.jsx("summary",{children:f==="hu"?"Elmélet":"Theory"}),e.jsx(Q,{markdown:_})]}),m.map(h=>e.jsx(Y,{snippets:h.snippets,caption:h.caption},h.id)),e.jsxs("p",{className:"tryit",children:["👉 ",n.tryIt]}),e.jsx(ge,{str:i,initialPoints:r,initialDerivs:t,primary:a,allowCompare:l,showTable:o,enableDerivatives:s}),e.jsx(ve,{deck:a}),e.jsx(we,{deck:a})]})}const V={lagrange:"#ff5d8f",newton:"#f5a623",hermite:"#9b5de5",spline:"#00bbf9"},B=i=>Math.cos(i),W=[-Math.PI-.5,Math.PI+.5],Tn=[-2.5,2.5];function Nn(){const i=Array.from({length:40}),a=["#ff5d8f","#f5a623","#9b5de5","#00bbf9","#3ddc97"];return e.jsx("div",{className:"confetti","aria-hidden":!0,children:i.map((r,t)=>e.jsx("span",{style:{left:`${Math.random()*100}%`,background:a[t%a.length],animationDelay:`${Math.random()*.6}s`,transform:`rotate(${Math.random()*360}deg)`}},t))})}function Ln({str:i}){const[a,r]=p.useState([{x:-3,y:-.5},{x:-1.2,y:.5},{x:.5,y:.7},{x:2,y:-.2},{x:3,y:-.8}]),[t,l]=p.useState("spline"),[o,s]=p.useState(!0),f=p.useMemo(()=>[...a].sort((x,g)=>x.x-g.x),[a]),n=p.useMemo(()=>F(t,f),[t,f]),_=p.useMemo(()=>{let x=0;for(let g=0;g<=80;g++){const v=W[0]+(W[1]-W[0])*g/80,S=Math.abs(n(v)-B(v));Number.isFinite(S)&&(x=Math.max(x,S))}return x},[n]),m=_<.18,h=[{fn:n,color:V[t],label:i.methods[t]}];o&&h.push({fn:B,color:"#8aa0b5",label:"cos x",dashed:!0});const u=(x,g,v)=>r(S=>S.map((D,T)=>T===x?{x:g,y:v}:D));return e.jsxs("div",{className:"challenge",children:[e.jsxs("div",{className:"challenge-head",children:[e.jsx("h2",{children:i.nav.playground}),e.jsx("p",{className:"intro",children:i.tagline})]}),e.jsxs("div",{className:"challenge-bar",children:[e.jsx("div",{className:"methodpills",children:Object.keys(V).map(x=>e.jsx("button",{className:`pill ${t===x?"on":""}`,style:t===x?{background:V[x],borderColor:V[x]}:{},onClick:()=>l(x),children:i.methods[x]},x))}),e.jsxs("label",{className:"chip",children:[e.jsx("input",{type:"checkbox",checked:o,onChange:()=>s(x=>!x)}),i.ui.showCos]})]}),e.jsxs("div",{className:"challenge-plotwrap",children:[e.jsx(U,{points:a,curves:h,domain:W,range:Tn,onDrag:u,width:720,height:440}),m&&e.jsx(Nn,{})]}),e.jsx("div",{className:`challenge-status ${m?"win":""}`,children:m?e.jsx("strong",{children:i.ui.nailedIt}):e.jsxs("span",{children:["🎯 ",i.ui.challengeHint," ",e.jsxs("em",{children:["(max Δ = ",_.toFixed(2),")"]})]})})]})}const Mn=[{id:"play",no:"6·play",title:{en:z.en.nav.playground,hu:z.hu.nav.playground},blurb:{en:"",hu:""}},{id:"lagrange",no:"6.1",title:{en:z.en.nav.lagrange,hu:z.hu.nav.lagrange},blurb:{en:"",hu:""}},{id:"newton",no:"6.2",title:{en:z.en.nav.newton,hu:z.hu.nav.newton},blurb:{en:"",hu:""}},{id:"hermite",no:"6.4",title:{en:z.en.nav.hermite,hu:z.hu.nav.hermite},blurb:{en:"",hu:""}},{id:"spline",no:"6.5",title:{en:z.en.nav.spline,hu:z.hu.nav.spline},blurb:{en:"",hu:""}}];function Fn(){const{lang:i}=E(),a=z[i],r={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return e.jsxs("div",{className:"app ch-interpolation",children:[e.jsx(J,{sections:Mn}),e.jsx("header",{className:"topbar",children:e.jsxs("div",{className:"brand",children:[e.jsx("span",{className:"logo",children:"📈"}),e.jsxs("div",{children:[e.jsx("div",{className:"brand-title",children:a.appTitle}),e.jsx("div",{className:"brand-sub",children:a.tagline})]})]})}),e.jsxs("main",{className:"content",children:[e.jsx("section",{id:"play",style:r,children:e.jsx(Ln,{str:a})}),e.jsx("section",{id:"lagrange",style:r,children:e.jsx(C,{str:a,method:"lagrange",points:[{x:-1,y:-3},{x:1,y:1},{x:2,y:3},{x:3,y:29}],allowCompare:!0})}),e.jsx("section",{id:"newton",style:r,children:e.jsx(C,{str:a,method:"newton",points:[{x:-1,y:-2},{x:1,y:0},{x:2,y:-2},{x:3,y:2}],showTable:!0,allowCompare:!0})}),e.jsx("section",{id:"hermite",style:r,children:e.jsx(C,{str:a,method:"hermite",points:[{x:-1,y:2},{x:1,y:4},{x:2,y:11}],derivatives:[3,-5,30],enableDerivatives:!0})}),e.jsx("section",{id:"spline",style:r,children:e.jsx(C,{str:a,method:"spline",points:[{x:0,y:.5},{x:1,y:.1},{x:1.5,y:2.5},{x:2,y:-1},{x:3,y:-.5},{x:4,y:0}],allowCompare:!0})})]}),e.jsx("footer",{className:"foot",children:"InterPlay · Numerical Analysis · Interpolation"})]})}export{Fn as default};
