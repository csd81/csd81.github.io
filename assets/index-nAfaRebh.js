...
`,qe={lagrange:{en:ue,hu:ye},newton:{en:ke,hu:be},hermite:{en:ve,hu:ze},spline:{en:we,hu:je}};function Le(t,a){var s;return((s=qe[t])==null?void 0:s[a])??""}const Te=`#include <vector>
#include <iostream>
using namespace std;
...
`,Me=`hermiteCoeffs[x_, y_, dy_] := Module[{n = Length[x], m, z, Q, i, j},
...
`,Ve=`function lagrange_coeffs(x, y)
    n = length(x)
...
`,Qe=`function a = lagrange_coeffs(x, y)
...
`,Oe=`lagrangeCoeffs[x_, y_] := Module[{n = Length[x], V},
...
`,Ye=`// Evaluate the Newton form by nested (Horner-like) multiplication.
...
`,Je=`function p = newton_eval(x, a, t)
...
`,en=`// Evaluate the Newton form by nested (Horner-like) multiplication.
...
`,nn=`newtonEval[x_, a_, t_] := Module[{p = Last[a], k},
...
`,an=`program divided_differences_demo
  implicit none
  integer, parameter :: n = 4
  real(8) :: x(n), a(n)
  integer :: i, j
...
`,sn=`function divided_differences(x, y)
...
`,ln=`// Newton divided-difference coefficients a_i = f[x_0, ..., x_i].
...
`,rn=`function a = divided_differences(x, y)
...
`,$n=`dividedDifferences[x_, y_] := Module[{a = N[y], n = Length[x], i, j},
...
`,cn=`function natural_cubic_spline(x, y)
    n = length(x); h = diff(x)
...
println("a = ", a)
`,mn=`// Natural cubic spline: per-interval coefficients (a, b, c, d).
function solve(A, b) {
  const n = b.length;
  const m = A.map((r) => [...r]), r = [...b];
  for (let k = 0; k < n; k++) {
...
`,pn=`function [a, b, c, d] = natural_cubic_spline(x, y)
...
if __name__ == "__main__":
    ...
    print("c =", c)
    print("d =", d)
`,un=`// Natural cubic spline: per-interval coefficients (a, b, c, d).
fn solve(mut a: Vec<Vec<f64>>, mut b: Vec<f64>) -> Vec<f64> {
    let n = b.len();
    for k in 0..n {
        let mut p = k;
...
`,yn=`naturalCubicSpline[x_, y_] := Module[{n = Length[x], h, A, rhs, c, a, b, d},
   h = Differences[x];
...
`,kn=Object.assign({"./hermite.cpp":Te,"./hermite.f90":Ae,"./hermite.go":Se,"./hermite.jl":He,"./hermite.js":De,"./hermite.m":Ne,"./hermite.py":Ie,"./hermite.rs":Ce,"./hermite.wl":Me,"./lagrange.cpp":Ee,"./lagrange.f90":Pe,"./lagrange.go":We,"./lagrange.jl":Ve,"./lagrange.js":Fe,"./lagrange.m":Qe,"./lagrange.py":Re,"./lagrange.rs":Be,"./lagrange.wl":Oe,"./newton-eval.cpp":Ue,"./newton-eval.f90":Ge,"./newton-eval.go":Ke,"./newton-eval.jl":Xe,"./newton-eval.js":Ye,"./newton-eval.m":Je,"./newton-eval.py":Ze,"./newton-eval.rs":en,"./newton-eval.wl":nn,"./newton.cpp":tn,"./newton.f90":an,"./newton.go":on,"./newton.jl":sn,"./newton.js":ln,"./newton.m":rn,"./newton.py":xn,"./newton.rs":_n,"./newton.wl":$n,"./spline.cpp":dn,"./spline.f90":fn,"./spline.go":hn,"./spline.jl":cn,"./spline.js":mn,"./spline.m":pn,"./spline.py":gn,"./spline.rs":un,"./spline.wl":yn}),q=(t,a)=>kn[`./${t}.${a}`],bn={lagrange:{en:"Lagrange interpolation (Vandermonde system)",hu:"Lagrange-interpoláció (Vandermonde-rendszer)"},newton:{en:"Newton's divided differences (coefficients)",hu:"Newton-féle osztott differenciák (együtthatók)"},"newton-eval":{en:"Newton polynomial evaluation (nested form)",hu:"Newton-polinom kiértékelése (beágyazott alak)"},hermite:{en:"Hermite interpolation",hu:"Hermite-interpoláció"},spline:{en:"Natural cubic spline",hu:"Természetes köbös spline"}},vn=t=>({id:t,caption:bn[t],snippets:{matlab:q(t,"m"),python:q(t,"py"),cpp:q(t,"cpp"),julia:q(t,"jl"),rust:q(t,"rs"),fortran:q(t,"f90"),wolfram:q(t,"wl"),javascript:q(t,"js"),go:q(t,"go")}}),zn={lagrange:["lagrange"],newton:["newton","newton-eval"],hermite:["hermite"],spline:["spline"]};function wn(t){return(zn[t]??[]).map(vn)}function M({str:t,method:a,points:s,derivatives:i,allowCompare:r,showTable:o,enableDerivatives:l}){const{lang:_}=V(),n=t.lessons[a],$=Le(a,_),m=wn(a);return e.jsxs("article",{className:"lesson",children:[e.jsxs("header",{children:[e.jsx("h2",{children:n.title}),e.jsx("p",{className:"intro",children:n.intro})]}),e.jsxs("section",{className:"theorem-card",children:[e.jsx("div",{className:"theorem-tag",children:n.theoremTitle}),e.jsx(Z,{block:!0,children:n.theorem}),e.jsx("p",{children:n.body})]}),$&&e.jsxs("details",{className:"lesson__theory",open:!0,children:[e.jsx("summary",{children:_==="hu"?"Elmélet":"Theory"}),e.jsx(W,{markdown:$})]}),m.map(h=>e.jsx(Y,{snippets:h.snippets,caption:h.caption},h.id)),e.jsxs("p",{className:"tryit",children:["👉 ",n.tryIt]}),e.jsx(fe,{str:t,initialPoints:s,initialDerivs:i,primary:a,allowCompare:r,showTable:o,enableDerivatives:l}),e.jsx(me,{deck:a}),e.jsx(ge,{deck:a})]})}const E={lagrange:"#ff5d8f",newton:"#f5a623",hermite:"#9b5de5",spline:"#00bbf9"},U=t=>Math.cos(t),P=[-Math.PI-.5,Math.PI+.5],jn=[-2.5,2.5];function qn(){const t=Array.from({length:40}),a=["#ff5d8f","#f5a623","#9b5de5","#00bbf9","#3ddc97"];return e.jsx("div",{className:"confetti","aria-hidden":!0,children:t.map((s,i)=>e.jsx("span",{style:{left:`${Math.random()*100}%`,background:a[i%a.length],animationDelay:`${Math.random()*.6}s`,transform:`rotate(${Math.random()*360}deg)`}},i))})}function Ln({str:t}){const[a,s]=p.useState([{x:-3,y:-.5},{x:-1.2,y:.5},{x:.5,y:.7},{x:2,y:-.2},{x:3,y:-.8}]),[i,r]=p.useState("spline"),[o,l]=p.useState(!0),_=p.useMemo(()=>[...a].sort((c,u)=>c.x-u.x),[a]),n=p.useMemo(()=>F(i,_),[i,_]),$=p.useMemo(()=>{let c=0;for(let u=0;u<=80;u++){const b=P[0]+(P[1]-P[0])*u/80,L=Math.abs(n(b)-U(b));Number.isFinite(L)&&(c=Math.max(c,L))}return c},[n]),m=$<.18,h=[{fn:n,color:E[i],label:t.methods[i]}];o&&h.push({fn:U,color:"#8aa0b5",label:"cos x",dashed:!0});const g=(c,u,b)=>s(L=>L.map((A,S)=>S===c?{x:u,y:b}:A));return e.jsxs("div",{className:"challenge",children:[e.jsxs("div",{className:"challenge-head",children:[e.jsx("h2",{children:t.nav.playground}),e.jsx("p",{className:"intro",children:t.tagline})]}),e.jsxs("div",{className:"challenge-bar",children:[e.jsx("div",{className:"methodpills",children:Object.keys(E).map(c=>e.jsx("button",{className:`pill ${i===c?"on":""}`,style:i===c?{background:E[c],borderColor:E[c]}:{},onClick:()=>r(c),children:t.methods[c]},c))}),e.jsxs("label",{className:"chip",children:[e.jsx("input",{type:"checkbox",checked:o,onChange:()=>l(c=>!c)}),t.ui.showCos]})]}),e.jsxs("div",{className:"challenge-plotwrap",children:[e.jsx(G,{points:a,curves:h,domain:P,range:jn,onDrag:g,width:720,height:440}),m&&e.jsx(qn,{})]}),e.jsx("div",{className:`challenge-status ${m?"win":""}`,children:m?e.jsx("strong",{children:t.ui.nailedIt}):e.jsxs("span",{children:["🎯 ",t.ui.challengeHint," ",e.jsxs("em",{children:["(max Δ = ",$.toFixed(2),")"]})]})})]})}const Tn=[{id:"play",no:"6·play",title:{en:w.en.nav.playground,hu:w.hu.nav.playground},blurb:{en:"",hu:""}},{id:"lagrange",no:"6.1",title:{en:w.en.nav.lagrange,hu:w.hu.nav.lagrange},blurb:{en:"",hu:""}},{id:"newton",no:"6.2",title:{en:w.en.nav.newton,hu:w.hu.nav.newton},blurb:{en:"",hu:""}},{id:"hermite",no:"6.4",title:{en:w.en.nav.hermite,hu:w.hu.nav.hermite},blurb:{en:"",hu:""}},{id:"spline",no:"6.5",title:{en:w.en.nav.spline,hu:w.hu.nav.spline},blurb:{en:"",hu:""}}];function In(){const{lang:t}=V(),a=w[t],s={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return e.jsxs("div",{className:"app ch-interpolation",children:[e.jsx(J,{sections:Tn}),e.jsx("header",{className:"topbar",children:e.jsxs("div",{className:"brand",children:[e.jsx("span",{className:"logo",children:"📈"}),e.jsxs("div",{children:[e.jsx("div",{className:"brand-title",children:a.appTitle}),e.jsx("div",{className:"brand-sub",children:a.tagline})]})]})}),e.jsxs("main",{className:"content",children:[e.jsx("section",{id:"play",style:s,children:e.jsx(Ln,{str:a})}),e.jsx("section",{id:"lagrange",style:s,children:e.jsx(M,{str:a,method:"lagrange",points:[{x:-1,y:-3},{x:1,y:1},{x:2,y:3},{x:3,y:29}],allowCompare:!0})}),e.jsx("section",{id:"newton",style:s,children:e.jsx(M,{str:a,method:"newton",points:[{x:-1,y:-2},{x:1,y:0},{x:2,y:-2},{x:3,y:2}],showTable:!0,allowCompare:!0})}),e.jsx("section",{id:"hermite",style:s,children:e.jsx(M,{str:a,method:"hermite",points:[{x:-1,y:2},{x:1,y:4},{x:2,y:11}],derivatives:[3,-5,30],enableDerivatives:!0})}),e.jsx("section",{id:"spline",style:s,children:e.jsx(M,{str:a,method:"spline",points:[{x:0,y:.5},{x:1,y:.1},{x:1.5,y:2.5},{x:2,y:-1},{x:3,y:-.5},{x:4,y:0}],allowCompare:!0})})]}),e.jsx("footer",{className:"foot",children:"InterPlay · Numerical Analysis 6 · Interpolation — F. Hartung, University of Pannonia"})]})}export{In as default};
