import{j as t,L as g,r as c}from"./index-HlE1l3Wn.js";import{T as m,R as l}from"./kit-CB9mzCA_.js";import"./auto-render-DUhD6wWl.js";import"./katex-Dc8nsIP1.js";const o=[{label:"a",expr:String.raw`\(a = 2^7 \cdot 3^{43} \cdot 11^{93} \cdot 39^{45} \cdot 101^2\)`,log10:"≈ 195,0794",digits:"196"},{label:"b₁₂",expr:String.raw`\(b_{1,2} = 697\,053\,813 \cdot 2^{16352} \pm 1\) (ikerprímek)`,log10:"≈ 4931,286",digits:"4 932"},{label:"c₁₂",expr:String.raw`\(c_{1,2} = 242\,206\,083 \cdot 2^{38880} \pm 1\) (ikerprímek)`,log10:"≈ 11 712,430",digits:"11 713"},{label:"d₁₂",expr:String.raw`\(d_{1,2} = 16\,869\,987\,339\,975 \cdot 2^{171960} \pm 1\) (2005-ös rekord)`,log10:"≈ 51 778,345",digits:"51 779"},{label:"M",expr:String.raw`\(M_{43\,112\,609} = 2^{43\,112\,609} - 1\) (Mersenne-prím)`,log10:"≈ 12 978 188,5",digits:"12 978 189 (12 millió jegy!)"}];function y(){const[n,a]=c.useState(new Array(o.length).fill(!1)),i=s=>a(e=>e.map((r,d)=>d===s?!r:r));return t.jsxs("div",{className:"info-box",style:{overflowX:"auto"},children:[t.jsx("span",{className:"lbl",style:{color:"#a78bfa"},children:"2.12 Példa — Hány jegyűek ezek a számok?"}),t.jsx("p",{style:{fontSize:".83rem",margin:".4rem 0"},children:"Kattints egy sorra a jegyesszám felfedéséhez."}),t.jsxs("table",{className:"cayley",style:{width:"100%",fontSize:".82rem"},children:[t.jsx("thead",{children:t.jsxs("tr",{children:[t.jsx("th",{style:{textAlign:"left",width:"3rem"},children:"Jel"}),t.jsx("th",{style:{textAlign:"left"},children:"Kifejezés"}),t.jsx("th",{style:{textAlign:"right",width:"8rem"},children:"Jegyek"})]})}),t.jsx("tbody",{children:o.map((s,e)=>t.jsxs("tr",{style:{cursor:"pointer",background:n[e]?"rgba(167,139,250,.08)":void 0},onClick:()=>i(e),children:[t.jsx("td",{style:{color:"#a78bfa",fontFamily:"monospace",fontWeight:700},children:s.label}),t.jsx("td",{children:t.jsx(l,{html:s.expr})}),t.jsx("td",{style:{textAlign:"right",fontSize:".78rem"},children:n[e]?t.jsx("span",{style:{color:"#fbbf24",fontWeight:700},children:s.digits}):t.jsx("span",{style:{color:"#64748b",fontStyle:"italic"},children:"kattints ▾"})})]},e))})]})]})}const b=String.raw`
<div class="def-box">
...
</div>`,z=[{id:"intro",label:"Áttekintés",content:t.jsx(l,{html:b})},{id:"bigo",label:"O, Θ, Ω, o, ω",content:t.jsx(l,{html:f})},{id:"scale",label:"Növekedési skála",content:t.jsx(l,{html:k})},{id:"meret",label:"2.2.1 Input mérete",content:t.jsxs("div",{children:[t.jsx(l,{html:h}),t.jsx(y,{})]})},{id:"muvelet",label:"2.2.2 Műveletek",content:t.jsx(l,{html:p})}];function _(){return t.jsxs("div",{className:"ila",children:[t.jsx(g,{to:"/algo",className:"ila__back",children:"← Fejezetek"}),t.jsx("p",{className:"ila__kicker",children:"Számelmélet — 2. fejezet"}),t.jsx("h1",{className:"ila__title",children:"Algoritmusok sebessége"}),t.jsx("p",{className:"ila__cite",children:"Szalkai István & Dósa György · Pannon Egyetem · Typotex 2011"}),t.jsx(m,{tabs:z})]})}export{_ as default};
