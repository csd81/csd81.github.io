...
`,we={lagrange:{en:ge,hu:pe},newton:{en:ue,hu:ke},hermite:{en:ye,hu:be},spline:{en:ve,hu:ze}};function qe(i,o){var s;return((s=we[i])==null?void 0:s[o])??""}function C({str:i,method:o,points:s,derivatives:t,allowCompare:x,showTable:a,enableDerivatives:l}){const{lang:$}=P(),n=i.lessons[o],_=qe(o,$);return e.jsxs("article",{className:"lesson",children:[e.jsxs("header",{children:[e.jsx("h2",{children:n.title}),e.jsx("p",{className:"intro",children:n.intro})]}),e.jsxs("section",{className:"theorem-card",children:[e.jsx("div",{className:"theorem-tag",children:n.theoremTitle}),e.jsx(Y,{block:!0,children:n.theorem}),e.jsx("p",{children:n.body})]}),_&&e.jsxs("details",{className:"lesson__theory",open:!0,children:[e.jsx("summary",{children:$==="hu"?"Elmélet":"Theory"}),e.jsx(W,{markdown:_})]}),e.jsxs("p",{className:"tryit",children:["👉 ",n.tryIt]}),e.jsx(_e,{str:i,initialPoints:s,initialDerivs:t,primary:o,allowCompare:x,showTable:a,enableDerivatives:l}),e.jsx(he,{deck:o}),e.jsx(me,{deck:o})]})}const E={lagrange:"#ff5d8f",newton:"#f5a623",hermite:"#9b5de5",spline:"#00bbf9"},G=i=>Math.cos(i),M=[-Math.PI-.5,Math.PI+.5],je=[-2.5,2.5];function Le(){const i=Array.from({length:40}),o=["#ff5d8f","#f5a623","#9b5de5","#00bbf9","#3ddc97"];return e.jsx("div",{className:"confetti","aria-hidden":!0,children:i.map((s,t)=>e.jsx("span",{style:{left:`${Math.random()*100}%`,background:o[t%o.length],animationDelay:`${Math.random()*.6}s`,transform:`rotate(${Math.random()*360}deg)`}},t))})}function Te({str:i}){const[o,s]=m.useState([{x:-3,y:-.5},{x:-1.2,y:.5},{x:.5,y:.7},{x:2,y:-.2},{x:3,y:-.8}]),[t,x]=m.useState("spline"),[a,l]=m.useState(!0),$=m.useMemo(()=>[...o].sort((h,u)=>h.x-u.x),[o]),n=m.useMemo(()=>F(t,$),[t,$]),_=m.useMemo(()=>{let h=0;for(let u=0;u<=80;u++){const b=M[0]+(M[1]-M[0])*u/80,j=Math.abs(n(b)-G(b));Number.isFinite(j)&&(h=Math.max(h,j))}return h},[n]),g=_<.18,c=[{fn:n,color:E[t],label:i.methods[t]}];a&&c.push({fn:G,color:"#8aa0b5",label:"cos x",dashed:!0});const p=(h,u,b)=>s(j=>j.map((T,S)=>S===h?{x:u,y:b}:T));return e.jsxs("div",{className:"challenge",children:[e.jsxs("div",{className:"challenge-head",children:[e.jsx("h2",{children:i.nav.playground}),e.jsx("p",{className:"intro",children:i.tagline})]}),e.jsxs("div",{className:"challenge-bar",children:[e.jsx("div",{className:"methodpills",children:Object.keys(E).map(h=>e.jsx("button",{className:`pill ${t===h?"on":""}`,style:t===h?{background:E[h],borderColor:E[h]}:{},onClick:()=>x(h),children:i.methods[h]},h))}),e.jsxs("label",{className:"chip",children:[e.jsx("input",{type:"checkbox",checked:a,onChange:()=>l(h=>!h)}),i.ui.showCos]})]}),e.jsxs("div",{className:"challenge-plotwrap",children:[e.jsx(K,{points:o,curves:c,domain:M,range:je,onDrag:p,width:720,height:440}),g&&e.jsx(Le,{})]}),e.jsx("div",{className:`challenge-status ${g?"win":""}`,children:g?e.jsx("strong",{children:i.ui.nailedIt}):e.jsxs("span",{children:["🎯 ",i.ui.challengeHint," ",e.jsxs("em",{children:["(max Δ = ",_.toFixed(2),")"]})]})})]})}const Se=[{id:"play",no:"6·play",title:{en:w.en.nav.playground,hu:w.hu.nav.playground},blurb:{en:"",hu:""}},{id:"lagrange",no:"6.1",title:{en:w.en.nav.lagrange,hu:w.hu.nav.lagrange},blurb:{en:"",hu:""}},{id:"newton",no:"6.2",title:{en:w.en.nav.newton,hu:w.hu.nav.newton},blurb:{en:"",hu:""}},{id:"hermite",no:"6.4",title:{en:w.en.nav.hermite,hu:w.hu.nav.hermite},blurb:{en:"",hu:""}},{id:"spline",no:"6.5",title:{en:w.en.nav.spline,hu:w.hu.nav.spline},blurb:{en:"",hu:""}}];function Ee(){const{lang:i}=P(),o=w[i],s={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return e.jsxs("div",{className:"app ch-interpolation",children:[e.jsx(X,{sections:Se}),e.jsx("header",{className:"topbar",children:e.jsxs("div",{className:"brand",children:[e.jsx("span",{className:"logo",children:"📈"}),e.jsxs("div",{children:[e.jsx("div",{className:"brand-title",children:o.appTitle}),e.jsx("div",{className:"brand-sub",children:o.tagline})]})]})}),e.jsxs("main",{className:"content",children:[e.jsx("section",{id:"play",style:s,children:e.jsx(Te,{str:o})}),e.jsx("section",{id:"lagrange",style:s,children:e.jsx(C,{str:o,method:"lagrange",points:[{x:-1,y:-3},{x:1,y:1},{x:2,y:3},{x:3,y:29}],allowCompare:!0})}),e.jsx("section",{id:"newton",style:s,children:e.jsx(C,{str:o,method:"newton",points:[{x:-1,y:-2},{x:1,y:0},{x:2,y:-2},{x:3,y:2}],showTable:!0,allowCompare:!0})}),e.jsx("section",{id:"hermite",style:s,children:e.jsx(C,{str:o,method:"hermite",points:[{x:-1,y:2},{x:1,y:4},{x:2,y:11}],derivatives:[3,-5,30],enableDerivatives:!0})}),e.jsx("section",{id:"spline",style:s,children:e.jsx(C,{str:o,method:"spline",points:[{x:0,y:.5},{x:1,y:.1},{x:1.5,y:2.5},{x:2,y:-1},{x:3,y:-.5},{x:4,y:0}],allowCompare:!0})})]}),e.jsx("footer",{className:"foot",children:"InterPlay · Numerical Analysis 6 · Interpolation — F. Hartung, University of Pannonia"})]})}export{Ee as default};
