...
`)}}}fences(n){const e=this.rules.block.fences.exec(n);if(e){const t=e[0],s=Ot(t,e[3]||"");return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:s}}}heading(n){const e=this.rules.block.heading.exec(n);if(e){let t=e[2].trim();if(/#$/.test(t)){const s=oe(t,"#");(this.options.pedantic||!s||/ $/.test(s))&&(t=s.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(n){const e=this.rules.block.hr.exec(n);if(e)return{type:"hr",raw:e[0]}}blockquote(n){const e=this.rules.block.blockquote.exec(n);if(e){let t=e[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);t=oe(t.replace(/^ *>[ \t]?/gm,""),`
`);const s=this.lexer.state.top;this.lexer.state.top=!0;const i=this.lexer.blockTokens(t);return this.lexer.state.top=s,{type:"blockquote",raw:e[0],tokens:i,text:t}}}list(n){let e=this.rules.block.list.exec(n);if(e){let t=e[1].trim();const s=t.length>1,i={type:"list",raw:"",ordered:s,start:s?+t.slice(0,-1):"",loose:!1,items:[]};t=s?`\\d{1,9}\\${t.slice(-1)}`:`\\${t}`,this.options.pedantic&&(t=s?t:"[*+-]");const a=new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`);let o="",l="",u=!1;for(;n;){let h=!1;if(!(e=a.exec(n))||this.rules.block.hr.test(n))break;o=e[0],n=n.substring(o.length);let m=e[2].split(`
`,1)[0].replace(/^\t+/,x=>" ".repeat(3*x.length)),p=n.split(`
`,1)[0],f=0;this.options.pedantic?(f=2,l=m.trimStart()):(f=e[2].search(/[^ ]/),f=f>4?1:f,l=m.slice(f),f+=e[1].length);let d=!1;if(!m&&/^ *$/.test(p)&&(o+=p+`
`,n=n.substring(p.length+1),h=!0),!h){const x=new RegExp(`^ {0,${Math.min(3,f-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),v=new RegExp(`^ {0,${Math.min(3,f-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),z=new RegExp(`^ {0,${Math.min(3,f-1)}}(?:\`\`\`|~~~)`),w=new RegExp(`^ {0,${Math.min(3,f-1)}}#`);for(;n;){const A=n.split(`
`,1)[0];if(p=A,this.options.pedantic&&(p=p.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),z.test(p)||w.test(p)||x.test(p)||v.test(n))break;if(p.search(/[^ ]/)>=f||!p.trim())l+=`
`+p.slice(f);else{if(d||m.search(/[^ ]/)>=4||z.test(m)||w.test(m)||v.test(m))break;l+=`
`+p}!d&&!p.trim()&&(d=!0),o+=A+`
`,n=n.substring(A.length+1),m=p.slice(f)}}i.loose||(u?i.loose=!0:/\n *\n *$/.test(o)&&(u=!0));let $=null,g;this.options.gfm&&($=/^\[[ xX]\] /.exec(l),$&&(g=$[0]!=="[ ] ",l=l.replace(/^\[[ xX]\] +/,""))),i.items.push({type:"list_item",raw:o,task:!!$,checked:g,loose:!1,text:l,tokens:[]}),i.raw+=o}i.items[i.items.length-1].raw=o.trimEnd(),i.items[i.items.length-1].text=l.trimEnd(),i.raw=i.raw.trimEnd();for(let h=0;h<i.items.length;h++)if(this.lexer.state.top=!1,i.items[h].tokens=this.lexer.blockTokens(i.items[h].text,[]),!i.loose){const m=i.items[h].tokens.filter(f=>f.type==="space"),p=m.length>0&&m.some(f=>/\n.*\n/.test(f.raw));i.loose=p}if(i.loose)for(let h=0;h<i.items.length;h++)i.items[h].loose=!0;return i}}html(n){const e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){const e=this.rules.block.def.exec(n);if(e){const t=e[1].toLowerCase().replace(/\s+/g," "),s=e[2]?e[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",i=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:s,title:i}}}table(n){const e=this.rules.block.table.exec(n);if(!e||!/[:|]/.test(e[2]))return;const t=Pe(e[1]),s=e[2].replace(/^\||\| *$/g,"").split("|"),i=e[3]&&e[3].trim()?e[3].replace(/\n[ \t]*$/,"").split(`
`):[],a={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===s.length){for(const o of s)/^ *-+: *$/.test(o)?a.align.push("right"):/^ *:-+: *$/.test(o)?a.align.push("center"):/^ *:-+ *$/.test(o)?a.align.push("left"):a.align.push(null);for(const o of t)a.header.push({text:o,tokens:this.lexer.inline(o)});for(const o of i)a.rows.push(Pe(o,a.header.length).map(l=>({text:l,tokens:this.lexer.inline(l)})));return a}}lheading(n){const e=this.rules.block.lheading.exec(n);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(n){const e=this.rules.block.paragraph.exec(n);if(e){const t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(n){const e=this.rules.block.text.exec(n);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(n){const e=this.rules.inline.escape.exec(n);if(e)return{type:"escape",raw:e[0],text:F(e[1])}}tag(n){const e=this.rules.inline.tag.exec(n);if(e)return!this.lexer.state.inLink&&/^<a /i.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(n){const e=this.rules.inline.link.exec(n);if(e){const t=e[2].trim();if(!this.options.pedantic&&/^</.test(t)){if(!/>$/.test(t))return;const a=oe(t.slice(0,-1),"\\");if((t.length-a.length)%2===0)return}else{const a=Dt(e[2],"()");if(a>-1){const l=(e[0].indexOf("!")===0?5:4)+e[1].length+a;e[2]=e[2].substring(0,a),e[0]=e[0].substring(0,l).trim(),e[3]=""}}let s=e[2],i="";if(this.options.pedantic){const a=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(s);a&&(s=a[1],i=a[3])}else i=e[3]?e[3].slice(1,-1):"";return s=s.trim(),/^</.test(s)&&(this.options.pedantic&&!/>$/.test(t)?s=s.slice(1):s=s.slice(1,-1)),Ve(e,{href:s&&s.replace(this.rules.inline.anyPunctuation,"$1"),title:i&&i.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer)}}reflink(n,e){let t;if((t=this.rules.inline.reflink.exec(n))||(t=this.rules.inline.nolink.exec(n))){const s=(t[2]||t[1]).replace(/\s+/g," "),i=e[s.toLowerCase()];if(!i){const a=t[0].charAt(0);return{type:"text",raw:a,text:a}}return Ve(t,i,t[0],this.lexer)}}emStrong(n,e,t=""){let s=this.rules.inline.emStrongLDelim.exec(n);if(!s||s[3]&&t.match(/[\p{L}\p{N}]/u))return;if(!(s[1]||s[2]||"")||!t||this.rules.inline.punctuation.exec(t)){const a=[...s[0]].length-1;let o,l,u=a,h=0;const m=s[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(m.lastIndex=0,e=e.slice(-1*n.length+a);(s=m.exec(e))!=null;){if(o=s[1]||s[2]||s[3]||s[4]||s[5]||s[6],!o)continue;if(l=[...o].length,s[3]||s[4]){u+=l;continue}else if((s[5]||s[6])&&a%3&&!((a+l)%3)){h+=l;continue}if(u-=l,u>0)continue;l=Math.min(l,l+u+h);const p=[...s[0]][0].length,f=n.slice(0,a+s.index+p+l);if(Math.min(a,l)%2){const $=f.slice(1,-1);return{type:"em",raw:f,text:$,tokens:this.lexer.inlineTokens($)}}const d=f.slice(2,-2);return{type:"strong",raw:f,text:d,tokens:this.lexer.inlineTokens(d)}}}}codespan(n){const e=this.rules.inline.code.exec(n);if(e){let t=e[2].replace(/\n/g," ");const s=/[^ ]/.test(t),i=/^ /.test(t)&&/ $/.test(t);return s&&i&&(t=t.substring(1,t.length-1)),t=F(t,!0),{type:"codespan",raw:e[0],text:t}}}br(n){const e=this.rules.inline.br.exec(n);if(e)return{type:"br",raw:e[0]}}del(n){const e=this.rules.inline.del.exec(n);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(n){const e=this.rules.inline.autolink.exec(n);if(e){let t,s;return e[2]==="@"?(t=F(e[1]),s="mailto:"+t):(t=F(e[1]),s=t),{type:"link",raw:e[0],text:t,href:s,tokens:[{type:"text",raw:t,text:t}]}}}url(n){var t;let e;if(e=this.rules.inline.url.exec(n)){let s,i;if(e[2]==="@")s=F(e[0]),i="mailto:"+s;else{let a;do a=e[0],e[0]=((t=this.rules.inline._backpedal.exec(e[0]))==null?void 0:t[0])??"";while(a!==e[0]);s=F(e[0]),e[1]==="www."?i="http://"+e[0]:i=e[0]}return{type:"link",raw:e[0],text:s,href:i,tokens:[{type:"text",raw:s,text:s}]}}}inlineText(n){const e=this.rules.inline.text.exec(n);if(e){let t;return this.lexer.state.inRawBlock?t=e[0]:t=F(e[0]),{type:"text",raw:e[0],text:t}}}}const Gt=/^(?: *(?:\n|$))+/,Yt=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Zt=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ie=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Xt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,et=/(?:[*+-]|\d{1,9}[.)])/,tt=_(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,et).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),qe=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Qt=/^[^\n]+/,je=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Kt=_(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",je).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ut=_(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,et).getRegex(),ge="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ae=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Jt=_("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",Ae).replace("tag",ge).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),nt=_(qe).replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex(),en=_(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",nt).getRegex(),Te={blockquote:en,code:Yt,def:Kt,fences:Zt,heading:Xt,hr:ie,html:Jt,lheading:tt,list:Ut,newline:Gt,paragraph:nt,table:ee,text:Qt},He=_("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex(),tn={...Te,table:He,paragraph:_(qe).replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",He).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex()},nn={...Te,html:_(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ae).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ee,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:_(qe).replace("hr",ie).replace("heading",` *#{1,6} *[^
]`).replace("lheading",tt).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},it=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,an=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,at=/^( {2,}|\\)\n(?!\s*$)/,sn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ae="\\p{P}\\p{S}",rn=_(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,ae).getRegex(),on=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,ln=_(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,ae).getRegex(),hn=_("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,ae).getRegex(),cn=_("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,ae).getRegex(),un=_(/\\([punct])/,"gu").replace(/punct/g,ae).getRegex(),mn=_(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),pn=_(Ae).replace("(?:-->|$)","-->").getRegex(),dn=_("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",pn).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ue=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,fn=_(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",ue).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),st=_(/^!?\[(label)\]\[(ref)\]/).replace("label",ue).replace("ref",je).getRegex(),rt=_(/^!?\[(ref)\](?:\[\])?/).replace("ref",je).getRegex(),$n=_("reflink|nolink(?!\\()","g").replace("reflink",st).replace("nolink",rt).getRegex(),Fe={_backpedal:ee,anyPunctuation:un,autolink:mn,blockSkip:on,br:at,code:an,del:ee,emStrongLDelim:ln,emStrongRDelimAst:hn,emStrongRDelimUnd:cn,escape:it,link:fn,nolink:rt,punctuation:rn,reflink:st,reflinkSearch:$n,tag:dn,text:sn,url:ee},gn={...Fe,link:_(/^!?\[(label)\]\((.*?)\)/).replace("label",ue).getRegex(),reflink:_(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ue).getRegex()},_e={...Fe,escape:_(it).replace("])","~|])").getRegex(),url:_(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},xn={..._e,br:_(at).replace("{2,}","*").getRegex(),text:_(_e.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},le={normal:Te,gfm:tn,pedantic:nn},U={normal:Fe,gfm:_e,breaks:xn,pedantic:gn};class N{constructor(n){k(this,"tokens");k(this,"options");k(this,"state");k(this,"tokenizer");k(this,"inlineQueue");this.tokens=[],this.tokens.links=Object.create(null),this.options=n||Y,this.options.tokenizer=this.options.tokenizer||new ce,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const e={block:le.normal,inline:U.normal};this.options.pedantic?(e.block=le.pedantic,e.inline=U.pedantic):this.options.gfm&&(e.block=le.gfm,this.options.breaks?e.inline=U.breaks:e.inline=U.gfm),this.tokenizer.rules=e}static get rules(){return{block:le,inline:U}}static lex(n,e){return new N(e).lex(n)}static lexInline(n,e){return new N(e).inlineTokens(n)}lex(n){n=n.replace(/\r\n|\r/g,`
`),this.blockTokens(n,this.tokens);for(let e=0;e<this.inlineQueue.length;e++){const t=this.inlineQueue[e];this.inlineTokens(t.src,t.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(n,e=[]){this.options.pedantic?n=n.replace(/\t/g,"    ").replace(/^ +$/gm,""):n=n.replace(/^( *)(\t+)/gm,(o,l,u)=>l+"    ".repeat(u.length));let t,s,i,a;for(;n;)if(!(this.options.extensions&&this.options.extensions.block&&this.options.extensions.block.some(o=>(t=o.call({lexer:this},n,e))?(n=n.substring(t.raw.length),e.push(t),!0):!1))){if(t=this.tokenizer.space(n)){n=n.substring(t.raw.length),t.raw.length===1&&e.length>0?e[e.length-1].raw+=`
...
`+t.raw,s.text+=`
`+t.raw,this.inlineQueue[this.inlineQueue.length-1].src=s.text):this.tokens.links[t.tag]||(this.tokens.links[t.tag]={href:t.href,title:t.title});continue}if(t=this.tokenizer.table(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.lheading(n)){n=n.substring(t.raw.length),e.push(t);continue}if(i=n,this.options.extensions&&this.options.extensions.startBlock){let o=1/0;const l=n.slice(1);let u;this.options.extensions.startBlock.forEach(h=>{u=h.call({lexer:this},l),typeof u=="number"&&u>=0&&(o=Math.min(o,u))}),o<1/0&&o>=0&&(i=n.substring(0,o+1))}if(this.state.top&&(t=this.tokenizer.paragraph(i))){s=e[e.length-1],a&&s.type==="paragraph"?(s.raw+=`
`+t.raw,s.text+=`
...
`+t.raw,s.text+=`
`+t.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=s.text):e.push(t);continue}if(n){const o="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,e}inline(n,e=[]){return this.inlineQueue.push({src:n,tokens:e}),e}inlineTokens(n,e=[]){let t,s,i,a=n,o,l,u;if(this.tokens.links){const h=Object.keys(this.tokens.links);if(h.length>0)for(;(o=this.tokenizer.rules.inline.reflinkSearch.exec(a))!=null;)h.includes(o[0].slice(o[0].lastIndexOf("[")+1,-1))&&(a=a.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(o=this.tokenizer.rules.inline.blockSkip.exec(a))!=null;)a=a.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(o=this.tokenizer.rules.inline.anyPunctuation.exec(a))!=null;)a=a.slice(0,o.index)+"++"+a.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;n;)if(l||(u=""),l=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(h=>(t=h.call({lexer:this},n,e))?(n=n.substring(t.raw.length),e.push(t),!0):!1))){if(t=this.tokenizer.escape(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.tag(n)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.link(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.reflink(n,this.tokens.links)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.emStrong(n,a,u)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.codespan(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.br(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.del(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.autolink(n)){n=n.substring(t.raw.length),e.push(t);continue}if(!this.state.inLink&&(t=this.tokenizer.url(n))){n=n.substring(t.raw.length),e.push(t);continue}if(i=n,this.options.extensions&&this.options.extensions.startInline){let h=1/0;const m=n.slice(1);let p;this.options.extensions.startInline.forEach(f=>{p=f.call({lexer:this},m),typeof p=="number"&&p>=0&&(h=Math.min(h,p))}),h<1/0&&h>=0&&(i=n.substring(0,h+1))}if(t=this.tokenizer.inlineText(i)){n=n.substring(t.raw.length),t.raw.slice(-1)!=="_"&&(u=t.raw.slice(-1)),l=!0,s=e[e.length-1],s&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(n){const h="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return e}}class me{constructor(n){k(this,"options");this.options=n||Y}code(n,e,t){var i;const s=(i=(e||"").match(/^\S*/))==null?void 0:i[0];return n=n.replace(/\n$/,"")+`
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return"<br>"}del(n){return`<del>${n}</del>`}link(n,e,t){const s=We(n);if(s===null)return t;n=s;let i='<a href="'+n+'"';return e&&(i+=' title="'+e+'"'),i+=">"+t+"</a>",i}image(n,e,t){const s=We(n);if(s===null)return t;n=s;let i=`<img src="${n}" alt="${t}"`;return e&&(i+=` title="${e}"`),i+=">",i}text(n){return n}}class Ee{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,e,t){return""+t}image(n,e,t){return""+t}br(){return""}}class R{constructor(n){k(this,"options");k(this,"renderer");k(this,"textRenderer");this.options=n||Y,this.options.renderer=this.options.renderer||new me,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Ee}static parse(n,e){return new R(e).parse(n)}static parseInline(n,e){return new R(e).parseInline(n)}parse(n,e=!0){let t="";for(let s=0;s<n.length;s++){const i=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){const a=i,o=this.options.extensions.renderers[a.type].call({parser:this},a);if(o!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(a.type)){t+=o||"";continue}}switch(i.type){case"space":continue;case"hr":{t+=this.renderer.hr();continue}case"heading":{const a=i;t+=this.renderer.heading(this.parseInline(a.tokens),a.depth,Vt(this.parseInline(a.tokens,this.textRenderer)));continue}case"code":{const a=i;t+=this.renderer.code(a.text,a.lang,!!a.escaped);continue}case"table":{const a=i;let o="",l="";for(let h=0;h<a.header.length;h++)l+=this.renderer.tablecell(this.parseInline(a.header[h].tokens),{header:!0,align:a.align[h]});o+=this.renderer.tablerow(l);let u="";for(let h=0;h<a.rows.length;h++){const m=a.rows[h];l="";for(let p=0;p<m.length;p++)l+=this.renderer.tablecell(this.parseInline(m[p].tokens),{header:!1,align:a.align[p]});u+=this.renderer.tablerow(l)}t+=this.renderer.table(o,u);continue}case"blockquote":{const a=i,o=this.parse(a.tokens);t+=this.renderer.blockquote(o);continue}case"list":{const a=i,o=a.ordered,l=a.start,u=a.loose;let h="";for(let m=0;m<a.items.length;m++){const p=a.items[m],f=p.checked,d=p.task;let $="";if(p.task){const g=this.renderer.checkbox(!!f);u?p.tokens.length>0&&p.tokens[0].type==="paragraph"?(p.tokens[0].text=g+" "+p.tokens[0].text,p.tokens[0].tokens&&p.tokens[0].tokens.length>0&&p.tokens[0].tokens[0].type==="text"&&(p.tokens[0].tokens[0].text=g+" "+p.tokens[0].tokens[0].text)):p.tokens.unshift({type:"text",text:g+" "}):$+=g+" "}$+=this.parse(p.tokens,u),h+=this.renderer.listitem($,d,!!f)}t+=this.renderer.list(h,o,l);continue}case"html":{const a=i;t+=this.renderer.html(a.text,a.block);continue}case"paragraph":{const a=i;t+=this.renderer.paragraph(this.parseInline(a.tokens));continue}case"text":{let a=i,o=a.tokens?this.parseInline(a.tokens):a.text;for(;s+1<n.length&&n[s+1].type==="text";)a=n[++s],o+=`
`+(a.tokens?this.parseInline(a.tokens):a.text);t+=e?this.renderer.paragraph(o):o;continue}default:{const a='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return t}parseInline(n,e){e=e||this.renderer;let t="";for(let s=0;s<n.length;s++){const i=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]){const a=this.options.extensions.renderers[i.type].call({parser:this},i);if(a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type)){t+=a||"";continue}}switch(i.type){case"escape":{const a=i;t+=e.text(a.text);break}case"html":{const a=i;t+=e.html(a.text);break}case"link":{const a=i;t+=e.link(a.href,a.title,this.parseInline(a.tokens,e));break}case"image":{const a=i;t+=e.image(a.href,a.title,a.text);break}case"strong":{const a=i;t+=e.strong(this.parseInline(a.tokens,e));break}case"em":{const a=i;t+=e.em(this.parseInline(a.tokens,e));break}case"codespan":{const a=i;t+=e.codespan(a.text);break}case"br":{t+=e.br();break}case"del":{const a=i;t+=e.del(this.parseInline(a.tokens,e));break}case"text":{const a=i;t+=e.text(a.text);break}default:{const a='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}}return t}}class te{constructor(n){k(this,"options");this.options=n||Y}preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}}k(te,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var G,ke,ot;class bn{constructor(...n){Ne(this,G);k(this,"defaults",we());k(this,"options",this.setOptions);k(this,"parse",re(this,G,ke).call(this,N.lex,R.parse));k(this,"parseInline",re(this,G,ke).call(this,N.lexInline,R.parseInline));k(this,"Parser",R);k(this,"Renderer",me);k(this,"TextRenderer",Ee);k(this,"Lexer",N);k(this,"Tokenizer",ce);k(this,"Hooks",te);this.use(...n)}walkTokens(n,e){var s,i;let t=[];for(const a of n)switch(t=t.concat(e.call(this,a)),a.type){case"table":{const o=a;for(const l of o.header)t=t.concat(this.walkTokens(l.tokens,e));for(const l of o.rows)for(const u of l)t=t.concat(this.walkTokens(u.tokens,e));break}case"list":{const o=a;t=t.concat(this.walkTokens(o.items,e));break}default:{const o=a;(i=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&i[o.type]?this.defaults.extensions.childTokens[o.type].forEach(l=>{const u=o[l].flat(1/0);t=t.concat(this.walkTokens(u,e))}):o.tokens&&(t=t.concat(this.walkTokens(o.tokens,e)))}}return t}use(...n){const e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach(t=>{const s={...t};if(s.async=this.defaults.async||s.async||!1,t.extensions&&(t.extensions.forEach(i=>{if(!i.name)throw new Error("extension name required");if("renderer"in i){const a=e.renderers[i.name];a?e.renderers[i.name]=function(...o){let l=i.renderer.apply(this,o);return l===!1&&(l=a.apply(this,o)),l}:e.renderers[i.name]=i.renderer}if("tokenizer"in i){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const a=e[i.level];a?a.unshift(i.tokenizer):e[i.level]=[i.tokenizer],i.start&&(i.level==="block"?e.startBlock?e.startBlock.push(i.start):e.startBlock=[i.start]:i.level==="inline"&&(e.startInline?e.startInline.push(i.start):e.startInline=[i.start]))}"childTokens"in i&&i.childTokens&&(e.childTokens[i.name]=i.childTokens)}),s.extensions=e),t.renderer){const i=this.defaults.renderer||new me(this.defaults);for(const a in t.renderer){if(!(a in i))throw new Error(`renderer '${a}' does not exist`);if(a==="options")continue;const o=a,l=t.renderer[o],u=i[o];i[o]=(...h)=>{let m=l.apply(i,h);return m===!1&&(m=u.apply(i,h)),m||""}}s.renderer=i}if(t.tokenizer){const i=this.defaults.tokenizer||new ce(this.defaults);for(const a in t.tokenizer){if(!(a in i))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;const o=a,l=t.tokenizer[o],u=i[o];i[o]=(...h)=>{let m=l.apply(i,h);return m===!1&&(m=u.apply(i,h)),m}}s.tokenizer=i}if(t.hooks){const i=this.defaults.hooks||new te;for(const a in t.hooks){if(!(a in i))throw new Error(`hook '${a}' does not exist`);if(a==="options")continue;const o=a,l=t.hooks[o],u=i[o];te.passThroughHooks.has(a)?i[o]=h=>{if(this.defaults.async)return Promise.resolve(l.call(i,h)).then(p=>u.call(i,p));const m=l.call(i,h);return u.call(i,m)}:i[o]=(...h)=>{let m=l.apply(i,h);return m===!1&&(m=u.apply(i,h)),m}}s.hooks=i}if(t.walkTokens){const i=this.defaults.walkTokens,a=t.walkTokens;s.walkTokens=function(o){let l=[];return l.push(a.call(this,o)),i&&(l=l.concat(i.call(this,o))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return N.lex(n,e??this.defaults)}parser(n,e){return R.parse(n,e??this.defaults)}}G=new WeakSet,ke=function(n,e){return(t,s)=>{const i={...s},a={...this.defaults,...i};this.defaults.async===!0&&i.async===!1&&(a.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),a.async=!0);const o=re(this,G,ot).call(this,!!a.silent,!!a.async);if(typeof t>"u"||t===null)return o(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return o(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(a.hooks&&(a.hooks.options=a),a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(t):t).then(l=>n(l,a)).then(l=>a.hooks?a.hooks.processAllTokens(l):l).then(l=>a.walkTokens?Promise.all(this.walkTokens(l,a.walkTokens)).then(()=>l):l).then(l=>e(l,a)).then(l=>a.hooks?a.hooks.postprocess(l):l).catch(o);try{a.hooks&&(t=a.hooks.preprocess(t));let l=n(t,a);a.hooks&&(l=a.hooks.processAllTokens(l)),a.walkTokens&&this.walkTokens(l,a.walkTokens);let u=e(l,a);return a.hooks&&(u=a.hooks.postprocess(u)),u}catch(l){return o(l)}}},ot=function(n,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){const s="<p>An error occurred:</p><pre>"+F(t.message+"",!0)+"</pre>";return e?Promise.resolve(s):s}if(e)return Promise.reject(t);throw t}};const O=new bn;function b(r,n){return O.parse(r,n)}b.options=b.setOptions=function(r){return O.setOptions(r),b.defaults=O.defaults,Ke(b.defaults),b};b.getDefaults=we;b.defaults=Y;b.use=function(...r){return O.use(...r),b.defaults=O.defaults,Ke(b.defaults),b};b.walkTokens=function(r,n){return O.walkTokens(r,n)};b.parseInline=O.parseInline;b.Parser=R;b.parser=R.parse;b.Renderer=me;b.TextRenderer=Ee;b.Lexer=N;b.lexer=N.lex;b.Tokenizer=ce;b.Hooks=te;b.parse=b;b.options;b.setOptions;b.use;b.walkTokens;b.parseInline;R.parse;N.lex;const yn={delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1};function Se(r){r&&Rt(r,yn)}b.setOptions({breaks:!0,gfm:!0});function Ie(r,n){const e=()=>n.forEach(s=>{if(s&&s.offsetParent!==null)try{ne.Plots.resize(s)}catch{}});requestAnimationFrame(e),setTimeout(e,60);let t;return typeof ResizeObserver<"u"&&(t=new ResizeObserver(e),t.observe(r)),()=>{t&&t.disconnect()}}function pe(r={}){const n=J("--fg")||"#1a1a2e",e=J("--grid")||"#d8d8e0",t=J("--surface")||"#ffffff";return{paper_bgcolor:t,plot_bgcolor:t,font:{color:n,family:"system-ui, sans-serif"},margin:{l:44,r:16,t:28,b:40},xaxis:{gridcolor:e,zerolinecolor:e},yaxis:{gridcolor:e,zerolinecolor:e},showlegend:!0,legend:{orientation:"h",y:1.12,x:0},...r}}const de=()=>J("--accent")||"#e63946",fe=()=>J("--point")||"#3a6ea5",$e={displayModeBar:!1,responsive:!0},he={xs:[-1,1,2.5,3,4,4.5,6],ys:[0,1.2,1.9,2.5,3.1,3.2,4.5]};function _n(r){let n=[...he.xs],e=[...he.ys],t=!1,s=.5,i=.5;r.innerHTML=`
    <div class="demo">
    ...
    </div>`;const a=r.querySelector("[data-plot]"),o=r.querySelector("[data-readout]"),l=r.querySelector("[data-sliders]");function u(d,$){const g=($-d)*.1||1;return[d-g,$+g]}function h(){const{a:d,b:$}=X(n,e),[g,x]=u(Math.min(...n),Math.max(...n)),v=[{x:n,y:e,mode:"markers",type:"scatter",name:y({hu:"adatok",en:"data"}),marker:{size:11,color:fe()}},{x:[g,x],y:[d*g+$,d*x+$],mode:"lines",name:y(q.demoBestFit),line:{color:de(),width:3}}];t&&v.push({x:[g,x],y:[s*g+i,s*x+i],mode:"lines",name:y(q.demoGuess),line:{color:"#f4a261",width:2,dash:"dash"}}),ne.react(a,v,pe({xaxis:{range:[g,x]}}),$e);const z=D(A=>d*A+$,n,e);let w=`<div class="ro-row">$\\bar a = ${d.toFixed(6)},\\quad \\bar b = ${$.toFixed(6)}$</div>`;if(w+=`<div class="ro-row"><span class="ro-label">${y(q.optimalError)}:</span> $F = ${z.toFixed(6)}$</div>`,t){const A=D(E=>s*E+i,n,e),B=A>0?z/A:1,C=B>.98?"★★★":B>.85?"★★☆":B>.6?"★☆☆":"☆☆☆";w+=`<div class="ro-row"><span class="ro-label">${y(q.yourError)}:</span> $F = ${A.toFixed(6)}$ <span class="ro-stars">${C}</span></div>`}o.innerHTML=w,Se(o)}function m(){const d=a.querySelector(".nsewdrag");if(!d)return;let $=-1;const g=x=>{const v=d.getBoundingClientRect(),z=a._fullLayout.xaxis,w=a._fullLayout.yaxis;return{x:z.p2d(x.clientX-v.left),y:w.p2d(x.clientY-v.top)}};d.addEventListener("mousedown",x=>{const v=g(x),z=a._fullLayout.xaxis,w=a._fullLayout.yaxis,A=z.range[1]-z.range[0],B=w.range[1]-w.range[0];let C=-1,E=1/0;for(let P=0;P<n.length;P++){const se=(n[P]-v.x)/A,Q=(e[P]-v.y)/B,K=se*se+Q*Q;K<E&&(E=K,C=P)}C>=0&&E<.0025&&($=C,x.preventDefault())}),window.addEventListener("mousemove",x=>{$<0||(e[$]=g(x).y,h())}),window.addEventListener("mouseup",()=>{$=-1})}r.querySelector('[data-act="best"]').addEventListener("click",()=>{t=!1,l.hidden=!0,r.querySelector('[data-act="guess"]').setAttribute("aria-pressed","false"),h()}),r.querySelector('[data-act="guess"]').addEventListener("click",d=>{t=!t,l.hidden=!t,d.currentTarget.setAttribute("aria-pressed",String(t)),h()}),r.querySelector('[data-act="add"]').addEventListener("click",()=>{const d=X(n,e),$=Math.max(...n)+1;n.push($),e.push(d.a*$+d.b),h(),setTimeout(m,60)}),r.querySelector('[data-act="reset"]').addEventListener("click",()=>{n=[...he.xs],e=[...he.ys],h(),setTimeout(m,60)}),r.querySelectorAll("[data-slider]").forEach(d=>{d.value=d.dataset.slider==="a"?s:i,d.addEventListener("input",()=>{d.dataset.slider==="a"?s=parseFloat(d.value):i=parseFloat(d.value),r.querySelector("[data-ga]").textContent=s.toFixed(2),r.querySelector("[data-gb]").textContent=i.toFixed(2),h()})}),r.querySelector("[data-ga]").textContent=s.toFixed(2),r.querySelector("[data-gb]").textContent=i.toFixed(2),h(),setTimeout(m,80);const p=ve(()=>h()),f=Ie(r,[a]);return()=>{p(),f()}}const De={xs:[-1,0,.5,1,2,2.5,3],ys:[1.4,1.9,1.6,1.7,.2,-.1,-2]};function kn(r){let n=[...De.xs],e=[...De.ys],t=2;const s=Math.min(6,n.length-1);r.innerHTML=`
    <div class="demo">
      ...
      <div class="demo-plot" data-plot></div>
      <div class="demo-readout" data-readout></div>
    </div>`;const i=r.querySelector("[data-plot]"),a=r.querySelector("[data-readout]");r.querySelector("[data-deg]").textContent=t;function o(){const h=Tt(n,e,t),m=Math.min(...n)-.4,p=Math.max(...n)+.4,f=[],d=[],$=120;for(let z=0;z<=$;z++){const w=m+(p-m)*z/$;f.push(w),d.push(Be(h,w))}ne.react(i,[{x:n,y:e,mode:"markers",type:"scatter",name:y({hu:"adatok",en:"data"}),marker:{size:11,color:fe()}},{x:f,y:d,mode:"lines",name:`${y({hu:"fokszám",en:"degree"})} ${t}`,line:{color:de(),width:3}}],pe({xaxis:{range:[m,p]}}),$e);const g=D(z=>Be(h,z),n,e);let v=`<div class="ro-row">$p(x) = ${h.map((z,w)=>w===0?z.toFixed(4):`${z>=0?"+":""}${z.toFixed(4)}x^{${w}}`).join(" ")}$</div>`;v+=`<div class="ro-row"><span class="ro-label">${y(q.error)}:</span> $F = ${g.toFixed(6)}$</div>`,t>=n.length-1&&(v+=`<div class="ro-row ro-warn">${y({hu:"⚠ $m \\ge n$: interpoláció, a hiba ≈ 0.",en:"⚠ $m \\ge n$: interpolation, error ≈ 0."})}</div>`),a.innerHTML=v,Se(a)}r.querySelector('[data-slider="m"]').addEventListener("input",h=>{t=parseInt(h.target.value,10),r.querySelector("[data-deg]").textContent=t,o()}),o();const l=ve(()=>o()),u=Ie(r,[i]);return()=>{l(),u()}}const zn={exp:{xs:[0,1,1.5,2,3,4],ys:[.3,.7,.9,1.2,1.8,2.7]},power:{xs:[.5,1,1.5,2.5,3],ys:[.7,1.1,1.6,2.1,2.3]}};function vn(r){let n="exp";r.innerHTML=`
    <div class="demo">
      <div class="demo-controls">
...
`,Rn=`// Fit y ~ b*exp(a*t) by linear least squares on ln(y). Returns [a, b].
...
`,Yn=`// Least-squares polynomial fit via the normal equations.
...
`,hi=Object.assign({"./exponential.cpp":In,"./exponential.f90":Mn,"./exponential.go":Ln,"./exponential.jl":Nn,"./exponential.js":Rn,"./exponential.m":Bn,"./exponential.py":Cn,"./exponential.r":Wn,"./exponential.rs":Pn,"./exponential.wl":Vn,"./polynomial.cpp":Hn,"./polynomial.f90":Dn,"./polynomial.go":On,"./polynomial.jl":Gn,"./polynomial.js":Yn,"./polynomial.m":Zn,"./polynomial.py":Xn,"./polynomial.r":Qn,"./polynomial.rs":Kn,"./polynomial.wl":Un,"./power.cpp":Jn,"./power.f90":ei,"./power.go":ti,"./power.jl":ni,"./power.js":ii,"./power.m":ai,"./power.py":si,"./power.r":ri,"./power.rs":oi,"./power.wl":li}),I=(r,n)=>hi[`./${r}.${n}`],ci={polynomial:{en:"Least-squares polynomial fit",hu:"Legkisebb négyzetes polinomillesztés"},exponential:{en:"Exponential fit  y ≈ b·e^{a t}",hu:"Exponenciális illesztés  y ≈ b·e^{a t}"},power:{en:"Power-law fit  y ≈ b·t^a",hu:"Hatványfüggvény-illesztés  y ≈ b·t^a"}},ui=r=>({id:r,caption:ci[r],snippets:{matlab:I(r,"m"),python:I(r,"py"),cpp:I(r,"cpp"),julia:I(r,"jl"),rust:I(r,"rs"),fortran:I(r,"f90"),wolfram:I(r,"wl"),javascript:I(r,"js"),go:I(r,"go"),r:I(r,"r")}}),mi={polynomial:["polynomial"],nonlinear:["exponential","power"]};function pi(r){return(mi[r]??[]).map(ui)}function di({block:r}){const{t:n}=H();return c.jsxs("figure",{className:"data-table",children:[r.caption&&c.jsx("figcaption",{children:c.jsx(L,{text:n(r.caption)})}),c.jsxs("table",{children:[c.jsx("thead",{children:c.jsx("tr",{children:r.headers.map((e,t)=>c.jsx("th",{children:c.jsx(L,{text:e})},t))})}),c.jsxs("tbody",{children:[r.rows.map((e,t)=>c.jsx("tr",{children:e.map((s,i)=>c.jsx("td",{children:c.jsx(L,{text:s})},i))},t)),r.totals&&c.jsx("tr",{className:"totals",children:r.totals.map((e,t)=>c.jsx("td",{children:c.jsx(L,{text:e})},t))})]})]})]})}function fi({block:r}){const{t:n}=H();return c.jsxs("div",{className:"exercises",children:[c.jsx("h4",{children:n(r.label)}),c.jsx("p",{children:c.jsx(L,{text:n(r.intro)})}),c.jsx("div",{className:"exercise-grid",children:r.items.map((e,t)=>c.jsxs("div",{className:"exercise-card",children:[c.jsx("div",{className:"exercise-tag",children:c.jsx(L,{text:e.tag})}),c.jsx("table",{className:"mini",children:c.jsxs("tbody",{children:[c.jsxs("tr",{children:[c.jsx("th",{children:c.jsx(L,{text:e.headers[0]})}),e.cols.map(([s],i)=>c.jsx("td",{children:s},i))]}),c.jsxs("tr",{children:[c.jsx("th",{children:c.jsx(L,{text:e.headers[1]})}),e.cols.map(([,s],i)=>c.jsx("td",{children:s},i))]})]})})]},t))})]})}function $i({block:r,sectionId:n}){const{t:e}=H();switch(r.type){case"text":return c.jsx("div",{className:"prose",children:c.jsx(V,{markdown:e(r)})});case"math":return c.jsx("div",{className:"math-display",children:c.jsx(V,{markdown:`$$
${r.tex}
$$`})});case"callout":return c.jsx("div",{className:`callout ${r.variant||"note"}`,children:c.jsx(V,{markdown:e(r)})});case"theorem":case"example":return c.jsxs("div",{className:`box ${r.type}`,children:[c.jsx("div",{className:"box-label",children:e(r.label)}),c.jsx("div",{className:"box-body",children:c.jsx(V,{markdown:e(r)})})]});case"table":return c.jsx(di,{block:r});case"exercises":return c.jsx(fi,{block:r});case"demo":return c.jsx(wn,{component:r.component,caption:r.caption?e(r.caption):void 0});case"quiz":return c.jsx(jn,{refKey:r.ref,sectionId:n});case"glossary":return c.jsx(Fn,{deck:r.deck});case"flashcards":return c.jsx(Sn,{deck:r.deck});default:return null}}function gi({section:r}){const{t:n}=H();return c.jsxs("article",{className:"section",id:`sec-${r.id}`,children:[c.jsxs("h2",{className:"section-title",children:[n(r.title),qt(r.id)&&c.jsx("span",{className:"done-badge",children:"✓"})]}),r.blocks.map((e,t)=>c.jsx($i,{block:e,sectionId:r.id},t)),pi(r.id).map(e=>c.jsx(dt,{snippets:e.snippets,caption:e.caption},e.id))]})}const lt=Ye,xi={intro:"9",line:"9.1",polynomial:"9.2",nonlinear:"9.3"},bi=lt.map(r=>({id:`sec-${r.id}`,no:xi[r.id]??"9",title:r.title,blurb:{en:"",hu:""}}));function ji(){const{lang:r}=H(),{theme:n}=mt(),e=pt();return T.useEffect(()=>{gt(r)},[r]),T.useEffect(()=>{bt(n)},[n]),T.useEffect(()=>{const t=decodeURIComponent(e.hash.replace(/^#/,""));t&&requestAnimationFrame(()=>{var s;return(s=document.getElementById(t))==null?void 0:s.scrollIntoView()})},[e.hash]),c.jsxs("div",{className:"ch-least-squares",children:[c.jsx(ft,{sections:bi}),c.jsx("main",{className:"content content--full",children:lt.map(t=>c.jsx(gi,{section:t},t.id))})]})}export{ji as default};
