import{r as k,j as l,f as nn,L as Re,e as tn,d as an}from"./index-B2apuq-N.js";import{M as rn,r as on,e as sn,d as ln,C as fn,k as hn,S as dn,b as cn}from"./SolutionsBlock-FTey4X2b.js";import{m as J,A as xn}from"./proxy-Cyza2ANK.js";import{c as $n,a as un}from"./create-omUZVxIu.js";import{m as _e}from"./linear-Dm4wCrSs.js";import"./bitOr.transform-CWwyI5t6.js";import"./fraction-DqatKmli.js";const pn=(a,e,n,t)=>{var r,s,o,h;const i=[n,{code:e,...t||{}}];if((s=(r=a==null?void 0:a.services)==null?void 0:r.logger)!=null&&s.forward)return a.services.logger.forward(i,"warn","react-i18next::",!0);G(i[0])&&(i[0]=`react-i18next:: ${i[0]}`),(h=(o=a==null?void 0:a.services)==null?void 0:o.logger)!=null&&h.warn?a.services.logger.warn(...i):console!=null&&console.warn&&console.warn(...i)},be={},he=(a,e,n,t)=>{G(n)&&be[n]||(G(n)&&(be[n]=new Date),pn(a,e,n,t))},Ke=(a,e)=>()=>{if(a.isInitialized)e();else{const n=()=>{setTimeout(()=>{a.off("initialized",n)},0),e()};a.on("initialized",n)}},de=(a,e,n)=>{a.loadNamespaces(e,Ke(a,n))},ke=(a,e,n,t)=>{if(G(n)&&(n=[n]),a.options.preload&&a.options.preload.indexOf(e)>-1)return de(a,n,t);n.forEach(i=>{a.options.ns.indexOf(i)<0&&a.options.ns.push(i)}),a.loadLanguages(e,Ke(a,t))},mn=(a,e,n={})=>!e.languages||!e.languages.length?(he(e,"NO_LANGUAGES","i18n.languages were undefined or empty",{languages:e.languages}),!0):e.hasLoadedNamespace(a,{lng:n.lng,precheck:(t,i)=>{if(n.bindI18n&&n.bindI18n.indexOf("languageChanging")>-1&&t.services.backendConnector.backend&&t.isLanguageChangingTo&&!i(t.isLanguageChangingTo,a))return!1}}),G=a=>typeof a=="string",gn=a=>typeof a=="object"&&a!==null,_n=/&(?:amp|#38|lt|#60|gt|#62|apos|#39|quot|#34|nbsp|#160|copy|#169|reg|#174|hellip|#8230|#x2F|#47);/g,bn={"&amp;":"&","&#38;":"&","&lt;":"<","&#60;":"<","&gt;":">","&#62;":">","&apos;":"'","&#39;":"'","&quot;":'"',"&#34;":'"',"&nbsp;":" ","&#160;":" ","&copy;":"©","&#169;":"©","&reg;":"®","&#174;":"®","&hellip;":"…","&#8230;":"…","&#x2F;":"/","&#47;":"/"},kn=a=>bn[a],yn=a=>a.replace(_n,kn);let ce={bindI18n:"languageChanged",bindI18nStore:"",transEmptyNodeValue:"",transSupportBasicHtmlNodes:!0,transWrapTextNodes:"",transKeepBasicHtmlNodesFor:["br","strong","i","p"],useSuspense:!0,unescape:yn};const vn=(a={})=>{ce={...ce,...a}},zn=()=>ce;let Fe;const wn=a=>{Fe=a},qn=()=>Fe,jn={type:"3rdParty",init(a){vn(a.options.react),wn(a)}},Nn=k.createContext();class Sn{constructor(){this.usedNamespaces={}}addUsedNamespaces(e){e.forEach(n=>{this.usedNamespaces[n]||(this.usedNamespaces[n]=!0)})}getUsedNamespaces(){return Object.keys(this.usedNamespaces)}}const Tn=(a,e)=>{const n=k.useRef();return k.useEffect(()=>{n.current=a},[a,e]),n.current},Ie=(a,e,n,t)=>a.getFixedT(e,n,t),Cn=(a,e,n,t)=>k.useCallback(Ie(a,e,n,t),[a,e,n,t]),A=(a,e={})=>{var g,q,j,N;const{i18n:n}=e,{i18n:t,defaultNS:i}=k.useContext(Nn)||{},r=n||t||qn();if(r&&!r.reportNamespaces&&(r.reportNamespaces=new Sn),!r){he(r,"NO_I18NEXT_INSTANCE","useTranslation: You will need to pass in an i18next instance by using initReactI18next");const S=(T,_)=>G(_)?_:gn(_)&&G(_.defaultValue)?_.defaultValue:Array.isArray(T)?T[T.length-1]:T,C=[S,{},!1];return C.t=S,C.i18n={},C.ready=!1,C}(g=r.options.react)!=null&&g.wait&&he(r,"DEPRECATED_OPTION","useTranslation: It seems you are still using the old wait option, you may migrate to the new useSuspense behaviour.");const s={...zn(),...r.options.react,...e},{useSuspense:o,keyPrefix:h}=s;let f=i||((q=r.options)==null?void 0:q.defaultNS);f=G(f)?[f]:f||["translation"],(N=(j=r.reportNamespaces).addUsedNamespaces)==null||N.call(j,f);const c=(r.isInitialized||r.initializedStoreOnce)&&f.every(S=>mn(S,r,s)),x=Cn(r,e.lng||null,s.nsMode==="fallback"?f:f[0],h),d=()=>x,$=()=>Ie(r,e.lng||null,s.nsMode==="fallback"?f:f[0],h),[m,w]=k.useState(d);let p=f.join();e.lng&&(p=`${e.lng}${p}`);const u=Tn(p),z=k.useRef(!0);k.useEffect(()=>{const{bindI18n:S,bindI18nStore:C}=s;z.current=!0,!c&&!o&&(e.lng?ke(r,e.lng,f,()=>{z.current&&w($)}):de(r,f,()=>{z.current&&w($)})),c&&u&&u!==p&&z.current&&w($);const T=()=>{z.current&&w($)};return S&&(r==null||r.on(S,T)),C&&(r==null||r.store.on(C,T)),()=>{z.current=!1,r&&S&&(S==null||S.split(" ").forEach(_=>r.off(_,T))),C&&r&&C.split(" ").forEach(_=>r.store.off(_,T))}},[r,p]),k.useEffect(()=>{z.current&&c&&w(d)},[r,h,c]);const y=[m,r,c];if(y.t=m,y.i18n=r,y.ready=c,c||!c&&!o)return y;throw new Promise(S=>{e.lng?ke(r,e.lng,f,()=>S()):de(r,f,()=>S())})},b=a=>typeof a=="string",V=()=>{let a,e;const n=new Promise((t,i)=>{a=t,e=i});return n.resolve=a,n.reject=e,n},ye=a=>a==null?"":""+a,Ln=(a,e,n)=>{a.forEach(t=>{e[t]&&(n[t]=e[t])})},Pn=/###/g,ve=a=>a&&a.indexOf("###")>-1?a.replace(Pn,"."):a,ze=a=>!a||b(a),U=(a,e,n)=>{const t=b(e)?e.split("."):e;let i=0;for(;i<t.length-1;){if(ze(a))return{};const r=ve(t[i]);!a[r]&&n&&(a[r]=new n),Object.prototype.hasOwnProperty.call(a,r)?a=a[r]:a={},++i}return ze(a)?{}:{obj:a,k:ve(t[i])}},we=(a,e,n)=>{const{obj:t,k:i}=U(a,e,Object);if(t!==void 0||e.length===1){t[i]=n;return}let r=e[e.length-1],s=e.slice(0,e.length-1),o=U(a,s,Object);for(;o.obj===void 0&&s.length;)r=`${s[s.length-1]}.${r}`,s=s.slice(0,s.length-1),o=U(a,s,Object),o&&o.obj&&typeof o.obj[`${o.k}.${r}`]<"u"&&(o.obj=void 0);o.obj[`${o.k}.${r}`]=n},En=(a,e,n,t)=>{const{obj:i,k:r}=U(a,e,Object);i[r]=i[r]||[],i[r].push(n)},te=(a,e)=>{const{obj:n,k:t}=U(a,e);if(n)return n[t]},On=(a,e,n)=>{const t=te(a,n);return t!==void 0?t:te(e,n)},We=(a,e,n)=>{for(const t in e)t!=="__proto__"&&t!=="constructor"&&(t in a?b(a[t])||a[t]instanceof String||b(e[t])||e[t]instanceof String?n&&(a[t]=e[t]):We(a[t],e[t],n):a[t]=e[t]);return a},D=a=>a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&");var An={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};const Rn=a=>b(a)?a.replace(/[&<>"'\/]/g,e=>An[e]):a;class Kn{constructor(e){this.capacity=e,this.regExpMap=new Map,this.regExpQueue=[]}getRegExp(e){const n=this.regExpMap.get(e);if(n!==void 0)return n;const t=new RegExp(e);return this.regExpQueue.length===this.capacity&&this.regExpMap.delete(this.regExpQueue.shift()),this.regExpMap.set(e,t),this.regExpQueue.push(e),t}}const Fn=[" ",",","?","!",";"],In=new Kn(20),Wn=(a,e,n)=>{e=e||"",n=n||"";const t=Fn.filter(s=>e.indexOf(s)<0&&n.indexOf(s)<0);if(t.length===0)return!0;const i=In.getRegExp(`(${t.map(s=>s==="?"?"\\?":s).join("|")})`);let r=!i.test(a);if(!r){const s=a.indexOf(n);s>0&&!i.test(a.substring(0,s))&&(r=!0)}return r},xe=function(a,e){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:".";if(!a)return;if(a[e])return a[e];const t=e.split(n);let i=a;for(let r=0;r<t.length;){if(!i||typeof i!="object")return;let s,o="";for(let h=r;h<t.length;++h)if(h!==r&&(o+=n),o+=t[h],s=i[o],s!==void 0){if(["string","number","boolean"].indexOf(typeof s)>-1&&h<t.length-1)continue;r+=h-r+1;break}i=s}return i},ae=a=>a&&a.replace("_","-"),Mn={type:"logger",log(a){this.output("log",a)},warn(a){this.output("warn",a)},error(a){this.output("error",a)},output(a,e){console&&console[a]&&console[a].apply(console,e)}};class re{constructor(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};this.init(e,n)}init(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};this.prefix=n.prefix||"i18next:",this.logger=e||Mn,this.options=n,this.debug=n.debug}log(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return this.forward(n,"log","",!0)}warn(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return this.forward(n,"warn","",!0)}error(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return this.forward(n,"error","")}deprecate(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t];return this.forward(n,"warn","WARNING DEPRECATED: ",!0)}forward(e,n,t,i){return i&&!this.debug?null:(b(e[0])&&(e[0]=`${t}${this.prefix} ${e[0]}`),this.logger[n](e))}create(e){return new re(this.logger,{prefix:`${this.prefix}:${e}:`,...this.options})}clone(e){return e=e||this.options,e.prefix=e.prefix||this.prefix,new re(this.logger,e)}}var F=new re;class se{constructor(){this.observers={}}on(e,n){return e.split(" ").forEach(t=>{this.observers[t]||(this.observers[t]=new Map);const i=this.observers[t].get(n)||0;this.observers[t].set(n,i+1)}),this}off(e,n){if(this.observers[e]){if(!n){delete this.observers[e];return}this.observers[e].delete(n)}}emit(e){for(var n=arguments.length,t=new Array(n>1?n-1:0),i=1;i<n;i++)t[i-1]=arguments[i];this.observers[e]&&Array.from(this.observers[e].entries()).forEach(s=>{let[o,h]=s;for(let f=0;f<h;f++)o(...t)}),this.observers["*"]&&Array.from(this.observers["*"].entries()).forEach(s=>{let[o,h]=s;for(let f=0;f<h;f++)o.apply(o,[e,...t])})}}class qe extends se{constructor(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{ns:["translation"],defaultNS:"translation"};super(),this.data=e||{},this.options=n,this.options.keySeparator===void 0&&(this.options.keySeparator="."),this.options.ignoreJSONStructure===void 0&&(this.options.ignoreJSONStructure=!0)}addNamespaces(e){this.options.ns.indexOf(e)<0&&this.options.ns.push(e)}removeNamespaces(e){const n=this.options.ns.indexOf(e);n>-1&&this.options.ns.splice(n,1)}getResource(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:{};const r=i.keySeparator!==void 0?i.keySeparator:this.options.keySeparator,s=i.ignoreJSONStructure!==void 0?i.ignoreJSONStructure:this.options.ignoreJSONStructure;let o;e.indexOf(".")>-1?o=e.split("."):(o=[e,n],t&&(Array.isArray(t)?o.push(...t):b(t)&&r?o.push(...t.split(r)):o.push(t)));const h=te(this.data,o);return!h&&!n&&!t&&e.indexOf(".")>-1&&(e=o[0],n=o[1],t=o.slice(2).join(".")),h||!s||!b(t)?h:xe(this.data&&this.data[e]&&this.data[e][n],t,r)}addResource(e,n,t,i){let r=arguments.length>4&&arguments[4]!==void 0?arguments[4]:{silent:!1};const s=r.keySeparator!==void 0?r.keySeparator:this.options.keySeparator;let o=[e,n];t&&(o=o.concat(s?t.split(s):t)),e.indexOf(".")>-1&&(o=e.split("."),i=n,n=o[1]),this.addNamespaces(n),we(this.data,o,i),r.silent||this.emit("added",e,n,t,i)}addResources(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:{silent:!1};for(const r in t)(b(t[r])||Array.isArray(t[r]))&&this.addResource(e,n,r,t[r],{silent:!0});i.silent||this.emit("added",e,n,t)}addResourceBundle(e,n,t,i,r){let s=arguments.length>5&&arguments[5]!==void 0?arguments[5]:{silent:!1,skipCopy:!1},o=[e,n];e.indexOf(".")>-1&&(o=e.split("."),i=t,t=n,n=o[1]),this.addNamespaces(n);let h=te(this.data,o)||{};s.skipCopy||(t=JSON.parse(JSON.stringify(t))),i?We(h,t,r):h={...h,...t},we(this.data,o,h),s.silent||this.emit("added",e,n,t)}removeResourceBundle(e,n){this.hasResourceBundle(e,n)&&delete this.data[e][n],this.removeNamespaces(n),this.emit("removed",e,n)}hasResourceBundle(e,n){return this.getResource(e,n)!==void 0}getResourceBundle(e,n){return n||(n=this.options.defaultNS),this.options.compatibilityAPI==="v1"?{...this.getResource(e,n)}:this.getResource(e,n)}getDataByLanguage(e){return this.data[e]}hasLanguageSomeTranslations(e){const n=this.getDataByLanguage(e);return!!(n&&Object.keys(n)||[]).find(i=>n[i]&&Object.keys(n[i]).length>0)}toJSON(){return this.data}}var Me={processors:{},addPostProcessor(a){this.processors[a.name]=a},handle(a,e,n,t,i){return a.forEach(r=>{this.processors[r]&&(e=this.processors[r].process(e,n,t,i))}),e}};const je={};class ie extends se{constructor(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};super(),Ln(["resourceStore","languageUtils","pluralResolver","interpolator","backendConnector","i18nFormat","utils"],e,this),this.options=n,this.options.keySeparator===void 0&&(this.options.keySeparator="."),this.logger=F.create("translator")}changeLanguage(e){e&&(this.language=e)}exists(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{interpolation:{}};if(e==null)return!1;const t=this.resolve(e,n);return t&&t.res!==void 0}extractFromKey(e,n){let t=n.nsSeparator!==void 0?n.nsSeparator:this.options.nsSeparator;t===void 0&&(t=":");const i=n.keySeparator!==void 0?n.keySeparator:this.options.keySeparator;let r=n.ns||this.options.defaultNS||[];const s=t&&e.indexOf(t)>-1,o=!this.options.userDefinedKeySeparator&&!n.keySeparator&&!this.options.userDefinedNsSeparator&&!n.nsSeparator&&!Wn(e,t,i);if(s&&!o){const h=e.match(this.interpolator.nestingRegexp);if(h&&h.length>0)return{key:e,namespaces:b(r)?[r]:r};const f=e.split(t);(t!==i||t===i&&this.options.ns.indexOf(f[0])>-1)&&(r=f.shift()),e=f.join(i)}return{key:e,namespaces:b(r)?[r]:r}}translate(e,n,t){if(typeof n!="object"&&this.options.overloadTranslationOptionHandler&&(n=this.options.overloadTranslationOptionHandler(arguments)),typeof n=="object"&&(n={...n}),n||(n={}),e==null)return"";Array.isArray(e)||(e=[String(e)]);const i=n.returnDetails!==void 0?n.returnDetails:this.options.returnDetails,r=n.keySeparator!==void 0?n.keySeparator:this.options.keySeparator,{key:s,namespaces:o}=this.extractFromKey(e[e.length-1],n),h=o[o.length-1],f=n.lng||this.language,c=n.appendNamespaceToCIMode||this.options.appendNamespaceToCIMode;if(f&&f.toLowerCase()==="cimode"){if(c){const g=n.nsSeparator||this.options.nsSeparator;return i?{res:`${h}${g}${s}`,usedKey:s,exactUsedKey:s,usedLng:f,usedNS:h,usedParams:this.getUsedParamsDetails(n)}:`${h}${g}${s}`}return i?{res:s,usedKey:s,exactUsedKey:s,usedLng:f,usedNS:h,usedParams:this.getUsedParamsDetails(n)}:s}const x=this.resolve(e,n);let d=x&&x.res;const $=x&&x.usedKey||s,m=x&&x.exactUsedKey||s,w=Object.prototype.toString.apply(d),p=["[object Number]","[object Function]","[object RegExp]"],u=n.joinArrays!==void 0?n.joinArrays:this.options.joinArrays,z=!this.i18nFormat||this.i18nFormat.handleAsObject,y=!b(d)&&typeof d!="boolean"&&typeof d!="number";if(z&&d&&y&&p.indexOf(w)<0&&!(b(u)&&Array.isArray(d))){if(!n.returnObjects&&!this.options.returnObjects){this.options.returnedObjectHandler||this.logger.warn("accessing an object - but returnObjects options is not enabled!");const g=this.options.returnedObjectHandler?this.options.returnedObjectHandler($,d,{...n,ns:o}):`key '${s} (${this.language})' returned an object instead of string.`;return i?(x.res=g,x.usedParams=this.getUsedParamsDetails(n),x):g}if(r){const g=Array.isArray(d),q=g?[]:{},j=g?m:$;for(const N in d)if(Object.prototype.hasOwnProperty.call(d,N)){const S=`${j}${r}${N}`;q[N]=this.translate(S,{...n,joinArrays:!1,ns:o}),q[N]===S&&(q[N]=d[N])}d=q}}else if(z&&b(u)&&Array.isArray(d))d=d.join(u),d&&(d=this.extendTranslation(d,e,n,t));else{let g=!1,q=!1;const j=n.count!==void 0&&!b(n.count),N=ie.hasDefaultValue(n),S=j?this.pluralResolver.getSuffix(f,n.count,n):"",C=n.ordinal&&j?this.pluralResolver.getSuffix(f,n.count,{ordinal:!1}):"",T=j&&!n.ordinal&&n.count===0&&this.pluralResolver.shouldUseIntlApi(),_=T&&n[`defaultValue${this.options.pluralSeparator}zero`]||n[`defaultValue${S}`]||n[`defaultValue${C}`]||n.defaultValue;!this.isValidLookup(d)&&N&&(g=!0,d=_),this.isValidLookup(d)||(q=!0,d=s);const P=(n.missingKeyNoValueFallbackToKey||this.options.missingKeyNoValueFallbackToKey)&&q?void 0:d,I=N&&_!==d&&this.options.updateMissing;if(q||g||I){if(this.logger.log(I?"updateKey":"missingKey",f,h,s,I?_:d),r){const O=this.resolve(s,{...n,keySeparator:!1});O&&O.res&&this.logger.warn("Seems the loaded translations were in flat JSON format instead of nested. Either set keySeparator: false on init or make sure your translations are published in nested format.")}let W=[];const Z=this.languageUtils.getFallbackCodes(this.options.fallbackLng,n.lng||this.language);if(this.options.saveMissingTo==="fallback"&&Z&&Z[0])for(let O=0;O<Z.length;O++)W.push(Z[O]);else this.options.saveMissingTo==="all"?W=this.languageUtils.toResolveHierarchy(n.lng||this.language):W.push(n.lng||this.language);const me=(O,M,H)=>{const ge=N&&H!==d?H:P;this.options.missingKeyHandler?this.options.missingKeyHandler(O,h,M,ge,I,n):this.backendConnector&&this.backendConnector.saveMissing&&this.backendConnector.saveMissing(O,h,M,ge,I,n),this.emit("missingKey",O,h,M,d)};this.options.saveMissing&&(this.options.saveMissingPlurals&&j?W.forEach(O=>{const M=this.pluralResolver.getSuffixes(O,n);T&&n[`defaultValue${this.options.pluralSeparator}zero`]&&M.indexOf(`${this.options.pluralSeparator}zero`)<0&&M.push(`${this.options.pluralSeparator}zero`),M.forEach(H=>{me([O],s+H,n[`defaultValue${H}`]||_)})}):me(W,s,_))}d=this.extendTranslation(d,e,n,x,t),q&&d===s&&this.options.appendNamespaceToMissingKey&&(d=`${h}:${s}`),(q||g)&&this.options.parseMissingKeyHandler&&(this.options.compatibilityAPI!=="v1"?d=this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey?`${h}:${s}`:s,g?d:void 0):d=this.options.parseMissingKeyHandler(d))}return i?(x.res=d,x.usedParams=this.getUsedParamsDetails(n),x):d}extendTranslation(e,n,t,i,r){var s=this;if(this.i18nFormat&&this.i18nFormat.parse)e=this.i18nFormat.parse(e,{...this.options.interpolation.defaultVariables,...t},t.lng||this.language||i.usedLng,i.usedNS,i.usedKey,{resolved:i});else if(!t.skipInterpolation){t.interpolation&&this.interpolator.init({...t,interpolation:{...this.options.interpolation,...t.interpolation}});const f=b(e)&&(t&&t.interpolation&&t.interpolation.skipOnVariables!==void 0?t.interpolation.skipOnVariables:this.options.interpolation.skipOnVariables);let c;if(f){const d=e.match(this.interpolator.nestingRegexp);c=d&&d.length}let x=t.replace&&!b(t.replace)?t.replace:t;if(this.options.interpolation.defaultVariables&&(x={...this.options.interpolation.defaultVariables,...x}),e=this.interpolator.interpolate(e,x,t.lng||this.language||i.usedLng,t),f){const d=e.match(this.interpolator.nestingRegexp),$=d&&d.length;c<$&&(t.nest=!1)}!t.lng&&this.options.compatibilityAPI!=="v1"&&i&&i.res&&(t.lng=this.language||i.usedLng),t.nest!==!1&&(e=this.interpolator.nest(e,function(){for(var d=arguments.length,$=new Array(d),m=0;m<d;m++)$[m]=arguments[m];return r&&r[0]===$[0]&&!t.context?(s.logger.warn(`It seems you are nesting recursively key: ${$[0]} in key: ${n[0]}`),null):s.translate(...$,n)},t)),t.interpolation&&this.interpolator.reset()}const o=t.postProcess||this.options.postProcess,h=b(o)?[o]:o;return e!=null&&h&&h.length&&t.applyPostProcessor!==!1&&(e=Me.handle(h,e,n,this.options&&this.options.postProcessPassResolved?{i18nResolved:{...i,usedParams:this.getUsedParamsDetails(t)},...t}:t,this)),e}resolve(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},t,i,r,s,o;return b(e)&&(e=[e]),e.forEach(h=>{if(this.isValidLookup(t))return;const f=this.extractFromKey(h,n),c=f.key;i=c;let x=f.namespaces;this.options.fallbackNS&&(x=x.concat(this.options.fallbackNS));const d=n.count!==void 0&&!b(n.count),$=d&&!n.ordinal&&n.count===0&&this.pluralResolver.shouldUseIntlApi(),m=n.context!==void 0&&(b(n.context)||typeof n.context=="number")&&n.context!=="",w=n.lngs?n.lngs:this.languageUtils.toResolveHierarchy(n.lng||this.language,n.fallbackLng);x.forEach(p=>{this.isValidLookup(t)||(o=p,!je[`${w[0]}-${p}`]&&this.utils&&this.utils.hasLoadedNamespace&&!this.utils.hasLoadedNamespace(o)&&(je[`${w[0]}-${p}`]=!0,this.logger.warn(`key "${i}" for languages "${w.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`,"This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")),w.forEach(u=>{if(this.isValidLookup(t))return;s=u;const z=[c];if(this.i18nFormat&&this.i18nFormat.addLookupKeys)this.i18nFormat.addLookupKeys(z,c,u,p,n);else{let g;d&&(g=this.pluralResolver.getSuffix(u,n.count,n));const q=`${this.options.pluralSeparator}zero`,j=`${this.options.pluralSeparator}ordinal${this.options.pluralSeparator}`;if(d&&(z.push(c+g),n.ordinal&&g.indexOf(j)===0&&z.push(c+g.replace(j,this.options.pluralSeparator)),$&&z.push(c+q)),m){const N=`${c}${this.options.contextSeparator}${n.context}`;z.push(N),d&&(z.push(N+g),n.ordinal&&g.indexOf(j)===0&&z.push(N+g.replace(j,this.options.pluralSeparator)),$&&z.push(N+q))}}let y;for(;y=z.pop();)this.isValidLookup(t)||(r=y,t=this.getResource(u,p,y,n))}))})}),{res:t,usedKey:i,exactUsedKey:r,usedLng:s,usedNS:o}}isValidLookup(e){return e!==void 0&&!(!this.options.returnNull&&e===null)&&!(!this.options.returnEmptyString&&e==="")}getResource(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:{};return this.i18nFormat&&this.i18nFormat.getResource?this.i18nFormat.getResource(e,n,t,i):this.resourceStore.getResource(e,n,t,i)}getUsedParamsDetails(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};const n=["defaultValue","ordinal","context","replace","lng","lngs","fallbackLng","ns","keySeparator","nsSeparator","returnObjects","returnDetails","joinArrays","postProcess","interpolation"],t=e.replace&&!b(e.replace);let i=t?e.replace:e;if(t&&typeof e.count<"u"&&(i.count=e.count),this.options.interpolation.defaultVariables&&(i={...this.options.interpolation.defaultVariables,...i}),!t){i={...i};for(const r of n)delete i[r]}return i}static hasDefaultValue(e){const n="defaultValue";for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t)&&n===t.substring(0,n.length)&&e[t]!==void 0)return!0;return!1}}const le=a=>a.charAt(0).toUpperCase()+a.slice(1);class Ne{constructor(e){this.options=e,this.supportedLngs=this.options.supportedLngs||!1,this.logger=F.create("languageUtils")}getScriptPartFromCode(e){if(e=ae(e),!e||e.indexOf("-")<0)return null;const n=e.split("-");return n.length===2||(n.pop(),n[n.length-1].toLowerCase()==="x")?null:this.formatLanguageCode(n.join("-"))}getLanguagePartFromCode(e){if(e=ae(e),!e||e.indexOf("-")<0)return e;const n=e.split("-");return this.formatLanguageCode(n[0])}formatLanguageCode(e){if(b(e)&&e.indexOf("-")>-1){if(typeof Intl<"u"&&typeof Intl.getCanonicalLocales<"u")try{let i=Intl.getCanonicalLocales(e)[0];if(i&&this.options.lowerCaseLng&&(i=i.toLowerCase()),i)return i}catch{}const n=["hans","hant","latn","cyrl","cans","mong","arab"];let t=e.split("-");return this.options.lowerCaseLng?t=t.map(i=>i.toLowerCase()):t.length===2?(t[0]=t[0].toLowerCase(),t[1]=t[1].toUpperCase(),n.indexOf(t[1].toLowerCase())>-1&&(t[1]=le(t[1].toLowerCase()))):t.length===3&&(t[0]=t[0].toLowerCase(),t[1].length===2&&(t[1]=t[1].toUpperCase()),t[0]!=="sgn"&&t[2].length===2&&(t[2]=t[2].toUpperCase()),n.indexOf(t[1].toLowerCase())>-1&&(t[1]=le(t[1].toLowerCase())),n.indexOf(t[2].toLowerCase())>-1&&(t[2]=le(t[2].toLowerCase()))),t.join("-")}return this.options.cleanCode||this.options.lowerCaseLng?e.toLowerCase():e}isSupportedCode(e){return(this.options.load==="languageOnly"||this.options.nonExplicitSupportedLngs)&&(e=this.getLanguagePartFromCode(e)),!this.supportedLngs||!this.supportedLngs.length||this.supportedLngs.indexOf(e)>-1}getBestMatchFromCodes(e){if(!e)return null;let n;return e.forEach(t=>{if(n)return;const i=this.formatLanguageCode(t);(!this.options.supportedLngs||this.isSupportedCode(i))&&(n=i)}),!n&&this.options.supportedLngs&&e.forEach(t=>{if(n)return;const i=this.getLanguagePartFromCode(t);if(this.isSupportedCode(i))return n=i;n=this.options.supportedLngs.find(r=>{if(r===i)return r;if(!(r.indexOf("-")<0&&i.indexOf("-")<0)&&(r.indexOf("-")>0&&i.indexOf("-")<0&&r.substring(0,r.indexOf("-"))===i||r.indexOf(i)===0&&i.length>1))return r})}),n||(n=this.getFallbackCodes(this.options.fallbackLng)[0]),n}getFallbackCodes(e,n){if(!e)return[];if(typeof e=="function"&&(e=e(n)),b(e)&&(e=[e]),Array.isArray(e))return e;if(!n)return e.default||[];let t=e[n];return t||(t=e[this.getScriptPartFromCode(n)]),t||(t=e[this.formatLanguageCode(n)]),t||(t=e[this.getLanguagePartFromCode(n)]),t||(t=e.default),t||[]}toResolveHierarchy(e,n){const t=this.getFallbackCodes(n||this.options.fallbackLng||[],e),i=[],r=s=>{s&&(this.isSupportedCode(s)?i.push(s):this.logger.warn(`rejecting language code not found in supportedLngs: ${s}`))};return b(e)&&(e.indexOf("-")>-1||e.indexOf("_")>-1)?(this.options.load!=="languageOnly"&&r(this.formatLanguageCode(e)),this.options.load!=="languageOnly"&&this.options.load!=="currentOnly"&&r(this.getScriptPartFromCode(e)),this.options.load!=="currentOnly"&&r(this.getLanguagePartFromCode(e))):b(e)&&r(this.formatLanguageCode(e)),t.forEach(s=>{i.indexOf(s)<0&&r(this.formatLanguageCode(s))}),i}}let Gn=[{lngs:["ach","ak","am","arn","br","fil","gun","ln","mfe","mg","mi","oc","pt","pt-BR","tg","tl","ti","tr","uz","wa"],nr:[1,2],fc:1},{lngs:["af","an","ast","az","bg","bn","ca","da","de","dev","el","en","eo","es","et","eu","fi","fo","fur","fy","gl","gu","ha","hi","hu","hy","ia","it","kk","kn","ku","lb","mai","ml","mn","mr","nah","nap","nb","ne","nl","nn","no","nso","pa","pap","pms","ps","pt-PT","rm","sco","se","si","so","son","sq","sv","sw","ta","te","tk","ur","yo"],nr:[1,2],fc:2},{lngs:["ay","bo","cgg","fa","ht","id","ja","jbo","ka","km","ko","ky","lo","ms","sah","su","th","tt","ug","vi","wo","zh"],nr:[1],fc:3},{lngs:["be","bs","cnr","dz","hr","ru","sr","uk"],nr:[1,2,5],fc:4},{lngs:["ar"],nr:[0,1,2,3,11,100],fc:5},{lngs:["cs","sk"],nr:[1,2,5],fc:6},{lngs:["csb","pl"],nr:[1,2,5],fc:7},{lngs:["cy"],nr:[1,2,3,8],fc:8},{lngs:["fr"],nr:[1,2],fc:9},{lngs:["ga"],nr:[1,2,3,7,11],fc:10},{lngs:["gd"],nr:[1,2,3,20],fc:11},{lngs:["is"],nr:[1,2],fc:12},{lngs:["jv"],nr:[0,1],fc:13},{lngs:["kw"],nr:[1,2,3,4],fc:14},{lngs:["lt"],nr:[1,2,10],fc:15},{lngs:["lv"],nr:[1,2,0],fc:16},{lngs:["mk"],nr:[1,2],fc:17},{lngs:["mnk"],nr:[0,1,2],fc:18},{lngs:["mt"],nr:[1,2,11,20],fc:19},{lngs:["or"],nr:[2,1],fc:2},{lngs:["ro"],nr:[1,2,20],fc:20},{lngs:["sl"],nr:[5,1,2,3],fc:21},{lngs:["he","iw"],nr:[1,2,20,21],fc:22}],Dn={1:a=>+(a>1),2:a=>+(a!=1),3:a=>0,4:a=>a%10==1&&a%100!=11?0:a%10>=2&&a%10<=4&&(a%100<10||a%100>=20)?1:2,5:a=>a==0?0:a==1?1:a==2?2:a%100>=3&&a%100<=10?3:a%100>=11?4:5,6:a=>a==1?0:a>=2&&a<=4?1:2,7:a=>a==1?0:a%10>=2&&a%10<=4&&(a%100<10||a%100>=20)?1:2,8:a=>a==1?0:a==2?1:a!=8&&a!=11?2:3,9:a=>+(a>=2),10:a=>a==1?0:a==2?1:a<7?2:a<11?3:4,11:a=>a==1||a==11?0:a==2||a==12?1:a>2&&a<20?2:3,12:a=>+(a%10!=1||a%100==11),13:a=>+(a!==0),14:a=>a==1?0:a==2?1:a==3?2:3,15:a=>a%10==1&&a%100!=11?0:a%10>=2&&(a%100<10||a%100>=20)?1:2,16:a=>a%10==1&&a%100!=11?0:a!==0?1:2,17:a=>a==1||a%10==1&&a%100!=11?0:1,18:a=>a==0?0:a==1?1:2,19:a=>a==1?0:a==0||a%100>1&&a%100<11?1:a%100>10&&a%100<20?2:3,20:a=>a==1?0:a==0||a%100>0&&a%100<20?1:2,21:a=>a%100==1?1:a%100==2?2:a%100==3||a%100==4?3:0,22:a=>a==1?0:a==2?1:(a<0||a>10)&&a%10==0?2:3};const Bn=["v1","v2","v3"],Hn=["v4"],Se={zero:0,one:1,two:2,few:3,many:4,other:5},Vn=()=>{const a={};return Gn.forEach(e=>{e.lngs.forEach(n=>{a[n]={numbers:e.nr,plurals:Dn[e.fc]}})}),a};class Un{constructor(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};this.languageUtils=e,this.options=n,this.logger=F.create("pluralResolver"),(!this.options.compatibilityJSON||Hn.includes(this.options.compatibilityJSON))&&(typeof Intl>"u"||!Intl.PluralRules)&&(this.options.compatibilityJSON="v3",this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")),this.rules=Vn(),this.pluralRulesCache={}}addRule(e,n){this.rules[e]=n}clearCache(){this.pluralRulesCache={}}getRule(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};if(this.shouldUseIntlApi()){const t=ae(e==="dev"?"en":e),i=n.ordinal?"ordinal":"cardinal",r=JSON.stringify({cleanedCode:t,type:i});if(r in this.pluralRulesCache)return this.pluralRulesCache[r];let s;try{s=new Intl.PluralRules(t,{type:i})}catch{if(!e.match(/-|_/))return;const h=this.languageUtils.getLanguagePartFromCode(e);s=this.getRule(h,n)}return this.pluralRulesCache[r]=s,s}return this.rules[e]||this.rules[this.languageUtils.getLanguagePartFromCode(e)]}needsPlural(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};const t=this.getRule(e,n);return this.shouldUseIntlApi()?t&&t.resolvedOptions().pluralCategories.length>1:t&&t.numbers.length>1}getPluralFormsOfKey(e,n){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};return this.getSuffixes(e,t).map(i=>`${n}${i}`)}getSuffixes(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};const t=this.getRule(e,n);return t?this.shouldUseIntlApi()?t.resolvedOptions().pluralCategories.sort((i,r)=>Se[i]-Se[r]).map(i=>`${this.options.prepend}${n.ordinal?`ordinal${this.options.prepend}`:""}${i}`):t.numbers.map(i=>this.getSuffix(e,i,n)):[]}getSuffix(e,n){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{};const i=this.getRule(e,t);return i?this.shouldUseIntlApi()?`${this.options.prepend}${t.ordinal?`ordinal${this.options.prepend}`:""}${i.select(n)}`:this.getSuffixRetroCompatible(i,n):(this.logger.warn(`no plural rule found for: ${e}`),"")}getSuffixRetroCompatible(e,n){const t=e.noAbs?e.plurals(n):e.plurals(Math.abs(n));let i=e.numbers[t];this.options.simplifyPluralSuffix&&e.numbers.length===2&&e.numbers[0]===1&&(i===2?i="plural":i===1&&(i=""));const r=()=>this.options.prepend&&i.toString()?this.options.prepend+i.toString():i.toString();return this.options.compatibilityJSON==="v1"?i===1?"":typeof i=="number"?`_plural_${i.toString()}`:r():this.options.compatibilityJSON==="v2"||this.options.simplifyPluralSuffix&&e.numbers.length===2&&e.numbers[0]===1?r():this.options.prepend&&t.toString()?this.options.prepend+t.toString():t.toString()}shouldUseIntlApi(){return!Bn.includes(this.options.compatibilityJSON)}}const Te=function(a,e,n){let t=arguments.length>3&&arguments[3]!==void 0?arguments[3]:".",i=arguments.length>4&&arguments[4]!==void 0?arguments[4]:!0,r=On(a,e,n);return!r&&i&&b(n)&&(r=xe(a,n,t),r===void 0&&(r=xe(e,n,t))),r},fe=a=>a.replace(/\$/g,"$$$$");class Qn{constructor(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};this.logger=F.create("interpolator"),this.options=e,this.format=e.interpolation&&e.interpolation.format||(n=>n),this.init(e)}init(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};e.interpolation||(e.interpolation={escapeValue:!0});const{escape:n,escapeValue:t,useRawValueToEscape:i,prefix:r,prefixEscaped:s,suffix:o,suffixEscaped:h,formatSeparator:f,unescapeSuffix:c,unescapePrefix:x,nestingPrefix:d,nestingPrefixEscaped:$,nestingSuffix:m,nestingSuffixEscaped:w,nestingOptionsSeparator:p,maxReplaces:u,alwaysFormat:z}=e.interpolation;this.escape=n!==void 0?n:Rn,this.escapeValue=t!==void 0?t:!0,this.useRawValueToEscape=i!==void 0?i:!1,this.prefix=r?D(r):s||"{{",this.suffix=o?D(o):h||"}}",this.formatSeparator=f||",",this.unescapePrefix=c?"":x||"-",this.unescapeSuffix=this.unescapePrefix?"":c||"",this.nestingPrefix=d?D(d):$||D("$t("),this.nestingSuffix=m?D(m):w||D(")"),this.nestingOptionsSeparator=p||",",this.maxReplaces=u||1e3,this.alwaysFormat=z!==void 0?z:!1,this.resetRegExp()}reset(){this.options&&this.init(this.options)}resetRegExp(){const e=(n,t)=>n&&n.source===t?(n.lastIndex=0,n):new RegExp(t,"g");this.regexp=e(this.regexp,`${this.prefix}(.+?)${this.suffix}`),this.regexpUnescape=e(this.regexpUnescape,`${this.prefix}${this.unescapePrefix}(.+?)${this.unescapeSuffix}${this.suffix}`),this.nestingRegexp=e(this.nestingRegexp,`${this.nestingPrefix}(.+?)${this.nestingSuffix}`)}interpolate(e,n,t,i){let r,s,o;const h=this.options&&this.options.interpolation&&this.options.interpolation.defaultVariables||{},f=$=>{if($.indexOf(this.formatSeparator)<0){const u=Te(n,h,$,this.options.keySeparator,this.options.ignoreJSONStructure);return this.alwaysFormat?this.format(u,void 0,t,{...i,...n,interpolationkey:$}):u}const m=$.split(this.formatSeparator),w=m.shift().trim(),p=m.join(this.formatSeparator).trim();return this.format(Te(n,h,w,this.options.keySeparator,this.options.ignoreJSONStructure),p,t,{...i,...n,interpolationkey:w})};this.resetRegExp();const c=i&&i.missingInterpolationHandler||this.options.missingInterpolationHandler,x=i&&i.interpolation&&i.interpolation.skipOnVariables!==void 0?i.interpolation.skipOnVariables:this.options.interpolation.skipOnVariables;return[{regex:this.regexpUnescape,safeValue:$=>fe($)},{regex:this.regexp,safeValue:$=>this.escapeValue?fe(this.escape($)):fe($)}].forEach($=>{for(o=0;r=$.regex.exec(e);){const m=r[1].trim();if(s=f(m),s===void 0)if(typeof c=="function"){const p=c(e,r,i);s=b(p)?p:""}else if(i&&Object.prototype.hasOwnProperty.call(i,m))s="";else if(x){s=r[0];continue}else this.logger.warn(`missed to pass in variable ${m} for interpolating ${e}`),s="";else!b(s)&&!this.useRawValueToEscape&&(s=ye(s));const w=$.safeValue(s);if(e=e.replace(r[0],w),x?($.regex.lastIndex+=s.length,$.regex.lastIndex-=r[0].length):$.regex.lastIndex=0,o++,o>=this.maxReplaces)break}}),e}nest(e,n){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},i,r,s;const o=(h,f)=>{const c=this.nestingOptionsSeparator;if(h.indexOf(c)<0)return h;const x=h.split(new RegExp(`${c}[ ]*{`));let d=`{${x[1]}`;h=x[0],d=this.interpolate(d,s);const $=d.match(/'/g),m=d.match(/"/g);($&&$.length%2===0&&!m||m.length%2!==0)&&(d=d.replace(/'/g,'"'));try{s=JSON.parse(d),f&&(s={...f,...s})}catch(w){return this.logger.warn(`failed parsing options string in nesting for key ${h}`,w),`${h}${c}${d}`}return s.defaultValue&&s.defaultValue.indexOf(this.prefix)>-1&&delete s.defaultValue,h};for(;i=this.nestingRegexp.exec(e);){let h=[];s={...t},s=s.replace&&!b(s.replace)?s.replace:s,s.applyPostProcessor=!1,delete s.defaultValue;let f=!1;if(i[0].indexOf(this.formatSeparator)!==-1&&!/{.*}/.test(i[1])){const c=i[1].split(this.formatSeparator).map(x=>x.trim());i[1]=c.shift(),h=c,f=!0}if(r=n(o.call(this,i[1].trim(),s),s),r&&i[0]===e&&!b(r))return r;b(r)||(r=ye(r)),r||(this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`),r=""),f&&(r=h.reduce((c,x)=>this.format(c,x,t.lng,{...t,interpolationkey:i[1].trim()}),r.trim())),e=e.replace(i[0],r),this.regexp.lastIndex=0}return e}}const Jn=a=>{let e=a.toLowerCase().trim();const n={};if(a.indexOf("(")>-1){const t=a.split("(");e=t[0].toLowerCase().trim();const i=t[1].substring(0,t[1].length-1);e==="currency"&&i.indexOf(":")<0?n.currency||(n.currency=i.trim()):e==="relativetime"&&i.indexOf(":")<0?n.range||(n.range=i.trim()):i.split(";").forEach(s=>{if(s){const[o,...h]=s.split(":"),f=h.join(":").trim().replace(/^'+|'+$/g,""),c=o.trim();n[c]||(n[c]=f),f==="false"&&(n[c]=!1),f==="true"&&(n[c]=!0),isNaN(f)||(n[c]=parseInt(f,10))}})}return{formatName:e,formatOptions:n}},B=a=>{const e={};return(n,t,i)=>{let r=i;i&&i.interpolationkey&&i.formatParams&&i.formatParams[i.interpolationkey]&&i[i.interpolationkey]&&(r={...r,[i.interpolationkey]:void 0});const s=t+JSON.stringify(r);let o=e[s];return o||(o=a(ae(t),i),e[s]=o),o(n)}};class Yn{constructor(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};this.logger=F.create("formatter"),this.options=e,this.formats={number:B((n,t)=>{const i=new Intl.NumberFormat(n,{...t});return r=>i.format(r)}),currency:B((n,t)=>{const i=new Intl.NumberFormat(n,{...t,style:"currency"});return r=>i.format(r)}),datetime:B((n,t)=>{const i=new Intl.DateTimeFormat(n,{...t});return r=>i.format(r)}),relativetime:B((n,t)=>{const i=new Intl.RelativeTimeFormat(n,{...t});return r=>i.format(r,t.range||"day")}),list:B((n,t)=>{const i=new Intl.ListFormat(n,{...t});return r=>i.format(r)})},this.init(e)}init(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{interpolation:{}};this.formatSeparator=n.interpolation.formatSeparator||","}add(e,n){this.formats[e.toLowerCase().trim()]=n}addCached(e,n){this.formats[e.toLowerCase().trim()]=B(n)}format(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:{};const r=n.split(this.formatSeparator);if(r.length>1&&r[0].indexOf("(")>1&&r[0].indexOf(")")<0&&r.find(o=>o.indexOf(")")>-1)){const o=r.findIndex(h=>h.indexOf(")")>-1);r[0]=[r[0],...r.splice(1,o)].join(this.formatSeparator)}return r.reduce((o,h)=>{const{formatName:f,formatOptions:c}=Jn(h);if(this.formats[f]){let x=o;try{const d=i&&i.formatParams&&i.formatParams[i.interpolationkey]||{},$=d.locale||d.lng||i.locale||i.lng||t;x=this.formats[f](o,$,{...c,...i,...d})}catch(d){this.logger.warn(d)}return x}else this.logger.warn(`there was no format function for ${f}`);return o},e)}}const Zn=(a,e)=>{a.pending[e]!==void 0&&(delete a.pending[e],a.pendingCount--)};class Xn extends se{constructor(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:{};super(),this.backend=e,this.store=n,this.services=t,this.languageUtils=t.languageUtils,this.options=i,this.logger=F.create("backendConnector"),this.waitingReads=[],this.maxParallelReads=i.maxParallelReads||10,this.readingCalls=0,this.maxRetries=i.maxRetries>=0?i.maxRetries:5,this.retryTimeout=i.retryTimeout>=1?i.retryTimeout:350,this.state={},this.queue=[],this.backend&&this.backend.init&&this.backend.init(t,i.backend,i)}queueLoad(e,n,t,i){const r={},s={},o={},h={};return e.forEach(f=>{let c=!0;n.forEach(x=>{const d=`${f}|${x}`;!t.reload&&this.store.hasResourceBundle(f,x)?this.state[d]=2:this.state[d]<0||(this.state[d]===1?s[d]===void 0&&(s[d]=!0):(this.state[d]=1,c=!1,s[d]===void 0&&(s[d]=!0),r[d]===void 0&&(r[d]=!0),h[x]===void 0&&(h[x]=!0)))}),c||(o[f]=!0)}),(Object.keys(r).length||Object.keys(s).length)&&this.queue.push({pending:s,pendingCount:Object.keys(s).length,loaded:{},errors:[],callback:i}),{toLoad:Object.keys(r),pending:Object.keys(s),toLoadLanguages:Object.keys(o),toLoadNamespaces:Object.keys(h)}}loaded(e,n,t){const i=e.split("|"),r=i[0],s=i[1];n&&this.emit("failedLoading",r,s,n),!n&&t&&this.store.addResourceBundle(r,s,t,void 0,void 0,{skipCopy:!0}),this.state[e]=n?-1:2,n&&t&&(this.state[e]=0);const o={};this.queue.forEach(h=>{En(h.loaded,[r],s),Zn(h,e),n&&h.errors.push(n),h.pendingCount===0&&!h.done&&(Object.keys(h.loaded).forEach(f=>{o[f]||(o[f]={});const c=h.loaded[f];c.length&&c.forEach(x=>{o[f][x]===void 0&&(o[f][x]=!0)})}),h.done=!0,h.errors.length?h.callback(h.errors):h.callback())}),this.emit("loaded",o),this.queue=this.queue.filter(h=>!h.done)}read(e,n,t){let i=arguments.length>3&&arguments[3]!==void 0?arguments[3]:0,r=arguments.length>4&&arguments[4]!==void 0?arguments[4]:this.retryTimeout,s=arguments.length>5?arguments[5]:void 0;if(!e.length)return s(null,{});if(this.readingCalls>=this.maxParallelReads){this.waitingReads.push({lng:e,ns:n,fcName:t,tried:i,wait:r,callback:s});return}this.readingCalls++;const o=(f,c)=>{if(this.readingCalls--,this.waitingReads.length>0){const x=this.waitingReads.shift();this.read(x.lng,x.ns,x.fcName,x.tried,x.wait,x.callback)}if(f&&c&&i<this.maxRetries){setTimeout(()=>{this.read.call(this,e,n,t,i+1,r*2,s)},r);return}s(f,c)},h=this.backend[t].bind(this.backend);if(h.length===2){try{const f=h(e,n);f&&typeof f.then=="function"?f.then(c=>o(null,c)).catch(o):o(null,f)}catch(f){o(f)}return}return h(e,n,o)}prepareLoading(e,n){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},i=arguments.length>3?arguments[3]:void 0;if(!this.backend)return this.logger.warn("No backend was added via i18next.use. Will not load resources."),i&&i();b(e)&&(e=this.languageUtils.toResolveHierarchy(e)),b(n)&&(n=[n]);const r=this.queueLoad(e,n,t,i);if(!r.toLoad.length)return r.pending.length||i(),null;r.toLoad.forEach(s=>{this.loadOne(s)})}load(e,n,t){this.prepareLoading(e,n,{},t)}reload(e,n,t){this.prepareLoading(e,n,{reload:!0},t)}loadOne(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"";const t=e.split("|"),i=t[0],r=t[1];this.read(i,r,"read",void 0,void 0,(s,o)=>{s&&this.logger.warn(`${n}loading namespace ${r} for language ${i} failed`,s),!s&&o&&this.logger.log(`${n}loaded namespace ${r} for language ${i}`,o),this.loaded(e,s,o)})}saveMissing(e,n,t,i,r){let s=arguments.length>5&&arguments[5]!==void 0?arguments[5]:{},o=arguments.length>6&&arguments[6]!==void 0?arguments[6]:()=>{};if(this.services.utils&&this.services.utils.hasLoadedNamespace&&!this.services.utils.hasLoadedNamespace(n)){this.logger.warn(`did not save key "${t}" as the namespace "${n}" was not yet loaded`,"This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");return}if(!(t==null||t==="")){if(this.backend&&this.backend.create){const h={...s,isUpdate:r},f=this.backend.create.bind(this.backend);if(f.length<6)try{let c;f.length===5?c=f(e,n,t,i,h):c=f(e,n,t,i),c&&typeof c.then=="function"?c.then(x=>o(null,x)).catch(o):o(null,c)}catch(c){o(c)}else f(e,n,t,i,o,h)}!e||!e[0]||this.store.addResource(e[0],n,t,i)}}}const Ce=()=>({debug:!1,initImmediate:!0,ns:["translation"],defaultNS:["translation"],fallbackLng:["dev"],fallbackNS:!1,supportedLngs:!1,nonExplicitSupportedLngs:!1,load:"all",preload:!1,simplifyPluralSuffix:!0,keySeparator:".",nsSeparator:":",pluralSeparator:"_",contextSeparator:"_",partialBundledLanguages:!1,saveMissing:!1,updateMissing:!1,saveMissingTo:"fallback",saveMissingPlurals:!0,missingKeyHandler:!1,missingInterpolationHandler:!1,postProcess:!1,postProcessPassResolved:!1,returnNull:!1,returnEmptyString:!0,returnObjects:!1,joinArrays:!1,returnedObjectHandler:!1,parseMissingKeyHandler:!1,appendNamespaceToMissingKey:!1,appendNamespaceToCIMode:!1,overloadTranslationOptionHandler:a=>{let e={};if(typeof a[1]=="object"&&(e=a[1]),b(a[1])&&(e.defaultValue=a[1]),b(a[2])&&(e.tDescription=a[2]),typeof a[2]=="object"||typeof a[3]=="object"){const n=a[3]||a[2];Object.keys(n).forEach(t=>{e[t]=n[t]})}return e},interpolation:{escapeValue:!0,format:a=>a,prefix:"{{",suffix:"}}",formatSeparator:",",unescapePrefix:"-",nestingPrefix:"$t(",nestingSuffix:")",nestingOptionsSeparator:",",maxReplaces:1e3,skipOnVariables:!0}}),Le=a=>(b(a.ns)&&(a.ns=[a.ns]),b(a.fallbackLng)&&(a.fallbackLng=[a.fallbackLng]),b(a.fallbackNS)&&(a.fallbackNS=[a.fallbackNS]),a.supportedLngs&&a.supportedLngs.indexOf("cimode")<0&&(a.supportedLngs=a.supportedLngs.concat(["cimode"])),a),X=()=>{},et=a=>{Object.getOwnPropertyNames(Object.getPrototypeOf(a)).forEach(n=>{typeof a[n]=="function"&&(a[n]=a[n].bind(a))})};class Y extends se{constructor(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},n=arguments.length>1?arguments[1]:void 0;if(super(),this.options=Le(e),this.services={},this.logger=F,this.modules={external:[]},et(this),n&&!this.isInitialized&&!e.isClone){if(!this.options.initImmediate)return this.init(e,n),this;setTimeout(()=>{this.init(e,n)},0)}}init(){var e=this;let n=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},t=arguments.length>1?arguments[1]:void 0;this.isInitializing=!0,typeof n=="function"&&(t=n,n={}),!n.defaultNS&&n.defaultNS!==!1&&n.ns&&(b(n.ns)?n.defaultNS=n.ns:n.ns.indexOf("translation")<0&&(n.defaultNS=n.ns[0]));const i=Ce();this.options={...i,...this.options,...Le(n)},this.options.compatibilityAPI!=="v1"&&(this.options.interpolation={...i.interpolation,...this.options.interpolation}),n.keySeparator!==void 0&&(this.options.userDefinedKeySeparator=n.keySeparator),n.nsSeparator!==void 0&&(this.options.userDefinedNsSeparator=n.nsSeparator);const r=c=>c?typeof c=="function"?new c:c:null;if(!this.options.isClone){this.modules.logger?F.init(r(this.modules.logger),this.options):F.init(null,this.options);let c;this.modules.formatter?c=this.modules.formatter:typeof Intl<"u"&&(c=Yn);const x=new Ne(this.options);this.store=new qe(this.options.resources,this.options);const d=this.services;d.logger=F,d.resourceStore=this.store,d.languageUtils=x,d.pluralResolver=new Un(x,{prepend:this.options.pluralSeparator,compatibilityJSON:this.options.compatibilityJSON,simplifyPluralSuffix:this.options.simplifyPluralSuffix}),c&&(!this.options.interpolation.format||this.options.interpolation.format===i.interpolation.format)&&(d.formatter=r(c),d.formatter.init(d,this.options),this.options.interpolation.format=d.formatter.format.bind(d.formatter)),d.interpolator=new Qn(this.options),d.utils={hasLoadedNamespace:this.hasLoadedNamespace.bind(this)},d.backendConnector=new Xn(r(this.modules.backend),d.resourceStore,d,this.options),d.backendConnector.on("*",function($){for(var m=arguments.length,w=new Array(m>1?m-1:0),p=1;p<m;p++)w[p-1]=arguments[p];e.emit($,...w)}),this.modules.languageDetector&&(d.languageDetector=r(this.modules.languageDetector),d.languageDetector.init&&d.languageDetector.init(d,this.options.detection,this.options)),this.modules.i18nFormat&&(d.i18nFormat=r(this.modules.i18nFormat),d.i18nFormat.init&&d.i18nFormat.init(this)),this.translator=new ie(this.services,this.options),this.translator.on("*",function($){for(var m=arguments.length,w=new Array(m>1?m-1:0),p=1;p<m;p++)w[p-1]=arguments[p];e.emit($,...w)}),this.modules.external.forEach($=>{$.init&&$.init(this)})}if(this.format=this.options.interpolation.format,t||(t=X),this.options.fallbackLng&&!this.services.languageDetector&&!this.options.lng){const c=this.services.languageUtils.getFallbackCodes(this.options.fallbackLng);c.length>0&&c[0]!=="dev"&&(this.options.lng=c[0])}!this.services.languageDetector&&!this.options.lng&&this.logger.warn("init: no languageDetector is used and no lng is defined"),["getResource","hasResourceBundle","getResourceBundle","getDataByLanguage"].forEach(c=>{this[c]=function(){return e.store[c](...arguments)}}),["addResource","addResources","addResourceBundle","removeResourceBundle"].forEach(c=>{this[c]=function(){return e.store[c](...arguments),e}});const h=V(),f=()=>{const c=(x,d)=>{this.isInitializing=!1,this.isInitialized&&!this.initializedStoreOnce&&this.logger.warn("init: i18next is already initialized. You should call init just once!"),this.isInitialized=!0,this.options.isClone||this.logger.log("initialized",this.options),this.emit("initialized",this.options),h.resolve(d),t(x,d)};if(this.languages&&this.options.compatibilityAPI!=="v1"&&!this.isInitialized)return c(null,this.t.bind(this));this.changeLanguage(this.options.lng,c)};return this.options.resources||!this.options.initImmediate?f():setTimeout(f,0),h}loadResources(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:X;const i=b(e)?e:this.language;if(typeof e=="function"&&(t=e),!this.options.resources||this.options.partialBundledLanguages){if(i&&i.toLowerCase()==="cimode"&&(!this.options.preload||this.options.preload.length===0))return t();const r=[],s=o=>{if(!o||o==="cimode")return;this.services.languageUtils.toResolveHierarchy(o).forEach(f=>{f!=="cimode"&&r.indexOf(f)<0&&r.push(f)})};i?s(i):this.services.languageUtils.getFallbackCodes(this.options.fallbackLng).forEach(h=>s(h)),this.options.preload&&this.options.preload.forEach(o=>s(o)),this.services.backendConnector.load(r,this.options.ns,o=>{!o&&!this.resolvedLanguage&&this.language&&this.setResolvedLanguage(this.language),t(o)})}else t(null)}reloadResources(e,n,t){const i=V();return typeof e=="function"&&(t=e,e=void 0),typeof n=="function"&&(t=n,n=void 0),e||(e=this.languages),n||(n=this.options.ns),t||(t=X),this.services.backendConnector.reload(e,n,r=>{i.resolve(),t(r)}),i}use(e){if(!e)throw new Error("You are passing an undefined module! Please check the object you are passing to i18next.use()");if(!e.type)throw new Error("You are passing a wrong module! Please check the object you are passing to i18next.use()");return e.type==="backend"&&(this.modules.backend=e),(e.type==="logger"||e.log&&e.warn&&e.error)&&(this.modules.logger=e),e.type==="languageDetector"&&(this.modules.languageDetector=e),e.type==="i18nFormat"&&(this.modules.i18nFormat=e),e.type==="postProcessor"&&Me.addPostProcessor(e),e.type==="formatter"&&(this.modules.formatter=e),e.type==="3rdParty"&&this.modules.external.push(e),this}setResolvedLanguage(e){if(!(!e||!this.languages)&&!(["cimode","dev"].indexOf(e)>-1))for(let n=0;n<this.languages.length;n++){const t=this.languages[n];if(!(["cimode","dev"].indexOf(t)>-1)&&this.store.hasLanguageSomeTranslations(t)){this.resolvedLanguage=t;break}}}changeLanguage(e,n){var t=this;this.isLanguageChangingTo=e;const i=V();this.emit("languageChanging",e);const r=h=>{this.language=h,this.languages=this.services.languageUtils.toResolveHierarchy(h),this.resolvedLanguage=void 0,this.setResolvedLanguage(h)},s=(h,f)=>{f?(r(f),this.translator.changeLanguage(f),this.isLanguageChangingTo=void 0,this.emit("languageChanged",f),this.logger.log("languageChanged",f)):this.isLanguageChangingTo=void 0,i.resolve(function(){return t.t(...arguments)}),n&&n(h,function(){return t.t(...arguments)})},o=h=>{!e&&!h&&this.services.languageDetector&&(h=[]);const f=b(h)?h:this.services.languageUtils.getBestMatchFromCodes(h);f&&(this.language||r(f),this.translator.language||this.translator.changeLanguage(f),this.services.languageDetector&&this.services.languageDetector.cacheUserLanguage&&this.services.languageDetector.cacheUserLanguage(f)),this.loadResources(f,c=>{s(c,f)})};return!e&&this.services.languageDetector&&!this.services.languageDetector.async?o(this.services.languageDetector.detect()):!e&&this.services.languageDetector&&this.services.languageDetector.async?this.services.languageDetector.detect.length===0?this.services.languageDetector.detect().then(o):this.services.languageDetector.detect(o):o(e),i}getFixedT(e,n,t){var i=this;const r=function(s,o){let h;if(typeof o!="object"){for(var f=arguments.length,c=new Array(f>2?f-2:0),x=2;x<f;x++)c[x-2]=arguments[x];h=i.options.overloadTranslationOptionHandler([s,o].concat(c))}else h={...o};h.lng=h.lng||r.lng,h.lngs=h.lngs||r.lngs,h.ns=h.ns||r.ns,h.keyPrefix!==""&&(h.keyPrefix=h.keyPrefix||t||r.keyPrefix);const d=i.options.keySeparator||".";let $;return h.keyPrefix&&Array.isArray(s)?$=s.map(m=>`${h.keyPrefix}${d}${m}`):$=h.keyPrefix?`${h.keyPrefix}${d}${s}`:s,i.t($,h)};return b(e)?r.lng=e:r.lngs=e,r.ns=n,r.keyPrefix=t,r}t(){return this.translator&&this.translator.translate(...arguments)}exists(){return this.translator&&this.translator.exists(...arguments)}setDefaultNamespace(e){this.options.defaultNS=e}hasLoadedNamespace(e){let n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};if(!this.isInitialized)return this.logger.warn("hasLoadedNamespace: i18next was not initialized",this.languages),!1;if(!this.languages||!this.languages.length)return this.logger.warn("hasLoadedNamespace: i18n.languages were undefined or empty",this.languages),!1;const t=n.lng||this.resolvedLanguage||this.languages[0],i=this.options?this.options.fallbackLng:!1,r=this.languages[this.languages.length-1];if(t.toLowerCase()==="cimode")return!0;const s=(o,h)=>{const f=this.services.backendConnector.state[`${o}|${h}`];return f===-1||f===0||f===2};if(n.precheck){const o=n.precheck(this,s);if(o!==void 0)return o}return!!(this.hasResourceBundle(t,e)||!this.services.backendConnector.backend||this.options.resources&&!this.options.partialBundledLanguages||s(t,e)&&(!i||s(r,e)))}loadNamespaces(e,n){const t=V();return this.options.ns?(b(e)&&(e=[e]),e.forEach(i=>{this.options.ns.indexOf(i)<0&&this.options.ns.push(i)}),this.loadResources(i=>{t.resolve(),n&&n(i)}),t):(n&&n(),Promise.resolve())}loadLanguages(e,n){const t=V();b(e)&&(e=[e]);const i=this.options.preload||[],r=e.filter(s=>i.indexOf(s)<0&&this.services.languageUtils.isSupportedCode(s));return r.length?(this.options.preload=i.concat(r),this.loadResources(s=>{t.resolve(),n&&n(s)}),t):(n&&n(),Promise.resolve())}dir(e){if(e||(e=this.resolvedLanguage||(this.languages&&this.languages.length>0?this.languages[0]:this.language)),!e)return"rtl";const n=["ar","shu","sqr","ssh","xaa","yhd","yud","aao","abh","abv","acm","acq","acw","acx","acy","adf","ads","aeb","aec","afb","ajp","apc","apd","arb","arq","ars","ary","arz","auz","avl","ayh","ayl","ayn","ayp","bbz","pga","he","iw","ps","pbt","pbu","pst","prp","prd","ug","ur","ydd","yds","yih","ji","yi","hbo","men","xmn","fa","jpr","peo","pes","prs","dv","sam","ckb"],t=this.services&&this.services.languageUtils||new Ne(Ce());return n.indexOf(t.getLanguagePartFromCode(e))>-1||e.toLowerCase().indexOf("-arab")>1?"rtl":"ltr"}static createInstance(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},n=arguments.length>1?arguments[1]:void 0;return new Y(e,n)}cloneInstance(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:X;const t=e.forkResourceStore;t&&delete e.forkResourceStore;const i={...this.options,...e,isClone:!0},r=new Y(i);return(e.debug!==void 0||e.prefix!==void 0)&&(r.logger=r.logger.clone(e)),["store","services","language"].forEach(o=>{r[o]=this[o]}),r.services={...this.services},r.services.utils={hasLoadedNamespace:r.hasLoadedNamespace.bind(r)},t&&(r.store=new qe(this.store.data,i),r.services.resourceStore=r.store),r.translator=new ie(r.services,i),r.translator.on("*",function(o){for(var h=arguments.length,f=new Array(h>1?h-1:0),c=1;c<h;c++)f[c-1]=arguments[c];r.emit(o,...f)}),r.init(i,n),r.translator.options=i,r.translator.backendConnector.services.utils={hasLoadedNamespace:r.hasLoadedNamespace.bind(r)},r}toJSON(){return{options:this.options,store:this.store,language:this.language,languages:this.languages,resolvedLanguage:this.resolvedLanguage}}}const L=Y.createInstance();L.createInstance=Y.createInstance;L.createInstance;L.dir;L.init;L.loadResources;L.reloadResources;L.use;L.changeLanguage;L.getFixedT;L.t;L.exists;L.setDefaultNamespace;L.hasLoadedNamespace;L.loadNamespaces;L.loadLanguages;const nt={title:"NumCalc",subtitle:"Numerical Differentiation & Integration",tagline:"Learn it. Play with it. Test yourself.",footer:"Built for Chapter 7 · Numerical Analysis"},tt={home:"Home",lessons:"Lessons",playground:"Playground",quiz:"Quiz"},at={toggle:"Toggle theme",light:"Light",dark:"Dark"},rt={label:"Language",en:"English",hu:"Magyar"},it={heading:"Numerical Calculus, made interactive",lead:"Read the chapter with beautifully typeset math, experiment with the real difference and quadrature formulas, then quiz yourself — in English or Hungarian.",cta_lessons:"Start reading",cta_playground:"Open the playground",card_lessons_title:"Lessons",card_lessons_desc:"Sections 7.1–7.4 with rendered formulas and tables.",card_playground_title:"Playground",card_playground_desc:"Tweak step sizes and methods; watch the error live.",card_quiz_title:"Quiz",card_quiz_desc:"Check your understanding with instant feedback."},ot={title:"Lessons",intro:"Pick a section to read.",loading:"Loading lesson…",error:"Could not load this lesson.",back:"All lessons",read:"Read"},st={title:"Interactive playground",lead:"Choose a function and a method, then drag the sliders.",tab_diff:"Differentiation",tab_int:"Integration",function:"Function f(x)",custom:"Custom expression",custom_hint:"Use x as the variable, e.g. exp(x) * sin(x)",method:"Method",x0:"Point x₀",h:"Step size h",a:"Lower limit a",b:"Upper limit b",n:"Subintervals n",approx:"Approximation",reference:"Reference (exact)",error:"Absolute error",invalid:"Invalid expression — check your syntax.",methods:{forward:"Forward difference (1st order)",backward:"Backward difference (1st order)",central:"Central difference (2nd order)","five-point":"5-point central (4th order)",second:"Second derivative",trapezoid:"Composite trapezoidal",simpson:"Composite Simpson",gauss2:"Gauss 2-point",gauss3:"Gauss 3-point",gauss4:"Gauss 4-point",gauss5:"Gauss 5-point"},computing_derivative:"Approximating f{order}(x₀)",computing_integral:"Approximating ∫f(x) dx"},lt={title:"Quiz",lead:"Answer the questions — you get instant feedback.",start:"Start quiz",loading:"Loading questions…",question:"Question",of:"of",score:"Score",streak:"Streak",check:"Check",next:"Next",finish:"See results",true:"True",false:"False",your_answer:"Your answer",correct:"Correct!",incorrect:"Not quite.",numeric_placeholder:"Type a number",results_title:"Your results",results_score:"You scored {{correct}} / {{total}}",retry:"Try again",to_lessons:"Review the lessons",topic:"Topic"},ft={app:nt,nav:tt,theme:at,lang:rt,home:it,lessons:ot,playground:st,quiz:lt},ht={title:"NumCalc",subtitle:"Numerikus differenciálás és integrálás",tagline:"Tanuld meg. Játssz vele. Teszteld magad.",footer:"A 7. fejezethez · Numerikus analízis"},dt={home:"Kezdőlap",lessons:"Leckék",playground:"Játéktér",quiz:"Kvíz"},ct={toggle:"Téma váltása",light:"Világos",dark:"Sötét"},xt={label:"Nyelv",en:"English",hu:"Magyar"},$t={heading:"A numerikus analízis, interaktívan",lead:"Olvasd a fejezetet szépen szedett képletekkel, kísérletezz a valódi differencia- és kvadratúraképletekkel, majd teszteld magad — angolul vagy magyarul.",cta_lessons:"Kezdj olvasni",cta_playground:"Nyisd meg a játékteret",card_lessons_title:"Leckék",card_lessons_desc:"7.1–7.4. szakaszok képletekkel és táblázatokkal.",card_playground_title:"Játéktér",card_playground_desc:"Állítsd a lépésközt és a módszert; nézd a hibát élőben.",card_quiz_title:"Kvíz",card_quiz_desc:"Ellenőrizd a tudásod azonnali visszajelzéssel."},ut={title:"Leckék",intro:"Válassz egy szakaszt olvasásra.",loading:"Lecke betöltése…",error:"Nem sikerült betölteni ezt a leckét.",back:"Összes lecke",read:"Olvasás"},pt={title:"Interaktív játéktér",lead:"Válassz függvényt és módszert, majd húzd a csúszkákat.",tab_diff:"Differenciálás",tab_int:"Integrálás",function:"Függvény f(x)",custom:"Egyéni kifejezés",custom_hint:"Használd az x változót, pl. exp(x) * sin(x)",method:"Módszer",x0:"Pont x₀",h:"Lépésköz h",a:"Alsó határ a",b:"Felső határ b",n:"Részintervallumok n",approx:"Közelítés",reference:"Referencia (pontos)",error:"Abszolút hiba",invalid:"Hibás kifejezés — ellenőrizd a szintaxist.",methods:{forward:"Jobb oldali differencia (1. rendű)",backward:"Bal oldali differencia (1. rendű)",central:"Centrális differencia (2. rendű)","five-point":"5-pontos centrális (4. rendű)",second:"Második derivált",trapezoid:"Összetett trapéz",simpson:"Összetett Simpson",gauss2:"Gauss 2-pontos",gauss3:"Gauss 3-pontos",gauss4:"Gauss 4-pontos",gauss5:"Gauss 5-pontos"},computing_derivative:"f{order}(x₀) közelítése",computing_integral:"∫f(x) dx közelítése"},mt={title:"Kvíz",lead:"Válaszolj a kérdésekre — azonnali visszajelzést kapsz.",start:"Kvíz indítása",loading:"Kérdések betöltése…",question:"Kérdés",of:"/",score:"Pontszám",streak:"Sorozat",check:"Ellenőrzés",next:"Következő",finish:"Eredmények",true:"Igaz",false:"Hamis",your_answer:"A válaszod",correct:"Helyes!",incorrect:"Nem egészen.",numeric_placeholder:"Írj be egy számot",results_title:"Az eredményed",results_score:"Eredményed: {{correct}} / {{total}}",retry:"Újra",to_lessons:"Nézd át a leckéket",topic:"Téma"},gt={app:ht,nav:dt,theme:ct,lang:xt,home:$t,lessons:ut,playground:pt,quiz:mt},Ge="numcalc-lang";function _t(){var a;try{const e=localStorage.getItem(Ge);if(e==="en"||e==="hu")return e;if((a=navigator.language)!=null&&a.toLowerCase().startsWith("hu"))return"hu"}catch{}return"en"}L.use(jn).init({resources:{en:{translation:ft},hu:{translation:gt}},lng:_t(),fallbackLng:"en",interpolation:{escapeValue:!1}});L.on("languageChanged",a=>{try{localStorage.setItem(Ge,a),document.documentElement.setAttribute("lang",a)}catch{}});document.documentElement.setAttribute("lang",L.language);const bt=`## 7.1. Numerical differentiation
...
`,kt=`## 7.2. Richardson's extrapolation
...
`,wt=`## 7.1. Numerikus differenciálás
...
`,qt=`## 7.2. Richardson-extrapoláció
...
`,Nt=`## 7.4. Gauss-féle kvadratúra formulák
...
`,Bt=`function simpson(f, a, b, n = 100)
    isodd(n) && (n += 1)
    h = (b - a) / n
    s = f(a) + f(b)
    for i in 1:n-1
...
`,Ht=`// Composite Simpson's rule (n forced even) on [a, b].
...
`,Qt=`# Composite Simpson's rule (n forced even) on [a, b].
...
`,Jt=`// Composite Simpson's rule (n forced even).
...
`,Yt=`simpson[f_, a_, b_, nIn_ : 100] := Module[{n = nIn, h},
   If[OddQ[n], n++];
   h = (b - a)/n;
...
`,na=`function trapezoid(f, a, b, n = 100)
    h = (b - a) / n
    s = (f(a) + f(b)) / 2
    for i in 1:n-1
        s += f(a + i*h)
...
`,ta=`// Composite trapezoidal rule for the integral of f on [a, b].
...
`,aa=`function I = trapezoid(f, a, b, n)
...
`,ia=`# Composite trapezoidal rule for the integral of f on [a, b].
...
`,sa=`trapezoid[f_, a_, b_, n_ : 100] := Module[{h = (b - a)/n},
   h (f[a]/2 + f[b]/2 + Sum[f[a + i h], {i, 1, n - 1}])];
Print["int_0^1 e^x dx = ", trapezoid[Exp, 0., 1., 100]]
`,la=Object.assign({"./simpson.cpp":Mt,"./simpson.f90":Gt,"./simpson.go":Dt,"./simpson.jl":Bt,"./simpson.js":Ht,"./simpson.m":Vt,"./simpson.py":Ut,"./simpson.r":Qt,"./simpson.rs":Jt,"./simpson.wl":Yt,"./trapezoid.cpp":Zt,"./trapezoid.f90":Xt,"./trapezoid.go":ea,"./trapezoid.jl":na,"./trapezoid.js":ta,"./trapezoid.m":aa,"./trapezoid.py":ra,"./trapezoid.r":ia,"./trapezoid.rs":oa,"./trapezoid.wl":sa}),R=(a,e)=>la[`./${a}.${e}`],fa={trapezoid:{en:"Composite trapezoidal rule",hu:"Összetett trapéz-szabály"},simpson:{en:"Composite Simpson's rule",hu:"Összetett Simpson-szabály"}},ha=a=>({id:a,caption:fa[a],snippets:{matlab:R(a,"m"),python:R(a,"py"),cpp:R(a,"cpp"),julia:R(a,"jl"),rust:R(a,"rs"),fortran:R(a,"f90"),wolfram:R(a,"wl"),javascript:R(a,"js"),go:R(a,"go"),r:R(a,"r")}}),da={"7_3":["trapezoid","simpson"]};function ca(a){return(da[a]??[]).map(ha)}function xa({slug:a}={}){const e=nn(),n=a??e.slug??"",t=a!=null,{t:i,i18n:r}=A(),s=r.language==="hu"?"hu":"en",[o,h]=k.useState(null),[f,c]=k.useState("loading");return k.useEffect(()=>{let x=!0;return c("loading"),Et(n,s).then(d=>{x&&(h(d),c("ok"))}).catch(()=>x&&c("error")),()=>{x=!1}},[n,s]),l.jsxs("article",{children:[!t&&l.jsxs(Re,{to:"/numerical-calculus/lessons",className:"text-sm font-semibold text-brand-600 hover:underline dark:text-brand-300",children:["← ",i("lessons.back")]}),f==="loading"&&l.jsx("p",{className:"mt-6 text-slate-500",children:i("lessons.loading")}),f==="error"&&l.jsx("p",{className:"mt-6 text-rose-600",children:i("lessons.error")}),f==="ok"&&o&&l.jsx(J.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},className:"card mt-4",children:l.jsx(oe,{markdown:o.markdown})},o.slug+s),f==="ok"&&o&&ca(o.slug).map(x=>l.jsx(fn,{snippets:x.snippets,caption:x.caption},x.id)),f==="ok"&&o&&l.jsxs(l.Fragment,{children:[l.jsx(Ft,{slug:o.slug}),l.jsx(Wt,{slug:o.slug})]})]})}const $a=(a,e,n)=>(a(e+n)-a(e))/n,ua=(a,e,n)=>(a(e)-a(e-n))/n,pa=(a,e,n)=>(a(e+n)-a(e-n))/(2*n),ma=(a,e,n)=>(a(e-n)-2*a(e)+a(e+n))/(n*n),Ve=(a,e,n)=>(a(e-2*n)-8*a(e-n)+8*a(e+n)-a(e+2*n))/(12*n),Pe={forward:{id:"forward",order:1,apply:$a},backward:{id:"backward",order:1,apply:ua},central:{id:"central",order:1,apply:pa},"five-point":{id:"five-point",order:1,apply:Ve},second:{id:"second",order:2,apply:ma}};function ga(a,e,n,t){const i=(n-e)/t;let r=.5*(a(e)+a(n));for(let s=1;s<t;s++)r+=a(e+s*i);return r*i}function Ue(a,e,n,t){const i=t%2===0?t:t+1,r=(n-e)/i;let s=a(e)+a(n);for(let o=1;o<i;o++)s+=(o%2===0?2:4)*a(e+o*r);return s*r/3}const Qe={2:{nodes:[-.5773502692,.5773502692],weights:[1,1]},3:{nodes:[-.7745966692,0,.7745966692],weights:[.5555555556,.8888888889,.5555555556]},4:{nodes:[-.8611363116,-.3399810436,.3399810436,.8611363116],weights:[.3478548451,.6521451549,.6521451549,.3478548451]},5:{nodes:[-.9061798459,-.5384693101,0,.5384693101,.9061798459],weights:[.236926885,.4786286705,.5688888889,.4786286705,.236926885]}};function ne(a,e,n,t){const{nodes:i,weights:r}=Qe[t],s=(n-e)/2,o=(e+n)/2;let h=0;for(let f=0;f<i.length;f++)h+=r[f]*a(s*i[f]+o);return s*h}const Ee={trapezoid:{id:"trapezoid",usesN:!0,apply:ga},simpson:{id:"simpson",usesN:!0,apply:Ue},gauss2:{id:"gauss2",usesN:!1,apply:(a,e,n)=>ne(a,e,n,2)},gauss3:{id:"gauss3",usesN:!1,apply:(a,e,n)=>ne(a,e,n,3)},gauss4:{id:"gauss4",usesN:!1,apply:(a,e,n)=>ne(a,e,n,4)},gauss5:{id:"gauss5",usesN:!1,apply:(a,e,n)=>ne(a,e,n,5)}};function _a(a,e,n,t=4e3){return Ue(a,e,n,t)}const Je=(a,e)=>Math.abs(a-e),ue=$n(un,{}),Oe=[{id:"exp_x2x",latex:"e^{x^2+x}",expr:"exp(x^2 + x)"},{id:"exp_x",latex:"e^{x}",expr:"exp(x)"},{id:"x2_exp_x",latex:"x^2 e^{x}",expr:"x^2 * exp(x)"},{id:"sin",latex:"\\sin x",expr:"sin(x)"},{id:"poly",latex:"x^4 - 6x^2 + 3x",expr:"x^4 - 6*x^2 + 3*x"},{id:"exp_sin",latex:"e^{x}\\sin x",expr:"exp(x) * sin(x)"}];function pe(a){try{const e=ue.parse(a),n=e.compile(),t=r=>{const s=n.evaluate({x:r});return typeof s=="number"?s:Number(s)},i=t(.123);return Number.isFinite(i),{f:t,ok:!0,node:e}}catch(e){return{f:()=>NaN,ok:!1,error:e instanceof Error?e.message:String(e)}}}function ba(a,e,n){try{let r=ue.parse(a);for(let f=0;f<n;f++)r=ue.derivative(r,"x");const o=r.compile().evaluate({x:e}),h=typeof o=="number"?o:Number(o);if(Number.isFinite(h))return h}catch{}const{f:t}=pe(a),i=1e-4;return n===1?Ve(t,e,i):(t(e-i)-2*t(e)+t(e+i))/(i*i)}function Q({label:a,value:e,min:n,max:t,step:i,onChange:r,format:s}){return l.jsxs("label",{className:"block",children:[l.jsxs("div",{className:"mb-1 flex items-baseline justify-between",children:[l.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a}),l.jsx("span",{className:"font-mono text-sm font-semibold text-brand-700 dark:text-brand-300",children:s?s(e):e})]}),l.jsx("input",{type:"range",min:n,max:t,step:i,value:e,onChange:o=>r(Number(o.target.value)),className:"h-2 w-full cursor-pointer appearance-none rounded-full bg-slate-200 accent-brand-600 dark:bg-slate-700"})]})}const E={top:12,right:12,bottom:24,left:36};function Ye({f:a,xMin:e,xMax:n,width:t=520,height:i=300,segments:r=[],areas:s=[],points:o=[]}){const{curve:h,x:f,y:c,yMin:x,yMax:d}=k.useMemo(()=>{const u=[],z=[];for(let _=0;_<=240;_++){const v=e+(n-e)*_/240;u.push(v),z.push(a(v))}const y=z.filter(_=>Number.isFinite(_));for(const _ of s)for(const[,v]of _.points)y.push(v);for(const _ of r)for(const[,v]of _.points)y.push(v);for(const _ of o)y.push(_.y);let g=Math.min(...y,0),q=Math.max(...y,0);(!Number.isFinite(g)||!Number.isFinite(q)||g===q)&&(g=-1,q=1);const j=(q-g)*.1||1;g-=j,q+=j;const N=_e().domain([e,n]).range([E.left,t-E.right]),S=_e().domain([g,q]).range([i-E.bottom,E.top]);let C="",T=!1;for(let _=0;_<=240;_++){const v=z[_];if(!Number.isFinite(v)){T=!1;continue}const P=N(u[_]),I=S(v);C+=`${T?"L":"M"}${P.toFixed(2)},${I.toFixed(2)} `,T=!0}return{curve:C,x:N,y:S,yMin:g,yMax:q}},[a,e,n,t,i,s,r,o]),$=p=>p.map((u,z)=>`${z?"L":"M"}${f(u[0]).toFixed(2)},${c(u[1]).toFixed(2)}`).join(" "),m=x<0&&d>0?c(0):null,w=e<0&&n>0?f(0):null;return l.jsxs("svg",{viewBox:`0 0 ${t} ${i}`,className:"h-auto w-full text-slate-400 dark:text-slate-500",role:"img",children:[l.jsx("rect",{x:E.left,y:E.top,width:t-E.left-E.right,height:i-E.top-E.bottom,className:"fill-transparent stroke-slate-200 dark:stroke-slate-700"}),m!==null&&l.jsx("line",{x1:E.left,x2:t-E.right,y1:m,y2:m,stroke:"currentColor",strokeWidth:1}),w!==null&&l.jsx("line",{x1:w,x2:w,y1:E.top,y2:i-E.bottom,stroke:"currentColor",strokeWidth:1}),s.map((p,u)=>l.jsx("path",{d:`${$(p.points)} Z`,fill:p.color??"#06b6d4",fillOpacity:.22,stroke:p.color??"#06b6d4",strokeOpacity:.5,strokeWidth:1},`a${u}`)),l.jsx("path",{d:h,fill:"none",stroke:"#6366f1",strokeWidth:2.5,strokeLinejoin:"round"}),r.map((p,u)=>l.jsx("path",{d:$(p.points),fill:"none",stroke:p.color??"#f59e0b",strokeWidth:2,strokeDasharray:p.dashed?"5 4":void 0},`s${u}`)),o.map((p,u)=>l.jsx("circle",{cx:f(p.x),cy:c(p.y),r:4,fill:p.color??"#f59e0b",stroke:"#fff",strokeWidth:1.5},`p${u}`)),l.jsx("text",{x:E.left,y:i-6,className:"fill-slate-500 text-[10px]",children:e}),l.jsx("text",{x:t-E.right,y:i-6,textAnchor:"end",className:"fill-slate-500 text-[10px]",children:n})]})}function ka({tex:a,display:e=!1,className:n}){const t=k.useMemo(()=>{try{return hn.renderToString(a,{displayMode:e,throwOnError:!1})}catch{return a}},[a,e]);return l.jsx("span",{className:n,dangerouslySetInnerHTML:{__html:t}})}function Ze({expr:a,onChange:e,valid:n}){const{t}=A(),i=Oe.find(r=>r.expr===a);return l.jsxs("div",{children:[l.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:t("playground.function")}),l.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:Oe.map(r=>l.jsx("button",{type:"button",onClick:()=>e(r.expr),className:`chip border transition ${(i==null?void 0:i.id)===r.id?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:l.jsx(ka,{tex:r.latex})},r.id))}),l.jsxs("label",{className:"mt-3 block",children:[l.jsx("span",{className:"text-xs uppercase tracking-wide text-slate-400",children:t("playground.custom")}),l.jsx("input",{type:"text",value:a,spellCheck:!1,onChange:r=>e(r.target.value),className:`mt-1 w-full rounded-xl border bg-white px-3 py-2 font-mono text-sm outline-none transition dark:bg-slate-800 ${n?"border-slate-200 focus:border-brand-400 dark:border-slate-700":"border-rose-400 focus:border-rose-500"}`})]}),n?l.jsx("p",{className:"mt-1 text-xs text-slate-400",children:t("playground.custom_hint")}):l.jsx("p",{className:"mt-1 text-xs text-rose-500",children:t("playground.invalid")})]})}const Ae=a=>Number.isFinite(a)?a.toPrecision(7):"—",ya=a=>Number.isFinite(a)?a.toExponential(4):"—";function Xe({approx:a,reference:e,error:n}){const{t}=A(),i=[{label:t("playground.approx"),value:Ae(a),accent:!0},{label:t("playground.reference"),value:Ae(e),accent:!1},{label:t("playground.error"),value:ya(n),accent:!1}];return l.jsx("dl",{className:"grid gap-2",children:i.map(r=>l.jsxs("div",{className:"flex items-center justify-between rounded-xl bg-slate-100 px-4 py-2 dark:bg-slate-800/70",children:[l.jsx("dt",{className:"text-sm text-slate-500 dark:text-slate-400",children:r.label}),l.jsx("dd",{className:`font-mono text-sm font-semibold ${r.accent?"text-brand-700 dark:text-brand-300":"text-slate-800 dark:text-slate-100"}`,children:r.value})]},r.label))})}const va=["forward","backward","central","five-point","second"];function za(){const{t:a}=A(),[e,n]=k.useState("exp(x^2 + x)"),[t,i]=k.useState("central"),[r,s]=k.useState(0),[o,h]=k.useState(.1),f=k.useMemo(()=>pe(e),[e]),c=Pe[t].order,{approx:x,reference:d,error:$,segments:m,points:w}=k.useMemo(()=>{if(!f.ok)return{approx:NaN,reference:NaN,error:NaN,segments:[],points:[]};const u=f.f,z=Pe[t].apply(u,r,o),y=ba(e,r,c),g=Je(z,y),q=[],j=[],N=u(r);if(j.push({x:r,y:N,color:"#ef4444"}),c===1){const S=Math.max(2*o,1),C=r-S,T=r+S;q.push({points:[[C,N+y*(C-r)],[T,N+y*(T-r)]],color:"#10b981",dashed:!0}),t==="central"||t==="five-point"?(j.push({x:r-o,y:u(r-o)},{x:r+o,y:u(r+o)}),q.push({points:[[r-o,u(r-o)],[r+o,u(r+o)]],color:"#f59e0b"})):t==="forward"?(j.push({x:r+o,y:u(r+o)}),q.push({points:[[r,N],[r+o,u(r+o)]],color:"#f59e0b"})):(j.push({x:r-o,y:u(r-o)}),q.push({points:[[r-o,u(r-o)],[r,N]],color:"#f59e0b"}))}else j.push({x:r-o,y:u(r-o)},{x:r+o,y:u(r+o)});return{approx:z,reference:y,error:g,segments:q,points:j}},[f,t,r,o,e,c]),p=Math.max(2.5*o,1.5);return l.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[l.jsxs("div",{className:"card space-y-4",children:[l.jsx(Ze,{expr:e,onChange:n,valid:f.ok}),l.jsxs("div",{children:[l.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),l.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:va.map(u=>l.jsx("button",{type:"button",onClick:()=>i(u),className:`chip border transition ${t===u?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${u}`)},u))})]}),l.jsx(Q,{label:a("playground.x0"),value:r,min:-3,max:3,step:.1,onChange:s,format:u=>u.toFixed(2)}),l.jsx(Q,{label:a("playground.h"),value:o,min:.01,max:1,step:.01,onChange:h,format:u=>u.toFixed(2)}),l.jsx(Xe,{approx:x,reference:d,error:$})]}),l.jsxs("div",{className:"card",children:[l.jsx(Ye,{f:f.f,xMin:r-p,xMax:r+p,segments:m,points:w}),l.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),c===1&&l.jsxs(l.Fragment,{children:[l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-1 w-4 rounded bg-amber-500"})," ",a("playground.approx")]}),l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-1 w-4 rounded bg-emerald-500"})," ",a("playground.reference")]})]})]})]})]})}const wa=["trapezoid","simpson","gauss2","gauss3","gauss4","gauss5"];function qa(){const{t:a}=A(),[e,n]=k.useState("x^2 * exp(x)"),[t,i]=k.useState("simpson"),[r,s]=k.useState(0),[o,h]=k.useState(1),[f,c]=k.useState(4),x=k.useMemo(()=>pe(e),[e]),d=Ee[t].usesN,{approx:$,reference:m,error:w,areas:p,points:u}=k.useMemo(()=>{if(!x.ok||o<=r)return{approx:NaN,reference:NaN,error:NaN,areas:[],points:[]};const y=x.f,g=Ee[t].apply(y,r,o,f),q=_a(y,r,o),j=Je(g,q),N=[],S=[];if(t==="trapezoid"){const C=(o-r)/f;for(let T=0;T<f;T++){const _=r+T*C,v=_+C;N.push({points:[[_,0],[_,y(_)],[v,y(v)],[v,0]]})}}else{const C=[[r,0]],T=80;for(let _=0;_<=T;_++){const v=r+(o-r)*_/T;C.push([v,y(v)])}if(C.push([o,0]),N.push({points:C}),t.startsWith("gauss")){const _=Number(t.slice(5)),v=(o-r)/2,P=(r+o)/2;for(const I of Qe[_].nodes){const W=v*I+P;S.push({x:W,y:y(W),color:"#ef4444"})}}}return{approx:g,reference:q,error:j,areas:N,points:S}},[x,t,r,o,f]),z=(o-r)*.1||.2;return l.jsxs("div",{className:"grid gap-5 lg:grid-cols-2",children:[l.jsxs("div",{className:"card space-y-4",children:[l.jsx(Ze,{expr:e,onChange:n,valid:x.ok}),l.jsxs("div",{children:[l.jsx("span",{className:"text-sm font-medium text-slate-600 dark:text-slate-300",children:a("playground.method")}),l.jsx("div",{className:"mt-2 flex flex-wrap gap-2",children:wa.map(y=>l.jsx("button",{type:"button",onClick:()=>i(y),className:`chip border transition ${t===y?"border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-900/40 dark:text-brand-200":"border-slate-200 bg-white text-slate-600 hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"}`,children:a(`playground.methods.${y}`)},y))})]}),l.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[l.jsx(Q,{label:a("playground.a"),value:r,min:-3,max:3,step:.1,onChange:s,format:y=>y.toFixed(2)}),l.jsx(Q,{label:a("playground.b"),value:o,min:-3,max:4,step:.1,onChange:h,format:y=>y.toFixed(2)})]}),d&&l.jsx(Q,{label:a("playground.n"),value:f,min:2,max:20,step:t==="simpson"?2:1,onChange:c}),l.jsx(Xe,{approx:$,reference:m,error:w})]}),l.jsxs("div",{className:"card",children:[l.jsx(Ye,{f:x.f,xMin:r-z,xMax:o+z,areas:p,points:u}),l.jsxs("div",{className:"mt-3 flex flex-wrap gap-3 text-xs text-slate-500 dark:text-slate-400",children:[l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-1 w-4 rounded bg-brand-500"})," f(x)"]}),l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-3 w-4 rounded bg-accent-500/30"})," ∫ region"]}),t.startsWith("gauss")&&l.jsxs("span",{className:"flex items-center gap-1",children:[l.jsx("span",{className:"inline-block h-2 w-2 rounded-full bg-red-500"})," nodes"]})]})]})]})}function ja(){const{t:a}=A(),[e,n]=k.useState("diff");return l.jsxs("div",{children:[l.jsx("h1",{className:"text-3xl font-extrabold",children:a("playground.title")}),l.jsx("p",{className:"mt-1 text-slate-500 dark:text-slate-400",children:a("playground.lead")}),l.jsx("div",{className:"mt-5 inline-flex rounded-xl bg-slate-200 p-1 dark:bg-slate-800",children:["diff","int"].map(t=>l.jsx("button",{type:"button",onClick:()=>n(t),className:`rounded-lg px-4 py-2 text-sm font-semibold transition ${e===t?"bg-white text-brand-700 shadow dark:bg-slate-900 dark:text-brand-300":"text-slate-600 dark:text-slate-300"}`,children:a(t==="diff"?"playground.tab_diff":"playground.tab_int")},t))}),l.jsx("div",{className:"mt-5",children:e==="diff"?l.jsx(za,{}):l.jsx(qa,{})})]})}function Na({correct:a,total:e,onRetry:n}){const{t}=A(),i=e?Math.round(a/e*100):0,r=i>=80?"🏆":i>=50?"👍":"📚";return l.jsxs(J.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},className:"card text-center",children:[l.jsx("div",{className:"text-6xl",children:r}),l.jsx("h2",{className:"mt-3 text-2xl font-extrabold",children:t("quiz.results_title")}),l.jsx("p",{className:"mt-2 text-lg text-slate-600 dark:text-slate-300",children:t("quiz.results_score",{correct:a,total:e})}),l.jsx("div",{className:"mx-auto mt-4 h-3 w-full max-w-sm overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:l.jsx(J.div,{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500",initial:{width:0},animate:{width:`${i}%`},transition:{duration:.6}})}),l.jsxs("div",{className:"mt-6 flex flex-wrap justify-center gap-3",children:[l.jsx("button",{type:"button",onClick:n,className:"btn-primary",children:t("quiz.retry")}),l.jsx(Re,{to:"/numerical-calculus/lessons",className:"btn-ghost",children:t("quiz.to_lessons")})]})]})}function Sa(){var _;const{t:a,i18n:e}=A(),n=e.language==="hu"?"hu":"en",[t,i]=k.useState([]),[r,s]=k.useState(0),[o,h]=k.useState(""),[f,c]=k.useState(null),[x,d]=k.useState(0),[$,m]=k.useState(0),[w,p]=k.useState(!1),[u,z]=k.useState(!0);function y(v=t){s(0),h(""),c(null),d(0),m(0),p(!1)}if(k.useEffect(()=>{z(!0),Ot(n).then(v=>{i(v),y(v)}).finally(()=>z(!1))},[n]),u)return l.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(!t.length)return l.jsx("p",{className:"card text-slate-500",children:a("quiz.loading")});if(w)return l.jsx(Na,{correct:x,total:t.length,onRetry:()=>y()});const g=t[r],q=r===t.length-1,j=f!==null,N=o!==""&&!j;async function S(){if(o==="")return;const v=await At(g.id,o,n);c(v),v.correct?(d(P=>P+1),m(P=>P+1)):m(0)}function C(){if(q){p(!0);return}s(v=>v+1),h(""),c(null)}const T=(v,P)=>j?v?"border-emerald-500 bg-emerald-50 dark:bg-emerald-900/30":P?"border-rose-500 bg-rose-50 dark:bg-rose-900/30":"border-slate-200 bg-white opacity-60 dark:border-slate-700 dark:bg-slate-800":P?"border-brand-500 bg-brand-50 dark:bg-brand-900/40":"border-slate-200 bg-white hover:border-brand-300 dark:border-slate-700 dark:bg-slate-800";return l.jsxs("div",{className:"card",children:[l.jsxs("div",{className:"flex items-center justify-between text-sm",children:[l.jsxs("span",{className:"font-semibold text-slate-500 dark:text-slate-400",children:[a("quiz.question")," ",r+1," ",a("quiz.of")," ",t.length]}),l.jsxs("span",{className:"flex gap-3",children:[l.jsxs("span",{className:"chip bg-brand-100 text-brand-700 dark:bg-brand-900/50 dark:text-brand-200",children:[a("quiz.score"),": ",x]}),l.jsxs("span",{className:"chip bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-200",children:["🔥 ",$]})]})]}),l.jsx("div",{className:"mt-2 h-1.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700",children:l.jsx("div",{className:"h-full rounded-full bg-gradient-to-r from-brand-500 to-accent-500 transition-all",style:{width:`${(r+(j?1:0))/t.length*100}%`}})}),l.jsxs("span",{className:"mt-4 inline-block chip bg-slate-100 text-slate-500 dark:bg-slate-800 dark:text-slate-400",children:[a("quiz.topic")," ",g.topic]}),l.jsx(xn,{mode:"wait",children:l.jsxs(J.div,{initial:{opacity:0,x:16},animate:{opacity:1,x:0},exit:{opacity:0,x:-16},children:[l.jsx("h2",{className:"mt-3 text-lg font-semibold",children:g.prompt}),l.jsxs("div",{className:"mt-4 space-y-2",children:[g.type==="mcq"&&((_=g.options)==null?void 0:_.map((v,P)=>l.jsxs("button",{type:"button",disabled:j,onClick:()=>h(P),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${T((f==null?void 0:f.answer)===P,o===P)}`,children:[l.jsx("span",{className:"grid h-6 w-6 shrink-0 place-items-center rounded-full bg-slate-200 text-xs font-bold dark:bg-slate-700",children:String.fromCharCode(65+P)}),v]},P))),g.type==="truefalse"&&[!0,!1].map(v=>l.jsx("button",{type:"button",disabled:j,onClick:()=>h(v),className:`flex w-full items-center gap-3 rounded-xl border px-4 py-3 text-left transition ${T((f==null?void 0:f.answer)===v,o===v)}`,children:a(v?"quiz.true":"quiz.false")},String(v))),g.type==="numeric"&&l.jsx("input",{type:"number",step:"any",disabled:j,placeholder:a("quiz.numeric_placeholder"),value:o===""?"":String(o),onChange:v=>h(v.target.value===""?"":Number(v.target.value)),className:"w-full rounded-xl border border-slate-200 bg-white px-4 py-3 font-mono outline-none focus:border-brand-400 dark:border-slate-700 dark:bg-slate-800"})]}),j&&l.jsxs(J.div,{initial:{opacity:0,y:6},animate:{opacity:1,y:0},className:`mt-4 rounded-xl p-4 ${f!=null&&f.correct?"bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-200":"bg-rose-50 text-rose-800 dark:bg-rose-900/30 dark:text-rose-200"}`,children:[l.jsx("p",{className:"font-bold",children:f!=null&&f.correct?a("quiz.correct"):a("quiz.incorrect")}),l.jsx("p",{className:"mt-1 text-sm",children:f==null?void 0:f.explanation})]})]},g.id)}),l.jsx("div",{className:"mt-5 flex justify-end gap-3",children:j?l.jsx("button",{type:"button",onClick:C,className:"btn-primary",children:a(q?"quiz.finish":"quiz.next")}):l.jsx("button",{type:"button",disabled:!N,onClick:S,className:"btn-primary disabled:opacity-50",children:a("quiz.check")})})]})}function Ta(){const{t:a}=A();return l.jsxs("div",{children:[l.jsx("h1",{className:"text-3xl font-extrabold",children:a("quiz.title")}),l.jsx("p",{className:"mb-5 mt-1 text-slate-500 dark:text-slate-400",children:a("quiz.lead")}),l.jsx(Sa,{})]})}const Ca=`# Chapter 7: Exercise Solutions
...
$$P_{n+1}(x) = xP_n(x) - \\frac{n^2}{4n^2-1}P_{n-1}(x)$$
`,en=De,La=[...en.map(a=>({id:a.slug,no:a.id==="intro"?"7":a.id,title:a.title,blurb:{en:"",hu:""}})),{id:"playground",no:"7·pg",title:{en:"Playground",hu:"Játéktér"},blurb:{en:"",hu:""}},{id:"quiz",no:"7·qz",title:{en:"Quiz",hu:"Kvíz"},blurb:{en:"",hu:""}}];function Ia(){const a=tn(),{t:e}=A(),{lang:n}=an();k.useEffect(()=>{L.changeLanguage(n)},[n]),k.useEffect(()=>{let i=decodeURIComponent(a.hash.replace(/^#/,""));if(!i){const r=a.pathname.match(/\/lessons\/([^/]+)/);if(r)i=r[1];else{const s=a.pathname.split("/").filter(Boolean).pop()??"";["playground","quiz"].includes(s)&&(i=s)}}i&&requestAnimationFrame(()=>{var r;return(r=document.getElementById(i))==null?void 0:r.scrollIntoView()})},[a.pathname,a.hash]);const t={scrollMarginTop:"calc(var(--nav-h) + var(--scrolly-topbar-h, 44px) + 8px)"};return l.jsxs("div",{className:"flex min-h-screen flex-col",children:[l.jsx(dn,{sections:La}),l.jsxs("main",{className:"mx-auto w-full max-w-5xl flex-1 space-y-16 px-4 py-8",children:[en.map(i=>l.jsx("section",{id:i.slug,style:t,children:l.jsx(xa,{slug:i.slug})},i.slug)),l.jsx("section",{id:"playground",style:t,children:l.jsx(ja,{})}),l.jsx("section",{id:"quiz",style:t,children:l.jsx(Ta,{})})]}),l.jsx("footer",{className:"border-t border-slate-200 py-6 text-center text-sm text-slate-400 dark:border-slate-800",children:e("app.footer")}),l.jsx(cn,{markdown:Ca})]})}export{Ia as default};
