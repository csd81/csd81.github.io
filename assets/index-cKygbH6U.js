...
**Reciprocal model $y=1/(a+bx)$.** Linearize as $1/y=a+bx$ and fit a line to $(x_i,1/y_i)$; e.g. data $x_i:1,\\dots,5$, $\\ y_i:0.50,0.33,0.25,0.20,0.17$ transform to $Y_i:2.00,3.03,4.00,5.00,5.88$, giving $Y=0.98+0.99X$, hence $y\\approx1/(1+x)$.`},{type:"glossary",deck:"nonlinear"},{type:"flashcards",deck:"nonlinear"},{type:"quiz",ref:"nonlinear"}]},Xe=[_t,zt,vt,wt];Xe.map(a=>a.id);const Qe="lsq.progress",qt=new Set,Ne=()=>({completed:{},xp:0});let X=(()=>{try{const a=localStorage.getItem(Qe);if(a)return{...Ne(),...JSON.parse(a)}}catch{}return Ne()})();function jt(){try{localStorage.setItem(Qe,JSON.stringify(X))}catch{}qt.forEach(a=>a(X))}function At(a){return!!X.completed[a]}function Ft(a,n=50){X.completed[a]||(X.completed[a]=!0,X.xp+=n,jt())}function Tt(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function L({text:a}){const n=F.useMemo(()=>(a||"").split(/(\$[^$]+\$)/g).map(e=>e.length>1&&e.startsWith("$")&&e.endsWith("$")?xe.renderToString(e.slice(1,-1),{throwOnError:!1}):Tt(e)).join(""),[a]);return m.jsx("span",{dangerouslySetInnerHTML:{__html:n}})}function Ze(a,n){const e=n.length,t=a.map((l,i)=>[...l,n[i]]);for(let l=0;l<e;l++){let i=l;for(let r=l+1;r<e;r++)Math.abs(t[r][l])>Math.abs(t[i][l])&&(i=r);if(Math.abs(t[i][l])<1e-15)throw new Error("Singular matrix in solveLinearSystem");[t[l],t[i]]=[t[i],t[l]];for(let r=l+1;r<e;r++){const o=t[r][l]/t[l][l];if(o!==0)for(let u=l;u<=e;u++)t[r][u]-=o*t[l][u]}}const s=new Array(e).fill(0);for(let l=e-1;l>=0;l--){let i=t[l][e];for(let r=l+1;r<e;r++)i-=t[l][r]*s[r];s[l]=i/t[l][l]}return s}function Q(a,n){const e=a.length;let t=0,s=0,l=0,i=0;for(let u=0;u<e;u++)t+=a[u],s+=n[u],l+=a[u]*a[u],i+=a[u]*n[u];const[r,o]=Ze([[l,t],[t,e]],[i,s]);return{a:r,b:o}}function St(a,n,e){const t=a.length,s=e+1,l=new Array(2*e+1).fill(0);for(let o=0;o<t;o++){let u=1;for(let h=0;h<=2*e;h++)l[h]+=u,u*=a[o]}const i=new Array(s).fill(0);for(let o=0;o<t;o++){let u=1;for(let h=0;h<s;h++)i[h]+=u*n[o],u*=a[o]}const r=[];for(let o=0;o<s;o++){const u=[];for(let h=0;h<s;h++)u.push(l[o+h]);r.push(u)}return Ze(r,i)}function Mt(a,n){const e=n.map(l=>Math.log(l)),{a:t,b:s}=Q(a,e);return{a:t,b:Math.exp(s)}}function Et(a,n){const e=a.map(i=>Math.log(i)),t=n.map(i=>Math.log(i)),{a:s,b:l}=Q(e,t);return{a:s,b:Math.exp(l)}}function D(a,n,e){let t=0;for(let s=0;s<n.length;s++){const l=a(n[s])-e[s];t+=l*l}return t}function Re(a,n){let e=0;for(let t=a.length-1;t>=0;t--)e=e*n+a[t];return e}var It=function(n,e,t){for(var s=t,l=0,i=n.length;s<e.length;){var r=e[s];if(l<=0&&e.slice(s,s+i)===n)return s;r==="\\"?s++:r==="{"?l++:r==="}"&&l--,s++}return-1},Lt=function(n){return n.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")},Bt=/^\\begin{/,Nt=function(n,e){for(var t,s=[],l=new RegExp("("+e.map(u=>Lt(u.left)).join("|")+")");t=n.search(l),t!==-1;){t>0&&(s.push({type:"text",data:n.slice(0,t)}),n=n.slice(t));var i=e.findIndex(u=>n.startsWith(u.left));if(t=It(e[i].right,n,e[i].left.length),t===-1)break;var r=n.slice(0,t+e[i].right.length),o=Bt.test(r)?r:n.slice(e[i].left.length,t);s.push({type:"math",data:o,rawData:r,display:e[i].display}),n=n.slice(t+e[i].right.length)}return n!==""&&s.push({type:"text",data:n}),s},Rt=function(n,e){var t=Nt(n,e.delimiters);if(t.length===1&&t[0].type==="text")return null;for(var s=document.createDocumentFragment(),l=0;l<t.length;l++)if(t[l].type==="text")s.appendChild(document.createTextNode(t[l].data));else{var i=document.createElement("span"),r=t[l].data;e.displayMode=t[l].display;try{e.preProcess&&(r=e.preProcess(r)),xe.render(r,i,e)}catch(o){if(!(o instanceof xe.ParseError))throw o;e.errorCallback("KaTeX auto-render: Failed to parse `"+t[l].data+"` with ",o),s.appendChild(document.createTextNode(t[l].rawData));continue}s.appendChild(i)}return s},Ke=function(n,e){for(var t=function(i){var r=n.childNodes[i];if(r.nodeType===3){for(var o,u=(o=r.textContent)!=null?o:"",h=r.nextSibling,$=0;h&&h.nodeType===Node.TEXT_NODE;){var c;u+=(c=h.textContent)!=null?c:"",h=h.nextSibling,$++}var p=Rt(u,e);if(p){for(var d=0;d<$;d++)r.nextSibling.remove();i+=p.childNodes.length-1,n.replaceChild(p,r)}else i+=$}else if(r.nodeType===1){var f=" "+r.className+" ",g=!e.ignoredTags.has(r.nodeName.toLowerCase())&&e.ignoredClasses.every(y=>!f.includes(" "+y+" "));g&&Ke(r,e)}s=i},s=0;s<n.childNodes.length;s++)t(s)},Wt=function(n,e){if(!n)throw new Error("No element provided to render");var t={};Object.assign(t,e),t.delimiters=t.delimiters||[{left:"$$",right:"$$",display:!0},{left:"\\(",right:"\\)",display:!1},{left:"\\begin{equation}",right:"\\end{equation}",display:!0},{left:"\\begin{align}",right:"\\end{align}",display:!0},{left:"\\begin{alignat}",right:"\\end{alignat}",display:!0},{left:"\\begin{gather}",right:"\\end{gather}",display:!0},{left:"\\begin{CD}",right:"\\end{CD}",display:!0},{left:"\\[",right:"\\]",display:!0}],t.ignoredTags=new Set((e==null?void 0:e.ignoredTags)||["script","noscript","style","textarea","pre","code","option"]),t.ignoredClasses=t.ignoredClasses||[],t.errorCallback=t.errorCallback||console.error,t.macros=t.macros||{},Ke(n,t)};function we(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let Y=we();function Ue(a){Y=a}const Je=/[&<>"']/,Ct=new RegExp(Je.source,"g"),et=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Pt=new RegExp(et.source,"g"),Ht={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},We=a=>Ht[a];function T(a,n){if(n){if(Je.test(a))return a.replace(Ct,We)}else if(et.test(a))return a.replace(Pt,We);return a}const Vt=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Dt(a){return a.replace(Vt,(n,e)=>(e=e.toLowerCase(),e==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const Gt=/(^|[^\[])\^/g;function k(a,n){let e=typeof a=="string"?a:a.source;n=n||"";const t={replace:(s,l)=>{let i=typeof l=="string"?l:l.source;return i=i.replace(Gt,"$1"),e=e.replace(s,i),t},getRegex:()=>new RegExp(e,n)};return t}function Ce(a){try{a=encodeURI(a).replace(/%25/g,"%")}catch{return null}return a}const ee={exec:()=>null};function Pe(a,n){const e=a.replace(/\|/g,(l,i,r)=>{let o=!1,u=i;for(;--u>=0&&r[u]==="\\";)o=!o;return o?"|":" |"}),t=e.split(/ \|/);let s=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),n)if(t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;s<t.length;s++)t[s]=t[s].trim().replace(/\\\|/g,"|");return t}function re(a,n,e){const t=a.length;if(t===0)return"";let s=0;for(;s<t&&a.charAt(t-s-1)===n;)s++;return a.slice(0,t-s)}function Ot(a,n){if(a.indexOf(n[1])===-1)return-1;let e=0;for(let t=0;t<a.length;t++)if(a[t]==="\\")t++;else if(a[t]===n[0])e++;else if(a[t]===n[1]&&(e--,e<0))return t;return-1}function He(a,n,e,t){const s=n.href,l=n.title?T(n.title):null,i=a[1].replace(/\\([\[\]])/g,"$1");if(a[0].charAt(0)!=="!"){t.state.inLink=!0;const r={type:"link",raw:e,href:s,title:l,text:i,tokens:t.inlineTokens(i)};return t.state.inLink=!1,r}return{type:"image",raw:e,href:s,title:l,text:T(i)}}function Yt(a,n){const e=a.match(/^(\s+)(?:```)/);if(e===null)return n;const t=e[1];return n.split(`
`).map(s=>{const l=s.match(/^\s+/);if(l===null)return s;const[i]=l;return i.length>=t.length?s.slice(t.length):s}).join(`
`)}class me{constructor(n){_(this,"options");_(this,"rules");_(this,"lexer");this.options=n||Y}space(n){const e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){const e=this.rules.block.code.exec(n);if(e){const t=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:re(t,`
`)}}}fences(n){const e=this.rules.block.fences.exec(n);if(e){const t=e[0],s=Yt(t,e[3]||"");return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:s}}}heading(n){const e=this.rules.block.heading.exec(n);if(e){let t=e[2].trim();if(/#$/.test(t)){const s=re(t,"#");(this.options.pedantic||!s||/ $/.test(s))&&(t=s.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(n){const e=this.rules.block.hr.exec(n);if(e)return{type:"hr",raw:e[0]}}blockquote(n){const e=this.rules.block.blockquote.exec(n);if(e){let t=e[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);t=re(t.replace(/^ *>[ \t]?/gm,""),`
`);const s=this.lexer.state.top;this.lexer.state.top=!0;const l=this.lexer.blockTokens(t);return this.lexer.state.top=s,{type:"blockquote",raw:e[0],tokens:l,text:t}}}list(n){let e=this.rules.block.list.exec(n);if(e){let t=e[1].trim();const s=t.length>1,l={type:"list",raw:"",ordered:s,start:s?+t.slice(0,-1):"",loose:!1,items:[]};t=s?`\\d{1,9}\\${t.slice(-1)}`:`\\${t}`,this.options.pedantic&&(t=s?t:"[*+-]");const i=new RegExp(`^( {0,3}${t})((?:[	 ][^\\n]*)?(?:\\n|$))`);let r="",o="",u=!1;for(;n;){let h=!1;if(!(e=i.exec(n))||this.rules.block.hr.test(n))break;r=e[0],n=n.substring(r.length);let $=e[2].split(`
`,1)[0].replace(/^\t+/,y=>" ".repeat(3*y.length)),c=n.split(`
`,1)[0],p=0;this.options.pedantic?(p=2,o=$.trimStart()):(p=e[2].search(/[^ ]/),p=p>4?1:p,o=$.slice(p),p+=e[1].length);let d=!1;if(!$&&/^ *$/.test(c)&&(r+=c+`
...
`,1)[0];if(c=A,this.options.pedantic&&(c=c.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),z.test(c)||w.test(c)||y.test(c)||v.test(n))break;if(c.search(/[^ ]/)>=p||!c.trim())o+=`
`+c.slice(p);else{if(d||$.search(/[^ ]/)>=4||z.test($)||w.test($)||v.test($))break;o+=`
`+c}!d&&!c.trim()&&(d=!0),r+=A+`
`,n=n.substring(A.length+1),$=c.slice(p)}}l.loose||(u?l.loose=!0:/\n *\n *$/.test(r)&&(u=!0));let f=null,g;this.options.gfm&&(f=/^\[[ xX]\] /.exec(o),f&&(g=f[0]!=="[ ] ",o=o.replace(/^\[[ xX]\] +/,""))),l.items.push({type:"list_item",raw:r,task:!!f,checked:g,loose:!1,text:o,tokens:[]}),l.raw+=r}l.items[l.items.length-1].raw=r.trimEnd(),l.items[l.items.length-1].text=o.trimEnd(),l.raw=l.raw.trimEnd();for(let h=0;h<l.items.length;h++)if(this.lexer.state.top=!1,l.items[h].tokens=this.lexer.blockTokens(l.items[h].text,[]),!l.loose){const $=l.items[h].tokens.filter(p=>p.type==="space"),c=$.length>0&&$.some(p=>/\n.*\n/.test(p.raw));l.loose=c}if(l.loose)for(let h=0;h<l.items.length;h++)l.items[h].loose=!0;return l}}html(n){const e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){const e=this.rules.block.def.exec(n);if(e){const t=e[1].toLowerCase().replace(/\s+/g," "),s=e[2]?e[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",l=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:s,title:l}}}table(n){const e=this.rules.block.table.exec(n);if(!e||!/[:|]/.test(e[2]))return;const t=Pe(e[1]),s=e[2].replace(/^\||\| *$/g,"").split("|"),l=e[3]&&e[3].trim()?e[3].replace(/\n[ \t]*$/,"").split(`
`):[],i={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===s.length){for(const r of s)/^ *-+: *$/.test(r)?i.align.push("right"):/^ *:-+: *$/.test(r)?i.align.push("center"):/^ *:-+ *$/.test(r)?i.align.push("left"):i.align.push(null);for(const r of t)i.header.push({text:r,tokens:this.lexer.inline(r)});for(const r of l)i.rows.push(Pe(r,i.header.length).map(o=>({text:o,tokens:this.lexer.inline(o)})));return i}}lheading(n){const e=this.rules.block.lheading.exec(n);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(n){const e=this.rules.block.paragraph.exec(n);if(e){const t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(n){const e=this.rules.block.text.exec(n);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(n){const e=this.rules.inline.escape.exec(n);if(e)return{type:"escape",raw:e[0],text:T(e[1])}}tag(n){const e=this.rules.inline.tag.exec(n);if(e)return!this.lexer.state.inLink&&/^<a /i.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(n){const e=this.rules.inline.link.exec(n);if(e){const t=e[2].trim();if(!this.options.pedantic&&/^</.test(t)){if(!/>$/.test(t))return;const i=re(t.slice(0,-1),"\\");if((t.length-i.length)%2===0)return}else{const i=Ot(e[2],"()");if(i>-1){const o=(e[0].indexOf("!")===0?5:4)+e[1].length+i;e[2]=e[2].substring(0,i),e[0]=e[0].substring(0,o).trim(),e[3]=""}}let s=e[2],l="";if(this.options.pedantic){const i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(s);i&&(s=i[1],l=i[3])}else l=e[3]?e[3].slice(1,-1):"";return s=s.trim(),/^</.test(s)&&(this.options.pedantic&&!/>$/.test(t)?s=s.slice(1):s=s.slice(1,-1)),He(e,{href:s&&s.replace(this.rules.inline.anyPunctuation,"$1"),title:l&&l.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer)}}reflink(n,e){let t;if((t=this.rules.inline.reflink.exec(n))||(t=this.rules.inline.nolink.exec(n))){const s=(t[2]||t[1]).replace(/\s+/g," "),l=e[s.toLowerCase()];if(!l){const i=t[0].charAt(0);return{type:"text",raw:i,text:i}}return He(t,l,t[0],this.lexer)}}emStrong(n,e,t=""){let s=this.rules.inline.emStrongLDelim.exec(n);if(!s||s[3]&&t.match(/[\p{L}\p{N}]/u))return;if(!(s[1]||s[2]||"")||!t||this.rules.inline.punctuation.exec(t)){const i=[...s[0]].length-1;let r,o,u=i,h=0;const $=s[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for($.lastIndex=0,e=e.slice(-1*n.length+i);(s=$.exec(e))!=null;){if(r=s[1]||s[2]||s[3]||s[4]||s[5]||s[6],!r)continue;if(o=[...r].length,s[3]||s[4]){u+=o;continue}else if((s[5]||s[6])&&i%3&&!((i+o)%3)){h+=o;continue}if(u-=o,u>0)continue;o=Math.min(o,o+u+h);const c=[...s[0]][0].length,p=n.slice(0,i+s.index+c+o);if(Math.min(i,o)%2){const f=p.slice(1,-1);return{type:"em",raw:p,text:f,tokens:this.lexer.inlineTokens(f)}}const d=p.slice(2,-2);return{type:"strong",raw:p,text:d,tokens:this.lexer.inlineTokens(d)}}}}codespan(n){const e=this.rules.inline.code.exec(n);if(e){let t=e[2].replace(/\n/g," ");const s=/[^ ]/.test(t),l=/^ /.test(t)&&/ $/.test(t);return s&&l&&(t=t.substring(1,t.length-1)),t=T(t,!0),{type:"codespan",raw:e[0],text:t}}}br(n){const e=this.rules.inline.br.exec(n);if(e)return{type:"br",raw:e[0]}}del(n){const e=this.rules.inline.del.exec(n);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(n){const e=this.rules.inline.autolink.exec(n);if(e){let t,s;return e[2]==="@"?(t=T(e[1]),s="mailto:"+t):(t=T(e[1]),s=t),{type:"link",raw:e[0],text:t,href:s,tokens:[{type:"text",raw:t,text:t}]}}}url(n){var t;let e;if(e=this.rules.inline.url.exec(n)){let s,l;if(e[2]==="@")s=T(e[0]),l="mailto:"+s;else{let i;do i=e[0],e[0]=((t=this.rules.inline._backpedal.exec(e[0]))==null?void 0:t[0])??"";while(i!==e[0]);s=T(e[0]),e[1]==="www."?l="http://"+e[0]:l=e[0]}return{type:"link",raw:e[0],text:s,href:l,tokens:[{type:"text",raw:s,text:s}]}}}inlineText(n){const e=this.rules.inline.text.exec(n);if(e){let t;return this.lexer.state.inRawBlock?t=e[0]:t=T(e[0]),{type:"text",raw:e[0],text:t}}}}const Xt=/^(?: *(?:\n|$))+/,Qt=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Zt=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ie=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Kt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,tt=/(?:[*+-]|\d{1,9}[.)])/,nt=k(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,tt).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),qe=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ut=/^[^\n]+/,je=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Jt=k(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",je).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),en=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,tt).getRegex(),ge="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ae=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,tn=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",Ae).replace("tag",ge).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),it=k(qe).replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex(),nn=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",it).getRegex(),Fe={blockquote:nn,code:Qt,def:Jt,fences:Zt,heading:Kt,hr:ie,html:tn,lheading:nt,list:en,newline:Xt,paragraph:it,table:ee,text:Ut},Ve=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex(),an={...Fe,table:Ve,paragraph:k(qe).replace("hr",ie).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ve).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ge).getRegex()},sn={...Fe,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ae).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ee,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(qe).replace("hr",ie).replace("heading",` *#{1,6} *[^
]`).replace("lheading",nt).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},at=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ln=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,st=/^( {2,}|\\)\n(?!\s*$)/,rn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ae="\\p{P}\\p{S}",on=k(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,ae).getRegex(),hn=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,mn=k(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,ae).getRegex(),un=k("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,ae).getRegex(),$n=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,ae).getRegex(),cn=k(/\\([punct])/,"gu").replace(/punct/g,ae).getRegex(),pn=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),dn=k(Ae).replace("(?:-->|$)","-->").getRegex(),fn=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",dn).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ue=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,gn=k(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",ue).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),lt=k(/^!?\[(label)\]\[(ref)\]/).replace("label",ue).replace("ref",je).getRegex(),rt=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",je).getRegex(),yn=k("reflink|nolink(?!\\()","g").replace("reflink",lt).replace("nolink",rt).getRegex(),Te={_backpedal:ee,anyPunctuation:cn,autolink:pn,blockSkip:hn,br:st,code:ln,del:ee,emStrongLDelim:mn,emStrongRDelimAst:un,emStrongRDelimUnd:$n,escape:at,link:gn,nolink:rt,punctuation:on,reflink:lt,reflinkSearch:yn,tag:fn,text:rn,url:ee},xn={...Te,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",ue).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ue).getRegex()},ke={...Te,escape:k(at).replace("])","~|])").getRegex(),url:k(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},bn={...ke,br:k(st).replace("{2,}","*").getRegex(),text:k(ke.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},oe={normal:Fe,gfm:an,pedantic:sn},U={normal:Te,gfm:ke,breaks:bn,pedantic:xn};class B{constructor(n){_(this,"tokens");_(this,"options");_(this,"state");_(this,"tokenizer");_(this,"inlineQueue");this.tokens=[],this.tokens.links=Object.create(null),this.options=n||Y,this.options.tokenizer=this.options.tokenizer||new me,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const e={block:oe.normal,inline:U.normal};this.options.pedantic?(e.block=oe.pedantic,e.inline=U.pedantic):this.options.gfm&&(e.block=oe.gfm,this.options.breaks?e.inline=U.breaks:e.inline=U.gfm),this.tokenizer.rules=e}static get rules(){return{block:oe,inline:U}}static lex(n,e){return new B(e).lex(n)}static lexInline(n,e){return new B(e).inlineTokens(n)}lex(n){n=n.replace(/\r\n|\r/g,`
`),this.blockTokens(n,this.tokens);for(let e=0;e<this.inlineQueue.length;e++){const t=this.inlineQueue[e];this.inlineTokens(t.src,t.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(n,e=[]){this.options.pedantic?n=n.replace(/\t/g,"    ").replace(/^ +$/gm,""):n=n.replace(/^( *)(\t+)/gm,(r,o,u)=>o+"    ".repeat(u.length));let t,s,l,i;for(;n;)if(!(this.options.extensions&&this.options.extensions.block&&this.options.extensions.block.some(r=>(t=r.call({lexer:this},n,e))?(n=n.substring(t.raw.length),e.push(t),!0):!1))){if(t=this.tokenizer.space(n)){n=n.substring(t.raw.length),t.raw.length===1&&e.length>0?e[e.length-1].raw+=`
...
`+t.raw,s.text+=`
`+t.raw,this.inlineQueue[this.inlineQueue.length-1].src=s.text):this.tokens.links[t.tag]||(this.tokens.links[t.tag]={href:t.href,title:t.title});continue}if(t=this.tokenizer.table(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.lheading(n)){n=n.substring(t.raw.length),e.push(t);continue}if(l=n,this.options.extensions&&this.options.extensions.startBlock){let r=1/0;const o=n.slice(1);let u;this.options.extensions.startBlock.forEach(h=>{u=h.call({lexer:this},o),typeof u=="number"&&u>=0&&(r=Math.min(r,u))}),r<1/0&&r>=0&&(l=n.substring(0,r+1))}if(this.state.top&&(t=this.tokenizer.paragraph(l))){s=e[e.length-1],i&&s.type==="paragraph"?(s.raw+=`
`+t.raw,s.text+=`
...
`+t.raw,s.text+=`
`+t.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=s.text):e.push(t);continue}if(n){const r="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(r);break}else throw new Error(r)}}return this.state.top=!0,e}inline(n,e=[]){return this.inlineQueue.push({src:n,tokens:e}),e}inlineTokens(n,e=[]){let t,s,l,i=n,r,o,u;if(this.tokens.links){const h=Object.keys(this.tokens.links);if(h.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)h.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)i=i.slice(0,r.index)+"["+"a".repeat(r[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(r=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,r.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;n;)if(o||(u=""),o=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(h=>(t=h.call({lexer:this},n,e))?(n=n.substring(t.raw.length),e.push(t),!0):!1))){if(t=this.tokenizer.escape(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.tag(n)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.link(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.reflink(n,this.tokens.links)){n=n.substring(t.raw.length),s=e[e.length-1],s&&t.type==="text"&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(t=this.tokenizer.emStrong(n,i,u)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.codespan(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.br(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.del(n)){n=n.substring(t.raw.length),e.push(t);continue}if(t=this.tokenizer.autolink(n)){n=n.substring(t.raw.length),e.push(t);continue}if(!this.state.inLink&&(t=this.tokenizer.url(n))){n=n.substring(t.raw.length),e.push(t);continue}if(l=n,this.options.extensions&&this.options.extensions.startInline){let h=1/0;const $=n.slice(1);let c;this.options.extensions.startInline.forEach(p=>{c=p.call({lexer:this},$),typeof c=="number"&&c>=0&&(h=Math.min(h,c))}),h<1/0&&h>=0&&(l=n.substring(0,h+1))}if(t=this.tokenizer.inlineText(l)){n=n.substring(t.raw.length),t.raw.slice(-1)!=="_"&&(u=t.raw.slice(-1)),o=!0,s=e[e.length-1],s&&s.type==="text"?(s.raw+=t.raw,s.text+=t.text):e.push(t);continue}if(n){const h="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return e}}class $e{constructor(n){_(this,"options");this.options=n||Y}code(n,e,t){var l;const s=(l=(e||"").match(/^\S*/))==null?void 0:l[0];return n=n.replace(/\n$/,"")+`
`,s?'<pre><code class="language-'+T(s)+'">'+(t?n:T(n,!0))+`</code></pre>
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return"<br>"}del(n){return`<del>${n}</del>`}link(n,e,t){const s=Ce(n);if(s===null)return t;n=s;let l='<a href="'+n+'"';return e&&(l+=' title="'+e+'"'),l+=">"+t+"</a>",l}image(n,e,t){const s=Ce(n);if(s===null)return t;n=s;let l=`<img src="${n}" alt="${t}"`;return e&&(l+=` title="${e}"`),l+=">",l}text(n){return n}}class Se{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,e,t){return""+t}image(n,e,t){return""+t}br(){return""}}class N{constructor(n){_(this,"options");_(this,"renderer");_(this,"textRenderer");this.options=n||Y,this.options.renderer=this.options.renderer||new $e,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Se}static parse(n,e){return new N(e).parse(n)}static parseInline(n,e){return new N(e).parseInline(n)}parse(n,e=!0){let t="";for(let s=0;s<n.length;s++){const l=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[l.type]){const i=l,r=this.options.extensions.renderers[i.type].call({parser:this},i);if(r!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){t+=r||"";continue}}switch(l.type){case"space":continue;case"hr":{t+=this.renderer.hr();continue}case"heading":{const i=l;t+=this.renderer.heading(this.parseInline(i.tokens),i.depth,Dt(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{const i=l;t+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{const i=l;let r="",o="";for(let h=0;h<i.header.length;h++)o+=this.renderer.tablecell(this.parseInline(i.header[h].tokens),{header:!0,align:i.align[h]});r+=this.renderer.tablerow(o);let u="";for(let h=0;h<i.rows.length;h++){const $=i.rows[h];o="";for(let c=0;c<$.length;c++)o+=this.renderer.tablecell(this.parseInline($[c].tokens),{header:!1,align:i.align[c]});u+=this.renderer.tablerow(o)}t+=this.renderer.table(r,u);continue}case"blockquote":{const i=l,r=this.parse(i.tokens);t+=this.renderer.blockquote(r);continue}case"list":{const i=l,r=i.ordered,o=i.start,u=i.loose;let h="";for(let $=0;$<i.items.length;$++){const c=i.items[$],p=c.checked,d=c.task;let f="";if(c.task){const g=this.renderer.checkbox(!!p);u?c.tokens.length>0&&c.tokens[0].type==="paragraph"?(c.tokens[0].text=g+" "+c.tokens[0].text,c.tokens[0].tokens&&c.tokens[0].tokens.length>0&&c.tokens[0].tokens[0].type==="text"&&(c.tokens[0].tokens[0].text=g+" "+c.tokens[0].tokens[0].text)):c.tokens.unshift({type:"text",text:g+" "}):f+=g+" "}f+=this.parse(c.tokens,u),h+=this.renderer.listitem(f,d,!!p)}t+=this.renderer.list(h,r,o);continue}case"html":{const i=l;t+=this.renderer.html(i.text,i.block);continue}case"paragraph":{const i=l;t+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=l,r=i.tokens?this.parseInline(i.tokens):i.text;for(;s+1<n.length&&n[s+1].type==="text";)i=n[++s],r+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);t+=e?this.renderer.paragraph(r):r;continue}default:{const i='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return t}parseInline(n,e){e=e||this.renderer;let t="";for(let s=0;s<n.length;s++){const l=n[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[l.type]){const i=this.options.extensions.renderers[l.type].call({parser:this},l);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(l.type)){t+=i||"";continue}}switch(l.type){case"escape":{const i=l;t+=e.text(i.text);break}case"html":{const i=l;t+=e.html(i.text);break}case"link":{const i=l;t+=e.link(i.href,i.title,this.parseInline(i.tokens,e));break}case"image":{const i=l;t+=e.image(i.href,i.title,i.text);break}case"strong":{const i=l;t+=e.strong(this.parseInline(i.tokens,e));break}case"em":{const i=l;t+=e.em(this.parseInline(i.tokens,e));break}case"codespan":{const i=l;t+=e.codespan(i.text);break}case"br":{t+=e.br();break}case"del":{const i=l;t+=e.del(this.parseInline(i.tokens,e));break}case"text":{const i=l;t+=e.text(i.text);break}default:{const i='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return t}}class te{constructor(n){_(this,"options");this.options=n||Y}preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}}_(te,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var O,_e,ot;class kn{constructor(...n){Be(this,O);_(this,"defaults",we());_(this,"options",this.setOptions);_(this,"parse",le(this,O,_e).call(this,B.lex,N.parse));_(this,"parseInline",le(this,O,_e).call(this,B.lexInline,N.parseInline));_(this,"Parser",N);_(this,"Renderer",$e);_(this,"TextRenderer",Se);_(this,"Lexer",B);_(this,"Tokenizer",me);_(this,"Hooks",te);this.use(...n)}walkTokens(n,e){var s,l;let t=[];for(const i of n)switch(t=t.concat(e.call(this,i)),i.type){case"table":{const r=i;for(const o of r.header)t=t.concat(this.walkTokens(o.tokens,e));for(const o of r.rows)for(const u of o)t=t.concat(this.walkTokens(u.tokens,e));break}case"list":{const r=i;t=t.concat(this.walkTokens(r.items,e));break}default:{const r=i;(l=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&l[r.type]?this.defaults.extensions.childTokens[r.type].forEach(o=>{const u=r[o].flat(1/0);t=t.concat(this.walkTokens(u,e))}):r.tokens&&(t=t.concat(this.walkTokens(r.tokens,e)))}}return t}use(...n){const e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach(t=>{const s={...t};if(s.async=this.defaults.async||s.async||!1,t.extensions&&(t.extensions.forEach(l=>{if(!l.name)throw new Error("extension name required");if("renderer"in l){const i=e.renderers[l.name];i?e.renderers[l.name]=function(...r){let o=l.renderer.apply(this,r);return o===!1&&(o=i.apply(this,r)),o}:e.renderers[l.name]=l.renderer}if("tokenizer"in l){if(!l.level||l.level!=="block"&&l.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const i=e[l.level];i?i.unshift(l.tokenizer):e[l.level]=[l.tokenizer],l.start&&(l.level==="block"?e.startBlock?e.startBlock.push(l.start):e.startBlock=[l.start]:l.level==="inline"&&(e.startInline?e.startInline.push(l.start):e.startInline=[l.start]))}"childTokens"in l&&l.childTokens&&(e.childTokens[l.name]=l.childTokens)}),s.extensions=e),t.renderer){const l=this.defaults.renderer||new $e(this.defaults);for(const i in t.renderer){if(!(i in l))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;const r=i,o=t.renderer[r],u=l[r];l[r]=(...h)=>{let $=o.apply(l,h);return $===!1&&($=u.apply(l,h)),$||""}}s.renderer=l}if(t.tokenizer){const l=this.defaults.tokenizer||new me(this.defaults);for(const i in t.tokenizer){if(!(i in l))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;const r=i,o=t.tokenizer[r],u=l[r];l[r]=(...h)=>{let $=o.apply(l,h);return $===!1&&($=u.apply(l,h)),$}}s.tokenizer=l}if(t.hooks){const l=this.defaults.hooks||new te;for(const i in t.hooks){if(!(i in l))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;const r=i,o=t.hooks[r],u=l[r];te.passThroughHooks.has(i)?l[r]=h=>{if(this.defaults.async)return Promise.resolve(o.call(l,h)).then(c=>u.call(l,c));const $=o.call(l,h);return u.call(l,$)}:l[r]=(...h)=>{let $=o.apply(l,h);return $===!1&&($=u.apply(l,h)),$}}s.hooks=l}if(t.walkTokens){const l=this.defaults.walkTokens,i=t.walkTokens;s.walkTokens=function(r){let o=[];return o.push(i.call(this,r)),l&&(o=o.concat(l.call(this,r))),o}}this.defaults={...this.defaults,...s}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return B.lex(n,e??this.defaults)}parser(n,e){return N.parse(n,e??this.defaults)}}O=new WeakSet,_e=function(n,e){return(t,s)=>{const l={...s},i={...this.defaults,...l};this.defaults.async===!0&&l.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);const r=le(this,O,ot).call(this,!!i.silent,!!i.async);if(typeof t>"u"||t===null)return r(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return r(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(t):t).then(o=>n(o,i)).then(o=>i.hooks?i.hooks.processAllTokens(o):o).then(o=>i.walkTokens?Promise.all(this.walkTokens(o,i.walkTokens)).then(()=>o):o).then(o=>e(o,i)).then(o=>i.hooks?i.hooks.postprocess(o):o).catch(r);try{i.hooks&&(t=i.hooks.preprocess(t));let o=n(t,i);i.hooks&&(o=i.hooks.processAllTokens(o)),i.walkTokens&&this.walkTokens(o,i.walkTokens);let u=e(o,i);return i.hooks&&(u=i.hooks.postprocess(u)),u}catch(o){return r(o)}}},ot=function(n,e){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){const s="<p>An error occurred:</p><pre>"+T(t.message+"",!0)+"</pre>";return e?Promise.resolve(s):s}if(e)return Promise.reject(t);throw t}};const G=new kn;function x(a,n){return G.parse(a,n)}x.options=x.setOptions=function(a){return G.setOptions(a),x.defaults=G.defaults,Ue(x.defaults),x};x.getDefaults=we;x.defaults=Y;x.use=function(...a){return G.use(...a),x.defaults=G.defaults,Ue(x.defaults),x};x.walkTokens=function(a,n){return G.walkTokens(a,n)};x.parseInline=G.parseInline;x.Parser=N;x.parser=N.parse;x.Renderer=$e;x.TextRenderer=Se;x.Lexer=B;x.lexer=B.lex;x.Tokenizer=me;x.Hooks=te;x.parse=x;x.options;x.setOptions;x.use;x.walkTokens;x.parseInline;N.parse;B.lex;const _n={delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1};function Me(a){a&&Wt(a,_n)}x.setOptions({breaks:!0,gfm:!0});function Ee(a,n){const e=()=>n.forEach(s=>{if(s&&s.offsetParent!==null)try{ne.Plots.resize(s)}catch{}});requestAnimationFrame(e),setTimeout(e,60);let t;return typeof ResizeObserver<"u"&&(t=new ResizeObserver(e),t.observe(a)),()=>{t&&t.disconnect()}}function ce(a={}){const n=J("--fg")||"#1a1a2e",e=J("--grid")||"#d8d8e0",t=J("--surface")||"#ffffff";return{paper_bgcolor:t,plot_bgcolor:t,font:{color:n,family:"system-ui, sans-serif"},margin:{l:44,r:16,t:28,b:40},xaxis:{gridcolor:e,zerolinecolor:e},yaxis:{gridcolor:e,zerolinecolor:e},showlegend:!0,legend:{orientation:"h",y:1.12,x:0},...a}}const pe=()=>J("--accent")||"#e63946",de=()=>J("--point")||"#3a6ea5",fe={displayModeBar:!1,responsive:!0},he={xs:[-1,1,2.5,3,4,4.5,6],ys:[0,1.2,1.9,2.5,3.1,3.2,4.5]};function zn(a){let n=[...he.xs],e=[...he.ys],t=!1,s=.5,l=.5;a.innerHTML=`
    <div class="demo">
    ...
    </div>`;const i=a.querySelector("[data-plot]"),r=a.querySelector("[data-readout]"),o=a.querySelector("[data-sliders]");function u(d,f){const g=(f-d)*.1||1;return[d-g,f+g]}function h(){const{a:d,b:f}=Q(n,e),[g,y]=u(Math.min(...n),Math.max(...n)),v=[{x:n,y:e,mode:"markers",type:"scatter",name:b({hu:"adatok",en:"data"}),marker:{size:11,color:de()}},{x:[g,y],y:[d*g+f,d*y+f],mode:"lines",name:b(q.demoBestFit),line:{color:pe(),width:3}}];t&&v.push({x:[g,y],y:[s*g+l,s*y+l],mode:"lines",name:b(q.demoGuess),line:{color:"#f4a261",width:2,dash:"dash"}}),ne.react(i,v,ce({xaxis:{range:[g,y]}}),fe);const z=D(A=>d*A+f,n,e);let w=`<div class="ro-row">$\\bar a = ${d.toFixed(6)},\\quad \\bar b = ${f.toFixed(6)}$</div>`;if(w+=`<div class="ro-row"><span class="ro-label">${b(q.optimalError)}:</span> $F = ${z.toFixed(6)}$</div>`,t){const A=D(S=>s*S+l,n,e),R=A>0?z/A:1,W=R>.98?"★★★":R>.85?"★★☆":R>.6?"★☆☆":"☆☆☆";w+=`<div class="ro-row"><span class="ro-label">${b(q.yourError)}:</span> $F = ${A.toFixed(6)}$ <span class="ro-stars">${W}</span></div>`}r.innerHTML=w,Me(r)}function $(){const d=i.querySelector(".nsewdrag");if(!d)return;let f=-1;const g=y=>{const v=d.getBoundingClientRect(),z=i._fullLayout.xaxis,w=i._fullLayout.yaxis;return{x:z.p2d(y.clientX-v.left),y:w.p2d(y.clientY-v.top)}};d.addEventListener("mousedown",y=>{const v=g(y),z=i._fullLayout.xaxis,w=i._fullLayout.yaxis,A=z.range[1]-z.range[0],R=w.range[1]-w.range[0];let W=-1,S=1/0;for(let H=0;H<n.length;H++){const se=(n[H]-v.x)/A,Z=(e[H]-v.y)/R,K=se*se+Z*Z;K<S&&(S=K,W=H)}W>=0&&S<.0025&&(f=W,y.preventDefault())}),window.addEventListener("mousemove",y=>{f<0||(e[f]=g(y).y,h())}),window.addEventListener("mouseup",()=>{f=-1})}a.querySelector('[data-act="best"]').addEventListener("click",()=>{t=!1,o.hidden=!0,a.querySelector('[data-act="guess"]').setAttribute("aria-pressed","false"),h()}),a.querySelector('[data-act="guess"]').addEventListener("click",d=>{t=!t,o.hidden=!t,d.currentTarget.setAttribute("aria-pressed",String(t)),h()}),a.querySelector('[data-act="add"]').addEventListener("click",()=>{const d=Q(n,e),f=Math.max(...n)+1;n.push(f),e.push(d.a*f+d.b),h(),setTimeout($,60)}),a.querySelector('[data-act="reset"]').addEventListener("click",()=>{n=[...he.xs],e=[...he.ys],h(),setTimeout($,60)}),a.querySelectorAll("[data-slider]").forEach(d=>{d.value=d.dataset.slider==="a"?s:l,d.addEventListener("input",()=>{d.dataset.slider==="a"?s=parseFloat(d.value):l=parseFloat(d.value),a.querySelector("[data-ga]").textContent=s.toFixed(2),a.querySelector("[data-gb]").textContent=l.toFixed(2),h()})}),a.querySelector("[data-ga]").textContent=s.toFixed(2),a.querySelector("[data-gb]").textContent=l.toFixed(2),h(),setTimeout($,80);const c=ve(()=>h()),p=Ee(a,[i]);return()=>{c(),p()}}const De={xs:[-1,0,.5,1,2,2.5,3],ys:[1.4,1.9,1.6,1.7,.2,-.1,-2]};function vn(a){let n=[...De.xs],e=[...De.ys],t=2;const s=Math.min(6,n.length-1);a.innerHTML=`
    <div class="demo">
      ...
      <div class="demo-plot" data-plot></div>
      <div class="demo-readout" data-readout></div>
    </div>`;const l=a.querySelector("[data-plot]"),i=a.querySelector("[data-readout]");a.querySelector("[data-deg]").textContent=t;function r(){const h=St(n,e,t),$=Math.min(...n)-.4,c=Math.max(...n)+.4,p=[],d=[],f=120;for(let z=0;z<=f;z++){const w=$+(c-$)*z/f;p.push(w),d.push(Re(h,w))}ne.react(l,[{x:n,y:e,mode:"markers",type:"scatter",name:b({hu:"adatok",en:"data"}),marker:{size:11,color:de()}},{x:p,y:d,mode:"lines",name:`${b({hu:"fokszám",en:"degree"})} ${t}`,line:{color:pe(),width:3}}],ce({xaxis:{range:[$,c]}}),fe);const g=D(z=>Re(h,z),n,e);let v=`<div class="ro-row">$p(x) = ${h.map((z,w)=>w===0?z.toFixed(4):`${z>=0?"+":""}${z.toFixed(4)}x^{${w}}`).join(" ")}$</div>`;v+=`<div class="ro-row"><span class="ro-label">${b(q.error)}:</span> $F = ${g.toFixed(6)}$</div>`,t>=n.length-1&&(v+=`<div class="ro-row ro-warn">${b({hu:"⚠ $m \\ge n$: interpoláció, a hiba ≈ 0.",en:"⚠ $m \\ge n$: interpolation, error ≈ 0."})}</div>`),i.innerHTML=v,Me(i)}a.querySelector('[data-slider="m"]').addEventListener("input",h=>{t=parseInt(h.target.value,10),a.querySelector("[data-deg]").textContent=t,r()}),r();const o=ve(()=>r()),u=Ee(a,[l]);return()=>{o(),u()}}const wn={exp:{xs:[0,1,1.5,2,3,4],ys:[.3,.7,.9,1.2,1.8,2.7]},power:{xs:[.5,1,1.5,2.5,3],ys:[.7,1.1,1.6,2.1,2.3]}};function qn(a){let n="exp";a.innerHTML=`
    <div class="demo">
      <div class="demo-controls">
...
`,Hn=`# Fit y ~ b*exp(a*t) by linear least squares on ln(y). Returns (a, b).
...
`,Vn=`// Linear regression y = a x + b; returns (a, b).
...
`,li=`function c = poly_fit(t, y, degree)
...
`,oi=`# Least-squares polynomial fit; returns coefficients (low -> high).
...
`,mi=`polyFit[t_, y_, degree_] := Module[{A},
...
if __name__ == "__main__":
    ...
    a, b = power_fit(t, y)
    print(f"a = {a:.4f}, b = {b:.4f}")
`,yi=`# Fit y ~ b*t^a by linear least squares on log-log data. Returns (a, b).
...
res <- power_fit(t, y)
cat(sprintf("a = %.4f, b = %.4f\\n", res$a, res$b))
`,xi=`fn linreg(x: &[f64], y: &[f64]) -> (f64, f64) {
    let n = x.len() as f64;
    let (mut sx, mut sy, mut sxx, mut sxy) = (0.0, 0.0, 0.0, 0.0);
    for i in 0..x.len() { sx += x[i]; sy += y[i]; sxx += x[i] * x[i]; sxy += x[i] * y[i]; }
    let a = (n * sxy - sx * sy) / (n * sxx - sx * sx);
